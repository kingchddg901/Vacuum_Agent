...
### C7. Slug identity has no uniqueness guarantee, and the docstring claims it does **[VERIFIED AT SOURCE]**
...
### C8. Reconciliation never runs -- the divergence detector is never invoked *(not independently verified)*
...
### C9. Destructive room writes with no confirmation or preservation *(not independently verified)* — **1/2 applied**
...
### C11. The Eufy in-memory map source has NO vacuum identity **[VERIFIED AT SOURCE]**
...
### C12. Live pose is projected through the WRONG coordinate frame *(not independently verified)*
...
### C13. The sticky-hold `stale` flag is written and never read *(not independently verified)*
...
### C16. dock_events records a NEW cycle on first sighting or on an availability blip *(not independently verified)*
...
### C23. The confidence tier system is INVERTED at the top, and green is unreachable **[VERIFIED AT SOURCE]**
...
### C24. External runs contribute battery=0.0 and the estimator consumes it as a real measurement *(not independently verified)*
...
### C26. Learning services destroy or misreport, and say success either way *(not independently verified)* — **2/4 applied**
...
### C27. overwrite_theme resolves against the ACTIVE theme, never the target it names **[VERIFIED AT SOURCE]**
...
### C28. Bundled themes are protected from neither delete nor overwrite **[VERIFIED AT SOURCE]**
...
### C29. delete_theme leaves the working draft orphaned on a base that no longer exists **[VERIFIED AT SOURCE]**
...
- [ ] **SN-1** `sensor/__init__.py:98` [both]  
...
- [ ] **A4-SETUP-2** `services/adapter_config.py:67` [both] _(finder said CRITICAL)_  
...
- [ ] **A1-INIT-3** `core/manager.py:347` [both] _(finder said HIGH)_  
...
- [ ] **A1-EST-3** `learning/estimator.py:476` [roborock] _(finder said HIGH)_  
...
- [ ] **A1-EST-4** `learning/estimator.py:843` [both] _(finder said HIGH)_  
...
- [ ] **A2-ACC-3** `learning/estimator.py:1178` [both] _(finder said HIGH)_  
...
- [ ] **A4-STATE-3** `learning/history_store.py:301` [both] _(finder said HIGH)_  
...
- [ ] **A4-RB-4** `mapping/map_source_runtime.py:511` [roborock] _(finder said HIGH)_  
...
- [ ] **A4-RB-3** `mapping/map_source_runtime.py:743` [roborock] _(finder said HIGH)_  
...
- [ ] **A4-CUSTOM-3** `mapping/mapping_services.py:1449` [Eufy only — on Roborock async_get_map_data_dict returns None early (map_source_coordinator.py:683), so nothing is written.] _(finder said HIGH)_  
...
- [ ] **A5-FURNIS-1** `mapping/mapping_services.py:2108` [both] _(finder said HIGH)_  
...
- [ ] **A6-ZONE-C-2** `mapping/mapping_services.py:2552` [Both — the zone step and its resolver are brand-agnostic.] _(finder said HIGH)_  
...
- [ ] **DR-ONB-4** `onboarding/manager.py:66` [both]  
...
- [ ] **A6-PP-EST-DSP-2** `planning/run_plan.py:125` [both] _(finder said HIGH)_  
...
- [ ] **DQ-Q-1** `planning/run_plan.py:902` [both] _(finder said HIGH)_  
...
- [ ] **A2-PP-CAP-7** `profiles/room_profiles.py:166` [future_brand_only] _(finder said LOW)_  
...
- [ ] **A1-PP-RES-3** `profiles/room_profiles.py:419` [eufy] _(finder said HIGH)_  
...
- [ ] **A2-REC-3** `rooms/reconciliation.py:125` [roborock] _(finder said HIGH)_  
...
- [ ] **A1-ID-2** `rooms/room_discovery.py:176` [roborock] _(finder said HIGH)_  
...
- [ ] **SN-5** `sensor/map_overlays.py:50` [both]  
...
- [ ] **DR-ONB-3** `sensor/onboarding.py:62` [both]  
...
- [ ] **A1-WIRE-2** `services/_common.py:57` [both] _(finder said HIGH)_  
...
- [ ] **A4-SETUP-5** `services/adapter_config.py:86` [both] _(finder said HIGH)_  
...
- [ ] **A4-SETUP-3** `services/adapter_config.py:108` [both] _(finder said HIGH)_  
...
- [ ] **A6-DIAG-1** `services/dock.py:83` [eufy] _(finder said HIGH)_  
...
- [ ] **A2-JOB-4** `services/job_control.py:130` [eufy] _(finder said HIGH)_  
...
- [ ] **A1-WIRE-1** `services/job_control.py:156` [both] _(finder said HIGH)_  
...
- [ ] **A3-ROOMS-4** `services/room_profiles.py:43` [both] _(finder said HIGH)_  
...
- [ ] **A3-ROOMS-5** `services/room_profiles.py:168` [both] _(finder said HIGH)_  
...
- [ ] **A3-ROOMS-3** `services/rooms.py:79` [both] _(finder said HIGH)_  
...
- [ ] **A3-ROOMS-6** `services/rooms.py:102` [both] _(finder said HIGH)_  
...
- [ ] **A5-RUNPROF-1** `services/run_profiles.py:97` [both] _(finder said HIGH)_  
...
- [ ] **A5-RUNPROF-2** `services/run_profiles.py:114` [both] _(finder said HIGH)_  
...
- [ ] **A5-RUNPROF-3** `services/run_profiles.py:146` [both] _(finder said HIGH)_  
...
- [ ] **DR-SETUP-2** `setup/drift.py:117` [both]  
...
- [ ] **SN-6** `themes/manager.py:412` [both]  
...
- [ ] **A2-DRAFT-2** `themes/manager.py:417` [both] _(finder said HIGH)_  
...
- [ ] **A3-PORT-1** `themes/manager.py:544` [both] _(finder said HIGH)_  
...
- [ ] **INF-2** `timestamp_utils.py:8` [both]  
...
- [ ] **DR-BAT-2** `battery/manager.py:601` [both]  
...
- [ ] **DR-BAT-3** `battery/manager.py:653` [both]  
...
- [ ] **A3-FLOW-2** `config_flow.py:103` [both] _(finder said MEDIUM)_  
...
- [ ] **A5-FACADE-4** `core/manager.py:1239` [both] _(finder said MEDIUM)_  
...
- [ ] **A4-START-3** `core/manager.py:2943` [both] _(finder said MEDIUM)_  
...
- [ ] **DQ-ZONE-5** `core/manager.py:4030` [both] _(finder said MEDIUM)_  
...
- [ ] **A4-START-2** `core/manager.py:5021` [both] _(finder said MEDIUM)_  
...
- [ ] **DR-BAT-1** `docs/dev/12-battery-system.md:88` [both]  
...
- [ ] **DR-BAT-4** `docs/dev/12-battery-system.md:338` [both]  
...
- [ ] **DR-ONB-6** `docs/dev/18-onboarding-manager.md:228` [both]  
...
- [ ] **A1-EST-7** `learning/estimator.py:238` [future_brand_only] _(finder said MEDIUM)_  
...
- [ ] **A2-ACC-7** `learning/estimator.py:592` [both] _(finder said MEDIUM)_  
...
- [ ] **A2-ACC-5** `learning/estimator.py:1130` [both] _(finder said MEDIUM)_  
...
- [ ] **A5-POSE-6** `mapping/map_source.py:139` [both] _(finder said MEDIUM)_  
...
- [ ] **A2-GEO-3** `mapping/map_source.py:191` [eufy] _(finder said MEDIUM)_  
...
- [ ] **A3-EXT-3** `mapping/map_source.py:686` [eufy] _(finder said MEDIUM)_  
...
- [ ] **A1-LC-4** `mapping/map_source_coordinator.py:266` [eufy] _(finder said MEDIUM)_  
...
- [ ] **A5-POSE-5** `mapping/map_source_coordinator.py:266` [eufy] _(finder said MEDIUM)_  
...
- [ ] **A5-POSE-3** `mapping/map_source_coordinator.py:491` [eufy] _(finder said MEDIUM)_  
...
- [ ] **A5-POSE-4** `mapping/map_source_coordinator.py:528` [eufy] _(finder said MEDIUM)_  
...
- [ ] **A4-RB-5** `mapping/map_source_runtime.py:427` [roborock] _(finder said MEDIUM)_  
...
- [ ] **A4-RB-6** `mapping/map_source_runtime.py:760` [roborock] _(finder said MEDIUM)_  
...
- [ ] **A3-IMAGE--11** `mapping/mapping_services.py:1089` [Both; any adapter that tunes min_area_pixels away from 1200.] _(finder said MEDIUM)_  
...
- [ ] **A4-CUSTOM-5** `mapping/mapping_services.py:1379` [Both — saved zones and queue zone steps exist for Eufy and Roborock alike.] _(finder said MEDIUM)_  
...
- [ ] **A5-FURNIS-3** `mapping/mapping_services.py:2076` [both] _(finder said MEDIUM)_  
...
- [ ] **A5-FURNIS-5** `mapping/mapping_services.py:2130` [both — sharpest on Roborock, whose rendered image is trimmed to the occupied extent] _(finder said MEDIUM)_  
...
- [ ] **A6-TRK-5** `mapping/tracker.py:47` [both] _(finder said MEDIUM)_  
...
- [ ] **DR-MAP-1** `maps/map_manager.py:62` [both]  
...
- [ ] **DR-MAP-2** `maps/map_manager.py:95` [both]  
...
- [ ] **A3-CRUD-6** `maps/map_manager.py:181` [both] _(finder said MEDIUM)_  
...
- [ ] **INF-3** `models/models.py:257` [both]  
...
- [ ] **A5-PP-RP-7** `planning/run_plan.py:125` [future_brand_only] _(finder said MEDIUM)_  
...
- [ ] **A6-PP-EST-H2O-2** `planning/run_plan.py:237` [future_brand_only] _(finder said MEDIUM)_  
...
- [ ] **A6-PP-EST-GUESS-1** `planning/run_plan.py:378` [eufy] _(finder said MEDIUM)_  
...
- [ ] **A5-PP-RP-6** `planning/run_plan.py:1458` [roborock] _(finder said MEDIUM)_  
...
- [ ] **A4-PP-RP-5** `profiles/manager.py:77` [both] _(finder said MEDIUM)_  
...
- [ ] **DQ-PAY-6** `profiles/manager.py:108` [roborock] _(finder said MEDIUM)_  
...
- [ ] **DQ-Q-4** `profiles/room_profiles.py:209` [roborock] _(finder said MEDIUM)_  
...
- [ ] **A1-PP-RES-6** `profiles/room_profiles.py:209` [roborock] _(finder said MEDIUM)_  
...
- [ ] **A2-PP-CAP-3** `profiles/room_profiles.py:496` [eufy] _(finder said MEDIUM)_  
...
- [ ] **DQ-DE-3** `queue/dispatch_engines.py:316` [future_brand_only] _(finder said MEDIUM)_  
...
- [ ] **DQ-PAY-5** `queue/queue_engine.py:182` [future_brand_only] _(finder said MEDIUM)_  
...
- [ ] **EP-8** `room_entities.py:217` [both]  
...
- [ ] **A3-CRUD-5** `rooms/room_manager.py:57` [both] _(finder said MEDIUM)_  
...
- [ ] **SN-8** `sensor/__init__.py:91` [both]  
...
- [ ] **SN-10b** `sensor/theme.py:75` [both]  
...
- [ ] **A4-SETUP-4** `services/adapter_config.py:57` [both] _(finder said HIGH)_  
...
- [ ] **A6-DIAG-7** `services/dock.py:59` [both] _(finder said MEDIUM)_  
...
- [ ] **A6-DIAG-4** `services/errors.py:71` [both] _(finder said MEDIUM)_  
...
- [ ] **A6-DIAG-5** `services/errors.py:93` [both] _(finder said MEDIUM)_  
...
- [ ] **A2-JOB-5** `services/queue.py:40` [both] _(finder said MEDIUM)_  
...
- [ ] **A2-JOB-6** `services/queue.py:51` [both] _(finder said MEDIUM)_  
...
- [ ] **A3-ROOMS-8** `services/room_profiles.py:97` [both] _(finder said MEDIUM)_  
...
- [ ] **A3-ROOMS-10** `services/rooms.py:251` [both] _(finder said MEDIUM)_  
...
- [ ] **A5-RUNPROF-5** `services/run_profiles.py:71` [both] _(finder said MEDIUM)_  
...
- [ ] **A5-RUNPROF-6** `services/run_profiles.py:152` [both] _(finder said MEDIUM)_  
...
- [ ] **A4-SETUP-9** `services/setup.py:131` [both] _(finder said MEDIUM)_  
...
- [ ] **A4-SETUP-12** `services/setup.py:184` [both] _(finder said MEDIUM)_  
...
- [ ] **A4-SETUP-8** `services/setup.py:222` [both] _(finder said MEDIUM)_  
...
- [ ] **DR-SETUP-3** `setup/drift.py:336` [both]  
...
- [ ] **DR-SETUP-4** `setup/protection.py:44` [both]  
...
- [ ] **A2-DRAFT-4** `themes/manager.py:111` [both] _(finder said MEDIUM)_  
...
- [ ] **A3-PORT-2** `themes/manager.py:643` [both] _(finder said HIGH)_  
