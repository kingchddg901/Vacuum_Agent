var Ue="eufy-vacuum-command-center";var y="eufy_vacuum";var ot="clear_queue";var lt="get_start_status",dt="start_selected_rooms";var ut="get_pause_timeout_settings",mt="set_pause_timeout_settings",vt="get_room_profiles",pt="save_user_room_profile",ht="save_room_profile_from_room",ft="overwrite_room_profile",gt="overwrite_room_profile_from_room",bt="rename_room_profile",_t="delete_room_profile",yt="apply_room_profile",xt="update_room_fields",wt="get_saved_run_profiles",St="save_run_profile",Rt="overwrite_run_profile",Et="apply_run_profile",kt="rename_run_profile",Tt="delete_run_profile";var Mt="get_theme_library",$t="save_theme_as_new",At="overwrite_theme",It="rename_theme",Ct="delete_theme",Ot="set_active_theme",Pt="update_working_draft",Lt="revert_draft",Nt="export_theme",Ft="import_theme",Ht="upload_map_image",Dt="analyze_map_image",Bt="get_map_segments",zt="adjust_map_segment",jt="set_segment_room_link",Vt="set_companion_anchor",qt="setup_get_status",Gt="setup_add_vacuum",Ut="setup_import_active_map",Wt="setup_get_map_rooms",Jt="setup_save_rooms",Kt="setup_delete_map",Yt="setup_reject_rooms",Qt="setup_force_remove_room";function ie(i){let e=String(i||"").split(".");return e.length>1?e[1]:e[0]}var _e={dockEvents:i=>`sensor.${ie(i)}_dock_events`,themeState:i=>`sensor.${ie(i)}_theme_state`,profileSensor:i=>`sensor.${ie(i)}_available_profiles`,activeMap:i=>`sensor.${ie(i)}_active_map`,robotPositionXRaw:i=>`sensor.${ie(i)}_robot_position_x_raw`,robotPositionYRaw:i=>`sensor.${ie(i)}_robot_position_y_raw`},Oe=new Set(["unknown","unavailable",""]);function Xt(i){i.entity=function(e){return e?this.hass?.states?.[e]??null:null},i.stateOf=function(e){return this.entity(e)?.state??null},i.attrsOf=function(e){return this.entity(e)?.attributes??{}},i.isValidState=function(e){return e==null?!1:!Oe.has(String(e))},i.hasEntity=function(e){let t=this.stateOf(e);return t!==null&&this.isValidState(t)},i.vacuumEntityId=function(){return this.config?.vacuum_entity_id??null},i.vacuumObjectId=function(){return ie(this.vacuumEntityId())},i.vacuumState=function(){let e=this.vacuumEntityId();return e?this.stateOf(e):null},i.vacuumAttrs=function(){let e=this.vacuumEntityId();return e?this.attrsOf(e):{}},i.batteryLevel=function(){let e=this.vacuumAttrs()?.battery_level,t=Number(e);return Number.isFinite(t)?t:null},i.isCharging=function(){let e=this.vacuumObjectId();return e?this.stateOf(`binary_sensor.${e}_charging`)==="on":!1},i.batteryState=function(){if(this.isCharging())return"charging";let e=this.batteryLevel();return e==null?"good":e<=15?"low":e<=25?"warn":e<=50?"mid":"good"},i.vacuumDisplayName=function(){let e=this.vacuumAttrs();if(e?.friendly_name)return String(e.friendly_name).trim();let t=this.vacuumObjectId();return t?t.replace(/_/g," ").replace(/\b\w/g,r=>r.toUpperCase()):"Vacuum"},i.rawRobotPosition=function(){let e=this.vacuumEntityId();if(!e)return null;let t=Number(this.stateOf(_e.robotPositionXRaw(e))),r=Number(this.stateOf(_e.robotPositionYRaw(e)));return!Number.isFinite(t)||!Number.isFinite(r)?null:{x:Math.round(t),y:Math.round(r)}},i.attrOf=function(e,t,r=null){let n=this.attrsOf(e)?.[t];return n!==void 0?n:r}}function Zt(i){i._ensureDockState=function(){return this._dockState||(this._dockState={actionStatus:null,pendingAction:"",pauseTimeoutSettings:null}),this._dockState},i.setDockActionStatus=function(e){this._ensureDockState().actionStatus=e??null},i.dockActionStatus=function(){return this._ensureDockState().actionStatus??null},i.beginDockAction=function(e){this._ensureDockState().pendingAction=String(e??"")},i.endDockAction=function(){this._ensureDockState().pendingAction=""},i.pendingDockAction=function(){return this._ensureDockState().pendingAction??""},i.isDockActionPending=function(e){return this.pendingDockAction()===String(e??"")},i.dockActionGate=function(e){return this.dockActionStatus()?.actions?.[e]??null},i.dockActionAllowed=function(e){return this.dockActionGate(e)?.allowed===!0},i.dockStatus=function(){return this.dockActionStatus()?.dock_status??this.dashboardUpkeep?.()?.dock_status??null},i.dockStatusLabel=function(){return this.dockActionStatus()?.dock_status_label??this.dashboardUpkeep?.()?.dock_status_label??null},i.dockLifecycleState=function(){return this.dockActionStatus()?.lifecycle_state??null},i.dockLifecycleStateLabel=function(){return this.dockActionStatus()?.lifecycle_state_label??null},i.dockTaskStatus=function(){return this.dockActionStatus()?.task_status??this.dockActionStatus()?.active_job_status??null},i.dockTaskStatusLabel=function(){return this.dockActionStatus()?.task_status_label??this.dockActionStatus()?.active_job_status_label??null},i.isDocked=function(){return this.dockActionStatus()?.docked===!0},i.stationWaterLabel=function(){return this.dashboardUpkeep?.()?.station_water_label??null},i.setPauseTimeoutSettings=function(e){this._ensureDockState().pauseTimeoutSettings=e??null},i.pauseTimeoutSettings=function(){return this._ensureDockState().pauseTimeoutSettings??null},i.pauseTimeoutMinutesDefault=function(){let e=this.pauseTimeoutSettings?.(),t=Number(e?.pause_timeout_minutes_default);return Number.isFinite(t)?t:null}}var he={LEARNING:"learning",ROOMS:"rooms",PROFILES:"profiles",WATER:"water",DOCK:"dock",BATTERY:"battery"};function er(i){i._ensureMetricsState=function(){return this._metricsState||(this._metricsState={snapshot:null,filters:{room_slug:"",profile_key:"",status:"",used_for_learning:""},activeTab:he.LEARNING,pendingSaveKey:""}),this._metricsState},i.metricsSnapshot=function(){return this._ensureMetricsState().snapshot??null},i.setMetricsSnapshot=function(e){let t=this._ensureMetricsState();t.snapshot=e??null;let r=e?.filters;r&&typeof r=="object"&&(t.filters={room_slug:r.room_slug==null?"":String(r.room_slug),profile_key:r.profile_key==null?"":String(r.profile_key),status:r.status==null?"":String(r.status),used_for_learning:typeof r.used_for_learning=="boolean"?String(r.used_for_learning):""})},i.metricsFilters=function(){return this._ensureMetricsState().filters},i.setMetricsFilter=function(e,t){let r=this.metricsFilters();e in r&&(r[e]=t==null?"":String(t))},i.metricsActiveTab=function(){return this._ensureMetricsState().activeTab??he.LEARNING},i.setMetricsActiveTab=function(e){let t=String(e??"").trim().toLowerCase();Object.values(he).includes(t)&&(this._ensureMetricsState().activeTab=t)},i.metricsTabOptions=function(){return[{value:he.LEARNING,label:"Learning"},{value:he.ROOMS,label:"Rooms"},{value:he.PROFILES,label:"Profiles"},{value:he.WATER,label:"Water"},{value:he.DOCK,label:"Dock"},{value:he.BATTERY,label:"Battery"}]},i.metricsOverview=function(){return this.metricsSnapshot()?.overview??{}},i.metricsSelection=function(){return this.metricsSnapshot()?.selection??{}},i.metricsRooms=function(){return Array.isArray(this.metricsSnapshot()?.rooms)?this.metricsSnapshot().rooms:[]},i.metricsRoomProfiles=function(){return Array.isArray(this.metricsSnapshot()?.room_profiles)?this.metricsSnapshot().room_profiles:[]},i.metricsFoundProfiles=function(){return Array.isArray(this.metricsSnapshot()?.found_profiles)?this.metricsSnapshot().found_profiles:[]},i.metricsLearningStats=function(){return this.metricsSnapshot()?.room_learning_stats??{}},i.metricsSources=function(){return this.metricsSnapshot()?.sources??{}},i.beginMetricsProfileSave=function(e){this._ensureMetricsState().pendingSaveKey=String(e??"")},i.endMetricsProfileSave=function(){this._ensureMetricsState().pendingSaveKey=""},i.isMetricsProfileSavePending=function(e){return this._ensureMetricsState().pendingSaveKey===String(e??"")},i.metricsProfileSaveKey=function(e,t){let r=String(e??"profile"),a=String(t?.room_slug??""),n=String(t?.profile_key??"");return`${r}:${a}:${n}`},i.findMetricsSaveCandidate=function(e,t,r=""){let a=String(e??""),n=String(t??""),c=String(r??"");return n?(a==="found"?this.metricsFoundProfiles?.()??[]:this.metricsRoomProfiles?.()??[]).find(o=>String(o?.profile_key??"")===n&&String(o?.room_slug??"")===c)??null:null},i.metricsFilterRoomOptions=function(){let e=this.metricsSnapshot()?.filter_options?.rooms;return Array.isArray(e)&&e.length?e:[]},i.metricsFilterProfileOptions=function(){let e=this.metricsSnapshot()?.filter_options?.profiles;return Array.isArray(e)&&e.length?e:[]},i.metricsFilterStatusOptions=function(){let e=this.metricsSnapshot()?.filter_options?.statuses;return Array.isArray(e)&&e.length?e:[]},i.metricsFilterUsedOptions=function(){let e=this.metricsSnapshot()?.filter_options?.used_for_learning;return Array.isArray(e)&&e.length?e:[]},i._batterySensor=function(e){let t=this.vacuumObjectId();if(!t)return null;let r=`sensor.${t}_${e}`,a=this.stateOf(r);return a==null?null:{entity_id:r,state:a,attrs:this.attrsOf(r)??{}}},i.batteryMetrics=function(){return{cycles:this._batterySensor("charge_cycles"),health:this._batterySensor("battery_health"),rate_overall:this._batterySensor("charge_rate"),rate_low:this._batterySensor("charge_rate_low_zone"),rate_high:this._batterySensor("charge_rate_high_zone"),rate_mid_job:this._batterySensor("mid_job_recharge_rate"),last_charge_duration:this._batterySensor("last_charge_duration"),last_job_per_min:this._batterySensor("last_job_drain_rate")||this._batterySensor("last_job_drain_per_min"),last_job_per_hour:this._batterySensor("last_job_drain_per_hour"),last_job_per_m2:this._batterySensor("last_job_drain_per_m2")||this._batterySensor("last_job_drain_per_m_")}}}function tr(i){i._ensureOrderState=function(){return this._orderState||(this._orderState={scope:null,activeItemId:null,targetPosition:null,dragItemId:null,dragOverItemId:null}),this._orderState},i.resetOrderState=function(){this._orderState={scope:null,activeItemId:null,targetPosition:null,dragItemId:null,dragOverItemId:null}},i._normalizeNumericOrder=function(e,t=999999){let r=Number(e);return Number.isFinite(r)?r:t},i._sortOrderedItems=function(e,t){let r=Array.isArray(e)?[...e]:[],a=t.getOrder,n=t.getId;return r.sort((c,s)=>{let o=this._normalizeNumericOrder(a(c)),l=this._normalizeNumericOrder(a(s));if(o!==l)return o-l;let d=String(n(c)),u=String(n(s));return d.localeCompare(u)})},i._reindexOrderedItems=function(e,t){let r=t.setOrder;return e.map((a,n)=>r(a,n+1))},i._moveOrderedItemToPosition=function(e,t,r,a){let n=this._reindexOrderedItems(this._sortOrderedItems(e,t),t),c=t.getId,s=Math.max(1,Math.min(Number(a)||1,n.length)),o=n.findIndex(u=>String(c(u))===String(r));if(o===-1)return n;let l=[...n],[d]=l.splice(o,1);return l.splice(s-1,0,d),this._reindexOrderedItems(l,t)},i._swapOrderedItemsById=function(e,t,r,a){let n=this._reindexOrderedItems(this._sortOrderedItems(e,t),t),c=t.getId,s=n.findIndex(u=>String(c(u))===String(r)),o=n.findIndex(u=>String(c(u))===String(a));if(s===-1||o===-1||s===o)return n;let l=[...n],[d]=l.splice(s,1);return l.splice(o,0,d),this._reindexOrderedItems(l,t)},i._buildOrderPatch=function(e,t){let r=t.getId,a=t.getOrder;return e.map(n=>({id:r(n),order:this._normalizeNumericOrder(a(n),1)}))},i.getOrderAdapter=function(e){return null},i.getOrderedItemsForScope=function(e){let t=this.getOrderAdapter(e);if(!t?.getItems)return[];let r=t.getItems.call(this);return this._reindexOrderedItems(this._sortOrderedItems(r,t),t)},i.getOrderedItemById=function(e,t){let r=this.getOrderedItemsForScope(e),a=this.getOrderAdapter(e);return a?r.find(n=>String(a.getId(n))===String(t))??null:null},i.getOrderedItemPosition=function(e,t){let r=this.getOrderedItemsForScope(e),a=this.getOrderAdapter(e);if(!a)return null;let n=r.findIndex(c=>String(a.getId(c))===String(t));return n===-1?null:n+1},i.openOrderSelector=function(e,t){let r=this._ensureOrderState(),a=this.getOrderedItemPosition(e,t);r.scope=e,r.activeItemId=t,r.targetPosition=a},i.closeOrderSelector=function(){let e=this._ensureOrderState();e.scope=null,e.activeItemId=null,e.targetPosition=null},i.isOrderSelectorOpen=function(){let e=this._ensureOrderState();return!!(e.scope&&e.activeItemId!=null)},i.orderSelectorScope=function(){return this._ensureOrderState().scope},i.orderSelectorItemId=function(){return this._ensureOrderState().activeItemId},i.orderSelectorItem=function(){let e=this._ensureOrderState();return!e.scope||e.activeItemId==null?null:this.getOrderedItemById(e.scope,e.activeItemId)},i.orderSelectorTargetPosition=function(){return this._ensureOrderState().targetPosition},i.setOrderSelectorTargetPosition=function(e){let t=this._ensureOrderState();t.targetPosition=Number(e)||1},i.orderSelectorPositions=function(){let e=this._ensureOrderState();if(!e.scope)return[];let t=this.getOrderedItemsForScope(e.scope);return Array.from({length:t.length},(r,a)=>a+1)},i.beginOrderDrag=function(e,t){let r=this._ensureOrderState();r.scope=e,r.dragItemId=t,r.dragOverItemId=t},i.setOrderDragOverItem=function(e){let t=this._ensureOrderState();t.dragOverItemId=e},i.orderDragItemId=function(){return this._ensureOrderState().dragItemId},i.orderDragOverItemId=function(){return this._ensureOrderState().dragOverItemId},i.clearOrderDrag=function(){let e=this._ensureOrderState();e.dragItemId=null,e.dragOverItemId=null},i.previewMovedItemsForScope=function(e,t,r){let a=this.getOrderAdapter(e);if(!a)return[];let n=a.getItems.call(this);return this._moveOrderedItemToPosition(n,a,t,r)},i.previewDraggedItemsForScope=function(e,t,r){let a=this.getOrderAdapter(e);if(!a)return[];let n=a.getItems.call(this);return this._swapOrderedItemsById(n,a,t,r)}}function rr(i){i._ensureRoomProfilesState=function(){return this._roomProfilesState||(this._roomProfilesState={profile_count:0,protected_profile_names:[],profiles:{}}),this._roomProfilesState},i._normalizeRoomProfile=function(e,t={}){return{name:String(e??""),label:String(t?.label??e??"Unnamed Profile"),clean_mode:String(t?.clean_mode??"vacuum"),fan_speed:String(t?.fan_speed??""),water_level:String(t?.water_level??""),clean_intensity:String(t?.clean_intensity??"Quick"),clean_passes:Number(t?.clean_passes??1),carpet:!!t?.carpet,edge_mopping:!!t?.edge_mopping}},i.setRoomProfilesLibrary=function(e){let t=this._ensureRoomProfilesState(),r=e?.profiles&&typeof e.profiles=="object"&&!Array.isArray(e.profiles)?e.profiles:{},a=Array.isArray(e?.protected_profile_names)?e.protected_profile_names.map(n=>String(n)):[];t.profile_count=Number(e?.profile_count??Object.keys(r).length??0),t.protected_profile_names=a,t.profiles=Object.fromEntries(Object.entries(r).map(([n,c])=>[String(n),this._normalizeRoomProfile(n,c)]).filter(([n])=>n))},i.roomProfilesLibrary=function(){return this._ensureRoomProfilesState().profiles},i.roomProfilesCount=function(){return this._ensureRoomProfilesState().profile_count??0},i.protectedRoomProfileNames=function(){return this._ensureRoomProfilesState().protected_profile_names??[]},i.isProtectedRoomProfile=function(e){let t=String(e??"").trim();return t?this.protectedRoomProfileNames().includes(t):!1},i.roomProfileDefinition=function(e){let t=String(e??"").trim();return t?this.roomProfilesLibrary()?.[t]??null:null},i.roomProfilesList=function(){let e=this.roomProfilesLibrary();return Object.values(e).sort((t,r)=>{let a=this.isProtectedRoomProfile(t.name),n=this.isProtectedRoomProfile(r.name);return a!==n?a?-1:1:String(t.label).localeCompare(String(r.label),void 0,{sensitivity:"base"})})},i.customRoomProfiles=function(){return this.roomProfilesList().filter(e=>!this.isProtectedRoomProfile(e.name))},i.makeRoomProfileName=function(e,t=null){let a=String(e??"").trim().toLowerCase().replace(/[^a-z0-9]+/g,"_").replace(/^_+|_+$/g,"").replace(/_+/g,"_"),n=a?`custom_${a}`:"custom_profile",c=String(t??"").trim();if(c&&c===n)return c;let s=new Set(Object.keys(this.roomProfilesLibrary()??{}));if(!s.has(n))return n;let o=2;for(;s.has(`${n}_${o}`);)o+=1;return`${n}_${o}`}}function ar(i){i._emptyRunProfileDraft=function(){return{name:"",expose_as_button:!1}},i._normalizeRunProfilesPayload=function(e){return Array.isArray(e)?{profiles:e,library:{}}:e&&typeof e=="object"?{profiles:Array.isArray(e.profiles)?e.profiles:Array.isArray(e.saved_run_profiles)?e.saved_run_profiles:[],library:e.library&&typeof e.library=="object"&&!Array.isArray(e.library)?e.library:{}}:{profiles:[],library:{}}},i._normalizeRunProfile=function(e){return{id:String(e?.id??e?.profile_id??""),name:String(e?.name??"Unnamed Profile"),vacuum_entity_id:String(e?.vacuum_entity_id??""),map_id:String(e?.map_id??""),room_count:Number(e?.room_count??0),room_ids:Array.isArray(e?.room_ids)?e.room_ids:[],room_names:Array.isArray(e?.room_names)?e.room_names:[],room_names_label:String(e?.room_names_label??""),expose_as_button:!!e?.expose_as_button,summary:String(e?.summary??""),created_at:String(e?.created_at??""),updated_at:String(e?.updated_at??""),rooms:Array.isArray(e?.rooms)?e.rooms:[]}},i._ensureRunProfilesState=function(){return this._runProfilesState||(this._runProfilesState={profiles:[],selectedProfileId:null,editorOpen:!1,editorMode:"new",editorProfileId:null,draft:this._emptyRunProfileDraft()}),this._runProfilesState},i.setRunProfilesLibrary=function(e){let t=this._ensureRunProfilesState(),r=this._normalizeRunProfilesPayload(e),a=r.profiles.map(n=>{let c=String(n?.id??n?.profile_id??""),s=c&&r.library?.[c]?r.library[c]:null;return this._normalizeRunProfile({...n,...s??{}})}).filter(n=>n.id);t.profiles=a,t.selectedProfileId&&!a.some(n=>n.id===t.selectedProfileId)&&(t.selectedProfileId=null),t.editorProfileId&&!a.some(n=>n.id===t.editorProfileId)&&(t.editorOpen=!1,t.editorMode="new",t.editorProfileId=null,t.draft=this._emptyRunProfileDraft())},i.savedRunProfiles=function(){return this._ensureRunProfilesState().profiles},i.savedRunProfilesCount=function(){return this.savedRunProfiles().length},i.selectedRunProfileId=function(){return this._ensureRunProfilesState().selectedProfileId??null},i.selectedRunProfile=function(){let e=this._ensureRunProfilesState();return e.profiles.find(t=>t.id===e.selectedProfileId)??null},i.selectRunProfile=function(e){let t=this._ensureRunProfilesState();t.selectedProfileId=e?String(e):null},i.openNewRunProfileEditor=function(){let e=this._ensureRunProfilesState();e.editorOpen=!0,e.editorMode="new",e.editorProfileId=null,e.draft=this._emptyRunProfileDraft()},i.openSelectedRunProfileEditor=function(){let e=this._ensureRunProfilesState(),t=this.selectedRunProfile();t&&(e.editorOpen=!0,e.editorMode="edit",e.editorProfileId=t.id,e.draft={name:t.name,expose_as_button:!!t.expose_as_button})},i.closeRunProfileEditor=function(){let e=this._ensureRunProfilesState();e.editorOpen=!1,e.editorMode="new",e.editorProfileId=null,e.draft=this._emptyRunProfileDraft()},i.isRunProfileEditorOpen=function(){return this._ensureRunProfilesState().editorOpen===!0},i.runProfileEditorMode=function(){return this._ensureRunProfilesState().editorMode??"new"},i.runProfileDraft=function(){return this._ensureRunProfilesState().draft},i.updateRunProfileDraft=function(e,t){let r=this._ensureRunProfilesState();if(e==="expose_as_button"){r.draft={...r.draft,expose_as_button:!!t};return}r.draft={...r.draft,[e]:t}}}var ye={NEWEST:"newest",OUTLIER:"outlier",SUGGESTED:"suggested",EXCLUDED:"excluded"},ir="manual_test_run",nr=Object.freeze({clean_mode:"Vacuum",fan_speed:"Standard",water_level:null,clean_intensity:"Quick",clean_passes:1,edge_mopping:!1});function cr(i){i._ensureReviewState=function(){return this._reviewState||(this._reviewState={snapshot:null,filters:{room_slug:"",profile_key:"",status:"",used_for_learning:"",limit:50},sort:ye.NEWEST,excludeReasons:{},pendingJobActionId:"",matcherFields:{...nr}}),this._reviewState},i.learningHistorySnapshot=function(){return this._ensureReviewState().snapshot??null},i.setLearningHistorySnapshot=function(e){let t=this._ensureReviewState();t.snapshot=e??null;let r=e?.filters;r&&typeof r=="object"&&(t.filters={room_slug:r.room_slug==null?"":String(r.room_slug),profile_key:r.profile_key==null?"":String(r.profile_key),status:r.status==null?"":String(r.status),used_for_learning:typeof r.used_for_learning=="boolean"?String(r.used_for_learning):"",limit:Number.isFinite(Number(r.limit))&&Number(r.limit)>0?Number(r.limit):t.filters?.limit??50})},i.learningHistoryFilters=function(){return this._ensureReviewState().filters},i.setLearningHistoryFilter=function(e,t){let r=this.learningHistoryFilters();if(e in r){if(e==="limit"){let a=Number(t);r[e]=Number.isFinite(a)&&a>0?a:50;return}r[e]=t==null?"":String(t)}},i.learningHistorySort=function(){return this._ensureReviewState().sort??ye.NEWEST},i.setLearningHistorySort=function(e){let t=String(e??"").trim().toLowerCase();Object.values(ye).includes(t)&&(this._ensureReviewState().sort=t)},i.learningHistoryJobs=function(){let e=this.learningHistorySnapshot()?.jobs;return Array.isArray(e)?e:[]},i.learningHistoryRooms=function(){let e=this.learningHistorySnapshot?.()?.filter_options?.rooms;if(Array.isArray(e)&&e.length)return e.filter(c=>String(c?.value??"").trim()!=="").map(c=>({room_slug:String(c?.value??""),room_name:String(c?.label??c?.value??"")}));let t=this.learningHistorySnapshot?.(),r=Array.isArray(t?.rooms)?t.rooms:[],a=Array.isArray(t?.jobs)?t.jobs.flatMap(c=>Array.isArray(c?.room_slugs)?c.room_slugs.map(s=>({room_slug:s,room_name:this._formatReviewRoomLabel?.(s)??s})):[]):[],n=new Map;for(let c of[...r,...a]){let s=String(c?.room_slug??c?.slug??"").trim();s&&(n.has(s)||n.set(s,{room_slug:s,room_name:c?.room_name??c?.label??this._formatReviewRoomLabel?.(s)??s}))}return Array.from(n.values()).sort((c,s)=>String(c.room_name??c.room_slug).localeCompare(String(s.room_name??s.room_slug)))},i.learningHistoryProfiles=function(){let e=this.learningHistorySnapshot?.()?.filter_options?.profiles;if(Array.isArray(e)&&e.length)return e.filter(c=>String(c?.value??"").trim()!=="").map(c=>({profile_key:String(c?.value??""),label:String(c?.label??c?.value??""),subtitle:c?.subtitle==null?null:String(c.subtitle),room_slug:c?.room_slug==null?null:String(c.room_slug),room_label:c?.room_label==null?null:String(c.room_label)}));let t=this.learningHistorySnapshot?.(),r=Array.isArray(t?.found_profiles)?t.found_profiles:[],a=Array.isArray(t?.room_profiles)?t.room_profiles:[],n=new Map;for(let c of[...r,...a]){let s=String(c?.profile_key??"").trim();s&&(n.has(s)||n.set(s,{profile_key:s,label:c?.profile_label??c?.label??c?.selected_profile_label??s,subtitle:c?.profile_subtitle??c?.resolved_profile_label??null}))}return Array.from(n.values()).sort((c,s)=>String(c.label??c.profile_key).localeCompare(String(s.label??s.profile_key)))},i.learningHistoryExcludeReason=function(e){return this._ensureReviewState().excludeReasons[String(e??"")]||ir},i.setLearningHistoryExcludeReason=function(e,t){this._ensureReviewState().excludeReasons[String(e??"")]=String(t??ir)},i.beginLearningHistoryJobAction=function(e){this._ensureReviewState().pendingJobActionId=String(e??"")},i.endLearningHistoryJobAction=function(){this._ensureReviewState().pendingJobActionId=""},i.isLearningHistoryJobActionPending=function(e){return this._ensureReviewState().pendingJobActionId===String(e??"")},i.learningHistorySortOptions=function(){return[{value:ye.NEWEST,label:"Newest"},{value:ye.OUTLIER,label:"Highest Outlier"},{value:ye.SUGGESTED,label:"Suggested Exclude"},{value:ye.EXCLUDED,label:"Excluded Only"}]},i.learningHistoryStatusOptions=function(){let e=this.learningHistorySnapshot?.()?.filter_options?.statuses;return Array.isArray(e)&&e.length?e.map(t=>({value:String(t?.value??""),label:String(t?.label??t?.value??"")})):[{value:"",label:"All Statuses"},{value:"completed",label:"Completed"},{value:"canceled",label:"Canceled"},{value:"failed",label:"Failed"},{value:"interrupted",label:"Interrupted"}]},i.learningHistoryUsedOptions=function(){let e=this.learningHistorySnapshot?.()?.filter_options?.used_for_learning;return Array.isArray(e)&&e.length?e.map(t=>({value:String(t?.value_key??t?.value??""),label:String(t?.label??t?.value_key??t?.value??"")})):[{value:"",label:"All Learning Use"},{value:"true",label:"Used For Learning"},{value:"false",label:"Not Used For Learning"}]},i.learningHistoryExcludeReasonOptions=function(){return[{value:"short_test_cancel",label:"Short Test Cancel"},{value:"manual_test_run",label:"Manual Test Run"},{value:"false_completion",label:"False Completion"},{value:"bad_room_attribution",label:"Bad Room Attribution"},{value:"interrupted_run",label:"Interrupted Run"}]},i._formatReviewRoomLabel=function(e){return String(e??"").replace(/[_-]+/g," ").replace(/\b\w/g,t=>t.toUpperCase())},i.reviewProfileMatcherFields=function(){return this._ensureReviewState().matcherFields},i.resetReviewProfileMatcher=function(){this._ensureReviewState().matcherFields={...nr}},i.setReviewProfileMatcherField=function(e,t){let r=this.reviewProfileMatcherFields();if(!r||!(e in r))return;let a=t;if(e==="clean_mode"&&(a=this._canonicalCleanModeDisplay?.(t)??t),e==="clean_passes"){let n=Number(t);a=Number.isFinite(n)&&n>0?n:1}e==="edge_mopping"&&(a=t===!0||String(t??"").trim().toLowerCase()==="true"),r[e]=a,e==="clean_mode"&&!this.isMopMode?.(a)&&(r.water_level=null,r.edge_mopping=!1)},i.showReviewProfileMatcherWaterLevel=function(){let e=this.reviewProfileMatcherFields();return e?this.isMopMode?.(e.clean_mode)??!1:!1},i.showReviewProfileMatcherEdgeMopping=function(){let e=this.reviewProfileMatcherFields();return e?this.isMopMode?.(e.clean_mode)??!1:!1},i.reviewProfileMatcherCatalog=function(){let e=this.attrsOf?.(_e.profileSensor(this.vacuumEntityId()))??{},t=e.profiles??{},r=e.profile_labels??{},a=this.learningHistoryProfiles?.()??[],n=new Map(a.map(s=>[String(s?.profile_key??""),String(s?.label??s?.profile_key??"")]).filter(([s])=>s)),c=new Map;for(let[s,o]of Object.entries(t)){let l=String(s??"").trim();l&&(c.has(l)||c.set(l,{profile_key:l,label:n.get(l)||r[l]||l,definition:o}))}for(let s of a){let o=String(s?.profile_key??"").trim();!o||c.has(o)||c.set(o,{profile_key:o,label:String(s?.label??o),definition:null})}return Array.from(c.values()).sort((s,o)=>String(s.label??s.profile_key).localeCompare(String(o.label??o.profile_key)))},i.reviewProfileMatcherMatches=function(){let e=this.reviewProfileMatcherFields(),t=this.reviewProfileMatcherCatalog();return!e||!t.length?[]:t.filter(r=>r?.definition?this._editorFieldsMatchProfile?.(e,r.definition)===!0:!1)}}function sr(i){i._normalizeRoomReferenceList=function(e){return e==null?[]:(Array.isArray(e)?e:[e]).map(r=>String(r??"").trim()).filter(r=>r!=="")},i._buildRoomAccessAdjacency=function(e=[]){let t={};return e.forEach(r=>{t[String(r.id)]=this._normalizeRoomReferenceList(r.grantsAccessTo)}),t},i._roomAccessGraphHasCycle=function(e={}){let t=new Set,r=new Set,a=n=>{if(r.has(n))return!0;if(t.has(n))return!1;t.add(n),r.add(n);let c=e[n]??[];for(let s of c)if(s in e&&a(s))return!0;return r.delete(n),!1};return Object.keys(e).some(n=>a(n))},i.roomAccessGraph=function(e=null){let t=e==null?this.getRoomsForActiveMap():this.getRoomsForMap(e),r=this._buildRoomAccessAdjacency(t);return t.map(a=>{let n=String(a.id),c=r[n]??[],s=t.filter(o=>(r[String(o.id)]??[]).includes(n)).map(o=>String(o.id));return{roomId:n,grantsAccessTo:c,requiresAccessFrom:s}})},i.validateRoomAccessUpdate=function(e,t,r=[]){let a=this.getRoomsForMap(e),n=String(t??"").trim(),c=new Set(a.map(h=>String(h.id))),s=this._normalizeRoomReferenceList(r),o=s.filter((h,b)=>s.indexOf(h)!==b),l=Array.from(new Set(s)),d=l.filter(h=>!c.has(h)),u=l.includes(n),m=[];c.has(n)||m.push({code:"missing_room",message:"This room no longer exists on the active map."}),u&&m.push({code:"self_reference",message:"A room cannot grant access to itself."}),o.length&&m.push({code:"duplicate_edges",message:"Each access link can only appear once.",roomIds:Array.from(new Set(o))}),d.length&&m.push({code:"missing_room_references",message:"All access links must point to rooms on the current map.",roomIds:d});let v=this._buildRoomAccessAdjacency(a),p=this._buildClaimedTargetMap(a,n),f=l.filter(h=>p.has(h)&&c.has(h));if(f.length){let h=Object.fromEntries(a.map(b=>[String(b.id),b.name]));f.forEach(b=>{let R=p.get(b),S=h[R]??`Room ${R}`,g=h[b]??`Room ${b}`;m.push({code:"multiple_inbound",message:`${g} already has an inbound link from ${S}. Each room can only be reached from one room.`,roomIds:[b,R].filter(Boolean)})})}return v[n]=l.filter(h=>c.has(h)),!m.length&&this._roomAccessGraphHasCycle(v)&&m.push({code:"cycle",message:"This access setup would create a loop in the room graph."}),{valid:m.length===0,issues:m,normalizedGrantsAccessTo:v[n]??[]}},i.orphanedRooms=function(e=null){let t=e!=null?this.getRoomsForMap(e):this.getRoomsForActiveMap();if(!t.some(n=>n.isDockRoom))return[];let a=new Set;return t.forEach(n=>{this._normalizeRoomReferenceList(n.grantsAccessTo).forEach(c=>{a.add(c)})}),t.filter(n=>n.isDockRoom?!1:!a.has(String(n.id)))},i._buildClaimedTargetMap=function(e=[],t=""){let r=new Map;return e.forEach(a=>{String(a.id)!==String(t)&&this._normalizeRoomReferenceList(a.grantsAccessTo).forEach(n=>{r.has(n)||r.set(n,String(a.id))})}),r},i.setStartStatus=function(e){this._startStatus=e??null},i.startPreflight=function(){let e=this.dashboardJobControl?.()?.preflight??this.dashboardStartStatus?.()?.preflight??this._startStatus?.preflight??null;if(e)return e;let t=this._startStatus??this.dashboardStartStatus?.()??null;return t?.selected_room_ids||t?.blocked_rooms||t?.modified_rooms?t:null},i.setStartConfirmation=function(e=null,t=null){this._startConfirmation={preflight:e??this.startPreflight(),confirmToken:t??e?.confirm_token??null}},i.clearStartConfirmation=function(){this._startConfirmation=null},i.startConfirmation=function(){return this._startConfirmation??null},i.startRequiresConfirmation=function(){return!!(this._startConfirmation?.confirmToken||this._startConfirmation?.preflight?.requires_confirmation)},i.startConfirmationToken=function(){return this._startConfirmation?.confirmToken??this._startConfirmation?.preflight?.confirm_token??null},i.requestCancelRunConfirmation=function(){this._cancelRunConfirmation=!0},i.clearCancelRunConfirmation=function(){this._cancelRunConfirmation=!1},i.cancelRunRequiresConfirmation=function(){return this._cancelRunConfirmation===!0},i.hasActiveRun=function(){let e=String(this.vacuumState()??"").toLowerCase();return e==="cleaning"||e==="paused"?!0:this._dashboardJobIsActive?.()??!1},i.shouldShowLiveQueue=function(){return(this.dashboardJobProgressTimeline?.()??[]).length>0&&this.hasActiveRun()},i.canPauseRun=function(){return String(this.vacuumState()??"").toLowerCase()==="cleaning"},i.canResumeRun=function(){return String(this.vacuumState()??"").toLowerCase()==="paused"},i.activeMapId=function(){let e=_e.activeMap(this.vacuumEntityId()),t=this.stateOf(e);if(t&&!Oe.has(String(t)))return String(t);let r=this._findRoomSwitchEntities();return r.length>0?String(r[0].attributes.map_id??"1"):"1"},i.queueChipLongPressMs=function(){let e=Number(this.config?.theme?.queue_chip_long_press_ms),t=Number(this.config?.queue_chip_long_press_ms),r=Number.isFinite(e)?e:Number.isFinite(t)?t:450;return Math.min(1e3,Math.max(250,r))},i._findRoomSwitchEntities=function(){let e=this.hass,t=this.vacuumEntityId();if(!e?.states||!t)return[];let r=[];for(let[a,n]of Object.entries(e.states)){if(!a.startsWith("switch."))continue;let c=n?.attributes;c&&c.vacuum_entity_id===t&&c.room_id!=null&&c.map_id!=null&&"enabled"in c&&r.push({entityId:a,state:n.state,attributes:c})}return r},i._findRoomOrderNumberEntities=function(){let e=this.hass,t=this.vacuumEntityId();if(!e?.states||!t)return[];let r=[];for(let[a,n]of Object.entries(e.states)){if(!a.startsWith("number."))continue;let c=n?.attributes;c&&c.vacuum_entity_id===t&&c.room_id!=null&&c.map_id!=null&&r.push({entityId:a,state:n.state,attributes:c})}return r},i.findRoomOrderNumberEntityId=function(e,t){let r=Object.values(this.hass?.states??{}),a=String(e),n=String(t),c=r.filter(o=>{if(!o?.entity_id?.startsWith("number."))return!1;let l=o.attributes??{};return String(l.map_id)===a&&String(l.room_id)===n});return c.find(o=>String(o.entity_id).toLowerCase().endsWith("_order"))?.entity_id??c[0]?.entity_id??null},i.findRoomSwitchEntityId=function(e,t){let r=this._findRoomSwitchEntities(),a=String(t),n=String(e);return r.find(s=>String(s.attributes.map_id)===n&&String(s.attributes.room_id)===a)?.entityId??null},i.getRoomsForActiveMap=function(){let e=this.activeMapId();return this.getRoomsForMap(e)},i.getRoomsForMap=function(e){let t=this._findRoomSwitchEntities(),r=this._findRoomOrderNumberEntities(),a={};for(let c of r){if(String(c.attributes.map_id)!==String(e))continue;let s=String(c.attributes.room_id),o=Number(c.state),l=String(c.entityId).toLowerCase().endsWith("_order");Number.isFinite(o)&&(!(s in a)||l)&&(a[s]=o)}let n=t.filter(c=>String(c.attributes.map_id)===String(e)).map(c=>{let s=String(c.attributes.room_id),o=c.state==="on",l=s in a?a[s]:c.attributes.order;return this._normalizeRoom(c.attributes,o,l)});return n.sort((c,s)=>{let o=(c.order??999)-(s.order??999);return o!==0?o:String(c.name).localeCompare(String(s.name))}),n},i._normalizeRoom=function(e,t,r=null){let a=Number(e.room_id),n=String(e.map_id??""),c=String(e.room_name??`Room ${e.room_id}`),s=e.slug??null,o=t!==void 0?!!t:!!e.enabled,l=Number(r??e.order??999),d=String(e.profile_name??"vacuum_quick"),u=e.profile_label??null,m=e.profile_subtitle??null,v=String(e.floor_type??""),p=e.floor_type_label??null,f=String(e.carpet_type??""),h=e.carpet_type_label??null,b=!!(e.carpet??(()=>{let E=String(v).toLowerCase();return E==="carpet"||E.startsWith("carpet_")||E.startsWith("carpet-")})()),R=e.clean_mode??"vacuum",S=e.fan_speed??null,g=e.water_level??null,x=e.clean_intensity??null,w=Number(e.clean_passes??1),I=!!(e.edge_mopping??!1),O=e.clean_mode_label??null,W=e.fan_speed_label??null,Y=e.water_level_label??null,fe=e.clean_intensity_label??e.path_type_label??null,V=e.clean_passes_label??null,ve=e.edge_mopping_label??null,re=String(R??"").toLowerCase(),le=re==="vacuum",P=re==="mop"||re==="vacuum_mop"||re.includes("mop")||re.includes("wash"),L=!!(e.is_dock_room??e.isDockRoom??!1),U=!!(e.is_transition??e.isTransition??!1),F=!!(e.transition_candidate??e.transitionCandidate??!1),Z=Number(e.transition_score??e.transitionScore??0),oe=this._normalizeRoomReferenceList(e.grants_access_to??e.grantsAccessTo),ae=this._normalizeRoomReferenceList(e.requires_access_from??e.requiresAccessFrom),pe=e.rules??e.automation_rules,$e=Array.isArray(pe)?pe:[];return{id:a,mapId:n,name:c,slug:s,enabled:o,order:l,profileName:d,profileLabel:u,profileSubtitle:m,floorType:v,floorTypeLabel:p,carpetType:f,carpetTypeLabel:h,carpet:b,cleanMode:R,cleanModeLabel:O,fanSpeed:S,fanSpeedLabel:W,waterLevel:g,waterLevelLabel:Y,cleanIntensity:x,cleanIntensityLabel:fe,cleanPasses:w,cleanPassesLabel:V,edgeMopping:I,edgeMoppingLabel:ve,isCustomProfile:d.toLowerCase()==="custom",isVacuumOnly:le,isMopCapable:P,isDockRoom:L,isTransition:U,transitionCandidate:F,transitionScore:Z,rules:$e,profile:d,passes:w,grantsAccessTo:oe,requiresAccessFrom:ae,profile_name:d,floor_type:v,floor_type_label:p,carpet_type:f,carpet_type_label:h,clean_mode:R,clean_mode_label:O,fan_speed:S,fan_speed_label:W,water_level:g,water_level_label:Y,clean_intensity:x,clean_intensity_label:fe,clean_passes:w,clean_passes_label:V,edge_mopping:I,edge_mopping_label:ve,map_id:n,room_id:a,room_name:c,grants_access_to:oe,requires_access_from:ae,is_transition:U,transition_candidate:F,transition_score:Z}},i._roomModeIncludesMop=function(e){let t=String(e??"").toLowerCase();return t==="mop"||t==="vacuum_mop"||t.includes("mop")||t.includes("wash")},i.enabledRoomCount=function(){return this.getRoomsForActiveMap().filter(e=>e.enabled).length},i._startStatusFlag=function(e){let t=this.dashboardJobControl?.()?.[e]??this.dashboardStartStatus?.()?.[e]??this._startStatus?.[e];if(typeof t=="boolean")return t;if(t==null)return!1;let r=String(t).trim().toLowerCase();return r==="true"||r==="1"||r==="yes"},i._localStartBlockReason=function(){if(this.enabledRoomCount()<1)return"No rooms included.";let e=String(this.vacuumState()??"").toLowerCase();return e==="cleaning"?"Already cleaning.":e==="returning"?"Returning to dock.":e==="error"?"Vacuum has an error.":null},i.canStartCleaning=function(){if(this._localStartBlockReason()&&!this.startRequiresConfirmation())return!1;let t=this.dashboardJobControl?.();return t&&t.can_start!=null?!!t.can_start:this._startStatus?!this._startStatusFlag("blocked"):!0},i.startBlockedReason=function(){if(this.startRequiresConfirmation())return null;let e=this._localStartBlockReason();if(e)return e;let t=this.dashboardJobControl?.();if(t){if(this._startStatusFlag("blocked"))return t.message??t.reason_detail??t.reason??"Start is blocked.";if(this._startStatusFlag("warning"))return t.message??t.reason_detail??null}return this._startStatus||this.dashboardStartStatus?.()?this._startStatusFlag("blocked")?this.dashboardStartStatus?.()?.message??this._startStatus?.message??"Start is blocked.":this._startStatusFlag("warning")?this.dashboardStartStatus?.()?.message??this._startStatus?.message??null:null:null},i.hasStartWarning=function(){return this._localStartBlockReason()?!1:this._startStatusFlag("warning")},i.startStatusReason=function(){return this.dashboardJobControl?.()?.reason??this.dashboardStartStatus?.()?.reason??this._startStatus?.reason??null},i.activeJobRooms=function(){let e=this.dashboardJobProgressTimeline?.()??[];if(this.shouldShowLiveQueue())return e.map((a,n)=>({jobOrder:a.position??n+1,name:a.room_name??`Room ${a.room_id??n+1}`}));let t=String(this.vacuumState()??"").toLowerCase();return new Set(["docked","idle","error"]).has(t)&&this._activeJobRooms?.length&&(this._activeJobRooms=null),this._activeJobRooms??null}}function or(i){i.getOrderAdapter=function(e){return e!=="rooms"?null:{scope:"rooms",getItems:function(){let t=this.getRoomsForActiveMap();return Array.isArray(t)?t:[]},getId:function(t){return t?.id},getLabel:function(t){return t?.name??"Room"},getOrder:function(t){return t?.order},setOrder:function(t,r){return{...t,order:r}},persist:async function(t,r={}){if(!this._actions?.persistRoomOrdering){console.warn("[eufy-vacuum-command-center] persistRoomOrdering not available");return}await this._actions.persistRoomOrdering(t,r)}}}}function lr(i){i.openRoomAccess=function(e,t){let r=this.getRoomsForMap(t).find(a=>String(a.id)===String(e)&&String(a.mapId)===String(t));r&&(this._roomAccessRoomId=r.id,this._roomAccessMapId=r.mapId,this._roomAccessFields={is_dock_room:r.isDockRoom??!1,grants_access_to:[...r.grantsAccessTo??[]]},this._roomAccessSaveError=null)},i.closeRoomAccess=function(){this._roomAccessRoomId=null,this._roomAccessMapId=null,this._roomAccessFields=null,this._roomAccessSaveError=null},i.isRoomAccessOpen=function(){return this._roomAccessRoomId!=null},i.activeAccessRoom=function(){return!this._roomAccessRoomId||!this._roomAccessMapId?null:this.getRoomsForMap(this._roomAccessMapId).find(e=>String(e.id)===String(this._roomAccessRoomId)&&String(e.mapId)===String(this._roomAccessMapId))??null},i.roomAccessFields=function(){return this._roomAccessFields??{grants_access_to:[]}},i.setRoomAccessSaveError=function(e){this._roomAccessSaveError=e??null},i.roomAccessSaveError=function(){return this._roomAccessSaveError??null},i.accessEditableRooms=function(){let e=this.activeAccessRoom();if(!e)return[];let t=this.getRoomsForMap(e.mapId),r=new Set(this._normalizeRoomReferenceList(this.roomAccessFields().grants_access_to)),a=this._buildClaimedTargetMap(t,String(e.id)),n=t.filter(o=>{if(String(o.id)===String(e.id)||o.isDockRoom)return!1;let l=String(o.id),d=a.get(l);return r.has(l)||!d}).map(o=>({id:String(o.id),name:o.name,missing:!1,available:!0,claimedBy:null})),c=new Set(n.map(o=>o.id)),s=Array.from(r).filter(o=>!c.has(String(o))).map(o=>({id:String(o),name:`Missing Room ${o}`,missing:!0,available:!0,claimedBy:null}));return[...n,...s]},i.accessInboundRooms=function(){let e=this.activeAccessRoom();if(!e)return[];let t=this.getRoomsForMap(e.mapId),r=String(e.id);return t.filter(a=>this._normalizeRoomReferenceList(a.grantsAccessTo).includes(r)).map(a=>({id:String(a.id),name:a.name,missing:!1}))},i.toggleRoomAccessTarget=function(e){if(!this._roomAccessFields)return;let t=String(e??"").trim();if(!t)return;let r=new Set(this._normalizeRoomReferenceList(this._roomAccessFields.grants_access_to));r.has(t)?r.delete(t):r.add(t),this._roomAccessFields={...this._roomAccessFields,grants_access_to:Array.from(r)},this._roomAccessSaveError=null},i.toggleIsDockRoomField=function(){this._roomAccessFields&&(this._roomAccessFields={...this._roomAccessFields,is_dock_room:!this._roomAccessFields.is_dock_room},this._roomAccessSaveError=null)},i.roomAccessValidation=function(){let e=this.activeAccessRoom();return e?this.roomAccessFields().is_dock_room?{valid:!0,issues:[],normalizedGrantsAccessTo:[]}:this.validateRoomAccessUpdate(e.mapId,e.id,this.roomAccessFields().grants_access_to??[]):{valid:!1,issues:[{code:"missing_room",message:"No room is selected for access editing."}],normalizedGrantsAccessTo:[]}}}function dr(i){i.openRoomEstimateModal=function(e,t){let r=this.getRoomsForMap(t).find(a=>String(a.id)===String(e)&&String(a.mapId)===String(t));r&&(this._roomEstimateModalRoomId=r.id,this._roomEstimateModalMapId=r.mapId)},i.closeRoomEstimateModal=function(){this._roomEstimateModalRoomId=null,this._roomEstimateModalMapId=null},i.isRoomEstimateModalOpen=function(){return this._roomEstimateModalRoomId!=null},i.activeRoomEstimateRoom=function(){return!this._roomEstimateModalRoomId||!this._roomEstimateModalMapId?null:this.getRoomsForMap(this._roomEstimateModalMapId).find(e=>String(e.id)===String(this._roomEstimateModalRoomId)&&String(e.mapId)===String(this._roomEstimateModalMapId))??null},i.activeRoomEstimateDetails=function(){let e=this.activeRoomEstimateRoom?.();if(!e)return null;let t=String(e.id),a=(Array.isArray(this.learningRoomTimeline?.())?this.learningRoomTimeline():[]).find(s=>String(s?.room_id)===t)??null,n=this.roomEstimateForRoom?.(e.id)??null,c=this.dashboardPlannedWaterRoomForRoom?.(e.id,e.slug)??null;return{room:e,entry:a,roomEstimate:n,plannedWaterRoom:c,confidenceBreakpoint:a?.confidence_breakpoint??n?.confidence_breakpoint??null,confidenceLabel:a?.confidence_label??n?.confidence_label??null}}}function ur(i){i.openRoomEditor=function(e,t){let a=this.getRoomsForActiveMap().find(n=>String(n.id)===String(e)&&String(n.mapId)===String(t));a&&(this._roomEditorRoomId=a.id,this._roomEditorMapId=a.mapId,this._roomEditorFields={clean_mode:this._canonicalCleanModeDisplay(a.cleanMode??"vacuum"),fan_speed:a.fanSpeed??null,water_level:(()=>{let n=a.waterLevel??null;return String(n??"").trim().toLowerCase()==="off"?null:n})(),clean_intensity:a.cleanIntensity??a.selected_profile_details?.clean_intensity??"Quick",clean_passes:a.cleanPasses??1,edge_mopping:a.edgeMopping??!1,profile_name:a.profileName??"vacuum_quick"},this._syncEditorProfileFromFields())},i.closeRoomEditor=function(){this._roomEditorRoomId=null,this._roomEditorMapId=null,this._roomEditorFields=null,this._skipRefreshOnClose=!1},i.setSkipRefreshOnClose=function(e){this._skipRefreshOnClose=!!e},i.shouldSkipRefreshOnClose=function(){return!!this._skipRefreshOnClose},i.isRoomEditorOpen=function(){return this._roomEditorRoomId!=null},i.activeEditorRoom=function(){return this._roomEditorRoomId?this.getRoomsForActiveMap().find(t=>String(t.id)===String(this._roomEditorRoomId)&&String(t.mapId)===String(this._roomEditorMapId))??null:null},i.editorFields=function(){return this._roomEditorFields??null},i.availableEditorProfiles=function(){return this.roomProfilesLibrary?.()??{}},i.editorProfileLabels=function(){return Object.fromEntries(this.roomProfilesList?.().map(e=>[e.name,e.label])??[])},i.getEditorProfileDefinition=function(e){return this.roomProfileDefinition?.(e)??null},i._profileDerivedOptions=function(e){let t=this.availableEditorProfiles(),r=new Set;return Object.values(t).forEach(a=>{let n=a?.[e];n!=null&&String(n).trim()!==""&&r.add(String(n))}),Array.from(r)},i._normalizeOptionList=function(e){let t=new Set,r=[];for(let a of e??[]){let n=String(a??"").trim();if(!n)continue;let c=n.toLowerCase();t.has(c)||(t.add(c),r.push(n))}return r},i._canonicalCleanModeDisplay=function(e){let t=String(e??"").trim(),r=t.toLowerCase().replace(/[\s+_-]+/g,"");return r==="vacuummop"||r==="vacuumandmop"?"Vacuum and mop":r==="vacuum"?"Vacuum":r==="mop"?"Mop":t},i._canonicalCleanModeCompare=function(e){let t=String(e??"").trim().toLowerCase().replace(/[\s+_-]+/g,"");return t==="vacuummop"||t==="vacuumandmop"?"vacuum_mop":t==="vacuum"?"vacuum":t==="mop"?"mop":t},i._profileIntensityToEditorIntensity=function(e){let t=String(e??"").trim().toLowerCase();return t==="quick"?"Quick":t==="deep"?"Narrow":e??null},i._editorIntensityToComparableProfileIntensity=function(e){let t=String(e??"").trim().toLowerCase();return t==="quick"?"quick":t==="narrow"?"deep":t},i._normalizeEditorComparisonValue=function(e,t=""){if(t==="clean_mode")return this._canonicalCleanModeCompare(e);if(t==="clean_intensity")return this._editorIntensityToComparableProfileIntensity(e);if(e==null)return null;if(typeof e=="boolean")return e;if(typeof e=="number")return Number(e);let r=String(e).trim(),a=r.toLowerCase();if(a==="true")return!0;if(a==="false")return!1;let n=Number(r);return!Number.isNaN(n)&&r!==""?n:a},i._buildComparableProfileFields=function(e){let t=this.isEditorRoomCarpet(),r=this._canonicalCleanModeDisplay(e?.clean_mode??"vacuum"),a=this.isMopMode(r)&&!t;return{clean_mode:r,fan_speed:e?.fan_speed??null,water_level:a?e?.water_level??null:null,clean_intensity:this._profileIntensityToEditorIntensity(e?.clean_intensity??null),clean_passes:Number(e?.clean_passes??1),edge_mopping:a?!!e?.edge_mopping:!1}},i._editorFieldsMatchProfile=function(e,t){if(!e||!t)return!1;let r=this._buildComparableProfileFields(t);return this._normalizeEditorComparisonValue(e.clean_mode,"clean_mode")===this._normalizeEditorComparisonValue(r.clean_mode,"clean_mode")&&this._normalizeEditorComparisonValue(e.fan_speed)===this._normalizeEditorComparisonValue(r.fan_speed)&&this._normalizeEditorComparisonValue(e.water_level)===this._normalizeEditorComparisonValue(r.water_level)&&this._normalizeEditorComparisonValue(e.clean_intensity,"clean_intensity")===this._normalizeEditorComparisonValue(r.clean_intensity,"clean_intensity")&&this._normalizeEditorComparisonValue(e.clean_passes)===this._normalizeEditorComparisonValue(r.clean_passes)&&this._normalizeEditorComparisonValue(e.edge_mopping)===this._normalizeEditorComparisonValue(r.edge_mopping)},i.matchingEditorProfileName=function(e=null){let t=e??this.editorFields();if(!t)return null;let r=this.availableEditorProfiles();for(let[a,n]of Object.entries(r))if(this._editorFieldsMatchProfile(t,n))return a;return null},i._syncEditorProfileFromFields=function(){if(!this._roomEditorFields)return;let e=this.matchingEditorProfileName(this._roomEditorFields);this._roomEditorFields={...this._roomEditorFields,profile_name:e??"custom"}},i.applyEditorProfile=function(e){if(!this._roomEditorFields)return;let t=this.getEditorProfileDefinition(e);if(!t)return;let r=this._canonicalCleanModeDisplay(t.clean_mode??this._roomEditorFields.clean_mode??"vacuum"),a=this.isEditorRoomCarpet(),n=this.isMopMode(r)&&!a;this._roomEditorFields={...this._roomEditorFields,profile_name:String(e),clean_mode:r,fan_speed:t.fan_speed??null,water_level:n?t.water_level??null:null,clean_intensity:this._profileIntensityToEditorIntensity(t.clean_intensity??null),clean_passes:Number(t.clean_passes??1),edge_mopping:n?!!t.edge_mopping:!1}},i.updateEditorField=function(e,t){if(!this._roomEditorFields)return;if(e==="profile_name"){t==="custom"?this._roomEditorFields={...this._roomEditorFields,profile_name:"custom"}:this.applyEditorProfile(t);return}let r=e==="clean_mode"?this._canonicalCleanModeDisplay(t):t;this._roomEditorFields={...this._roomEditorFields,[e]:r},e==="clean_mode"&&!this.isMopMode(r)&&(this._roomEditorFields.water_level=null,this._roomEditorFields.edge_mopping=!1),e==="clean_mode"&&this.isEditorRoomCarpet()&&(this._roomEditorFields.water_level=null,this._roomEditorFields.edge_mopping=!1),this._syncEditorProfileFromFields()},i.isMopMode=function(e){let t=this._canonicalCleanModeCompare(e);return t.includes("mop")||t.includes("wash")},i.isEditorRoomCarpet=function(){let e=this.activeEditorRoom();if(!e)return!1;if(e.carpet===!0)return!0;let t=String(e.floorType??"").toLowerCase();return t==="carpet"||t.startsWith("carpet_")||t.startsWith("carpet-")},i.showWaterLevel=function(){if(this.isEditorRoomCarpet())return!1;let e=this.editorFields();return e?this.isMopMode(e.clean_mode):!1},i.showEdgeMopping=function(){if(this.isEditorRoomCarpet())return!1;let e=this.editorFields();return e?this.isMopMode(e.clean_mode):!1},i._buildOptionListForRole=function(e,t){let r=this.adapterOptionsFor?.(e)??[],a=this._profileDerivedOptions(t),n=new Set,c=[];for(let s of r){let o=String(s?.value??"").trim();if(!o)continue;let l=o.toLowerCase();n.has(l)||(n.add(l),c.push({value:o,label:String(s?.label??o)}))}for(let s of a){let o=String(s??"").trim();if(!o)continue;let l=o.toLowerCase();n.has(l)||(n.add(l),c.push({value:o,label:o}))}return c},i.cleanModeOptions=function(){let e=this._buildOptionListForRole("clean_mode","clean_mode");return this.isEditorRoomCarpet()?e.filter(t=>!this.isMopMode(t.value)):e},i.suctionLevelOptions=function(){return this._buildOptionListForRole("fan_speed","fan_speed")},i.waterLevelOptions=function(){return this._buildOptionListForRole("water_level","water_level")},i.cleanIntensityOptions=function(){return this._buildOptionListForRole("clean_intensity","clean_intensity")},i.isCustomProfile=function(){let e=this.editorFields();return e?String(e.profile_name??"").toLowerCase()==="custom":!1},i.currentEditorManagedProfileName=function(){let e=this.editorFields();if(!e)return null;let t=String(e.profile_name??"").trim();return!t||t.toLowerCase()==="custom"?null:t}}var Pe=new Set(["is_on","is_off","exists","missing"]),_i=["is_on","is_off","exists","missing"],yi=["equals","not_equals","in","not_in","exists","missing"],xi=["equals","not_equals","gt","gte","lt","lte","exists","missing"],wi=["equals","not_equals","in","not_in","exists","missing"],We=["is_on","is_off","exists","missing","equals","not_equals","gt","gte","lt","lte","in","not_in"];function Si(){return{id:null,label:"",entity_id:"",kind:"blocker",operator:"is_on",value:null,enabled:!0,effect:{action:"exclude",reason:"",changes:{}}}}function Ae(i){if(i==null||i==="")return!1;if(typeof i=="number")return Number.isFinite(i);let e=String(i).trim();return e?Number.isFinite(Number(e)):!1}function Je(i){if(Array.isArray(i))return i.map(t=>String(t??"").trim()).filter(Boolean);let e=String(i??"").trim();return e?e.split(",").map(t=>t.trim()).filter(Boolean):[]}function mr(i,e,t){if(Pe.has(String(t??"")))return null;let r=e?.valueModeForOperator?.(t)??"text";if(r==="multi-select")return Je(i);if(r==="number"){if(i==null||i==="")return null;let a=Number(i);return Number.isFinite(a)?a:i}return i}function Ie(i,e){if(!i)return i;let t=e?.operators??We,r=t[0]??"equals",a=t.includes(i.operator)?i.operator:r,n=mr(i.value,e,a);if(e?.category==="enum"){let c=new Set((e.options??[]).map(o=>String(o.value))),s=e.valueModeForOperator?.(a);s==="single-select"&&n!=null&&!c.has(String(n))&&(n=null),s==="multi-select"&&(n=Je(n).filter(o=>c.has(String(o))))}return{...i,operator:a,value:n}}function Ri(i){return Array.isArray(i)?i.join(", "):i}function Ei(i,e,t){if(!t)return 0;let r=String(i??"").toLowerCase(),a=String(e??"").toLowerCase();return r===t?100:a===t?95:r.startsWith(t)?80:a.startsWith(t)?70:r.includes(t)?50:a.includes(t)?40:0}function vr(i){i.roomRulesActiveRoomId=function(){return this._roomRulesActiveRoomId??null},i.setRoomRulesActiveRoom=function(e){let t=String(e??"").trim();this._roomRulesActiveRoomId=t||null,this._roomRulesDraft=null,this._roomRulesDraftMode=null,this._roomRulesSaveError=null},i.resolvedRoomRulesRoom=function(){let e=this.getRoomsForActiveMap?.()??[];if(!e.length)return null;let t=this._roomRulesActiveRoomId;if(t){let r=e.find(a=>String(a.id)===String(t));if(r)return r}return e[0]},i.rulesForActiveRoomTab=function(){let e=this.resolvedRoomRulesRoom();return e?Array.isArray(e.rules)?e.rules:[]:[]},i.roomRulesDraft=function(){return this._roomRulesDraft??null},i.roomRulesDraftMode=function(){return this._roomRulesDraftMode??null},i.openNewRuleDraft=function(){this._roomRulesDraft=Ie(Si(),this.ruleEntityDescriptor("")),this._roomRulesDraftMode="new",this._roomRulesSaveError=null},i.openEditRuleDraft=function(e){e&&(this._roomRulesDraft=Ie({id:e.id??null,label:e.label??"",entity_id:e.entity_id??"",kind:e.kind??"blocker",operator:e.operator??"is_on",value:e.value??null,enabled:e.enabled!==!1,effect:{action:e.effect?.action??(e.kind==="modifier"?"mutate":"exclude"),reason:e.effect?.reason??"",changes:{...e.effect?.changes??{}}}},this.ruleEntityDescriptor(e.entity_id??"")),this._roomRulesDraftMode="edit",this._roomRulesSaveError=null)},i.closeRulesDraft=function(){this._roomRulesDraft=null,this._roomRulesDraftMode=null,this._roomRulesSaveError=null},i.updateRuleDraftField=function(e,t){if(this._roomRulesDraft){if(e==="kind"){let r=t==="modifier"?"modifier":"blocker";this._roomRulesDraft=Ie({...this._roomRulesDraft,kind:r,effect:{...this._roomRulesDraft.effect,action:r==="modifier"?"mutate":"exclude",changes:r==="blocker"?{}:this._roomRulesDraft.effect.changes}},this.ruleEntityDescriptor(this._roomRulesDraft.entity_id))}else if(e==="operator")this._roomRulesDraft=Ie({...this._roomRulesDraft,operator:String(t??"is_on"),value:Pe.has(String(t))?null:this._roomRulesDraft.value},this.ruleEntityDescriptor(this._roomRulesDraft.entity_id));else if(e==="enabled")this._roomRulesDraft={...this._roomRulesDraft,enabled:!!t};else if(e==="entity_id")this._roomRulesDraft=Ie({...this._roomRulesDraft,entity_id:String(t??"")},this.ruleEntityDescriptor(t));else if(e==="effect.reason")this._roomRulesDraft={...this._roomRulesDraft,effect:{...this._roomRulesDraft.effect,reason:String(t??"")}};else if(e.startsWith("effect.changes.")){let r=e.slice(15),a={...this._roomRulesDraft.effect.changes??{}};t==null?delete a[r]:a[r]=t,this._roomRulesDraft={...this._roomRulesDraft,effect:{...this._roomRulesDraft.effect,changes:a}}}else{let r=this.ruleEntityDescriptor(this._roomRulesDraft.entity_id);this._roomRulesDraft={...this._roomRulesDraft,[e]:e==="value"?mr(t,r,this._roomRulesDraft.operator):t}}this._roomRulesSaveError=null}},i.roomRulesDraftIsValid=function(){let e=this._roomRulesDraft;if(!e)return!1;let t=String(e.entity_id??"").trim();if(!t)return!1;let r=this.ruleEntityDescriptor(t);if(!r.entityExists||!(r.operators??[]).includes(e.operator))return!1;if(!Pe.has(String(e.operator??""))){let a=r.valueModeForOperator?.(e.operator)??"text";if(a==="multi-select"){if(!Je(e.value).length)return!1}else if(a==="number"){if(!Ae(e.value))return!1}else if(!String(e.value??"").trim())return!1}if(e.kind==="modifier"){let a=e.effect?.changes??{};if(!Object.entries(a).filter(([c,s])=>s==null?!1:c==="clean_passes"?Number(s)===1||Number(s)===2:!0).length)return!1}return!0},i.roomRulesSaveError=function(){return this._roomRulesSaveError??null},i.setRoomRulesSaveError=function(e){this._roomRulesSaveError=e??null},i.ruleEntityDescriptor=function(e=null){let t=typeof e=="string"?e:e?.entity_id??this._roomRulesDraft?.entity_id??"",r=String(t??"").trim(),a=r?this.entity?.(r):null,n=a?.attributes??{},c=r.includes(".")?r.split(".")[0]:"",s=a?.state??null,o=Array.isArray(n.options)?n.options.map(u=>({value:String(u??""),label:String(u??"")})):[],l="unknown";["binary_sensor","switch","input_boolean"].includes(c)?l="boolean":["select","input_select"].includes(c)||o.length?l="enum":["number","input_number"].includes(c)?l="numeric":c==="sensor"?l=Ae(s)?"numeric":"text":String(s??"").toLowerCase()==="on"||String(s??"").toLowerCase()==="off"?l="boolean":r&&(l="text");let d=l==="boolean"?_i:l==="enum"?yi:l==="numeric"?xi:l==="text"?wi:We;return{entityId:r,entityExists:!!a,entityLabel:String((n.friendly_name??r)||"Entity"),currentState:s,category:l,operators:d,options:o,min:Ae(n.min)?Number(n.min):null,max:Ae(n.max)?Number(n.max):null,step:Ae(n.step)?Number(n.step):null,unit:n.unit_of_measurement??null,valueModeForOperator(u){return Pe.has(String(u??""))||l==="boolean"?"none":l==="enum"?u==="in"||u==="not_in"?"multi-select":"single-select":l==="numeric"?"number":"text"}}},i.ruleOperatorGroups=function(e=null){let t=this.ruleEntityDescriptor(e),r=new Set(t.operators??We);return[{label:"State",operators:[{value:"is_on",label:"Is ON"},{value:"is_off",label:"Is OFF"}]},{label:"Existence",operators:[{value:"exists",label:"Exists"},{value:"missing",label:"Missing"}]},{label:"Equality",operators:[{value:"equals",label:"Equals"},{value:"not_equals",label:"Not equals"}]},{label:"Numeric",operators:[{value:"gt",label:">"},{value:"gte",label:"\u2265"},{value:"lt",label:"<"},{value:"lte",label:"\u2264"}]},{label:"List",operators:[{value:"in",label:"In list"},{value:"not_in",label:"Not in list"}]}].map(n=>({...n,operators:n.operators.filter(c=>r.has(c.value))})).filter(n=>n.operators.length>0)},i.ruleEntitySearchResults=function(e=null,t=12){let r=String(e??this._roomRulesDraft?.entity_id??"").trim().toLowerCase();return r.length<2?[]:Object.entries(this.hass?.states??{}).map(([n,c])=>{let s=String(c?.attributes?.friendly_name??"").trim(),o=Ei(n,s,r);return o<=0?null:{entity_id:n,friendly_name:s,state:c?.state??null,domain:n.split(".")[0]??"",score:o}}).filter(Boolean).sort((n,c)=>c.score!==n.score?c.score-n.score:n.entity_id.localeCompare(c.entity_id)).slice(0,Math.max(1,Number(t)||12))},i.roomRulesForRoom=function(e){let r=(this.getRoomsForActiveMap?.()??[]).find(a=>String(a.id)===String(e));return r?Array.isArray(r.rules)?r.rules:[]:[]},i.ruleConditionSummary=function(e){let t=e.operator??"",r=Ri(e.value);switch(t){case"is_on":return"is ON";case"is_off":return"is OFF";case"exists":return"exists";case"missing":return"is missing";case"equals":return`= ${r??""}`;case"not_equals":return`!= ${r??""}`;case"gt":return`> ${r??""}`;case"gte":return`>= ${r??""}`;case"lt":return`< ${r??""}`;case"lte":return`<= ${r??""}`;case"in":return`in [${r??""}]`;case"not_in":return`not in [${r??""}]`;default:return t}},i.ruleEffectSummary=function(e){if(e.kind==="blocker"){let a=e.effect?.reason;return a?`Exclude - ${a}`:"Exclude room"}let t=e.effect?.changes??{},r=[];return t.clean_mode&&r.push(`mode: ${t.clean_mode}`),t.fan_speed&&r.push(`fan: ${t.fan_speed}`),t.water_level&&r.push(`water: ${t.water_level}`),t.clean_intensity&&r.push(`intensity: ${t.clean_intensity}`),t.clean_passes!=null&&r.push(`passes: ${t.clean_passes}`),t.edge_mopping!=null&&r.push(`edge mop: ${t.edge_mopping?"on":"off"}`),r.length?r.join(", "):"Modify settings"}}var Ke={MAINTENANCE:"maintenance_items",REPLACEMENTS:"replacements"};function pr(i){i._ensureMaintenanceState=function(){return this._maintenanceState||(this._maintenanceState={activeTab:Ke.MAINTENANCE,modalItem:null,resetUi:{confirming:!1,pending:!1,success:"",error:""}}),this._maintenanceState},i.maintenanceActiveTab=function(){return this._ensureMaintenanceState().activeTab},i.setMaintenanceActiveTab=function(e){let t=this._ensureMaintenanceState(),r=String(e??"").trim().toLowerCase();r!==Ke.MAINTENANCE&&r!==Ke.REPLACEMENTS||(t.activeTab=r)},i.isMaintenanceTabActive=function(e){return this.maintenanceActiveTab()===String(e??"").trim().toLowerCase()},i.openMaintenanceModal=function(e){if(!e||typeof e!="object")return;let t=this._ensureMaintenanceState();t.modalItem={...e},t.resetUi={confirming:!1,pending:!1,success:"",error:""}},i.closeMaintenanceModal=function(){let e=this._ensureMaintenanceState();e.modalItem=null,e.resetUi={confirming:!1,pending:!1,success:"",error:""}},i.activeMaintenanceModalItem=function(){return this._ensureMaintenanceState().modalItem??null},i.isMaintenanceModalOpen=function(){return!!this.activeMaintenanceModalItem()},i.maintenanceResetUi=function(){return this._ensureMaintenanceState().resetUi},i.beginMaintenanceResetConfirmation=function(){let e=this.maintenanceResetUi();e.confirming=!0,e.error="",e.success=""},i.cancelMaintenanceResetConfirmation=function(){let e=this.maintenanceResetUi();e.confirming=!1,e.pending=!1,e.error=""},i.setMaintenanceResetPending=function(e){this.maintenanceResetUi().pending=!!e},i.setMaintenanceResetSuccess=function(e){let t=this.maintenanceResetUi();t.success=String(e??""),t.error="",t.pending=!1,t.confirming=!1},i.setMaintenanceResetError=function(e){let t=this.maintenanceResetUi();t.error=String(e??""),t.success="",t.pending=!1},i.canInvokeMaintenanceReset=function(e){return e?.can_reset===!0&&typeof e?.reset_service=="string"&&e.reset_service.length>0&&e?.reset_service_data!=null},i.findUpkeepItem=function(e,t,r=null){let a=this.dashboardUpkeep?.()??{},n=String(e??"").trim().toLowerCase(),c=String(t??"").trim().toLowerCase(),s=r==null?null:String(r).trim().toLowerCase();return[...Array.isArray(a.maintenance_items)?a.maintenance_items:[],...Array.isArray(a.replacement_items)?a.replacement_items:[]].find(l=>{let d=String(l?.kind??"").trim().toLowerCase(),u=String(l?.component??"").trim().toLowerCase(),m=l?.entity_id==null?null:String(l.entity_id).trim().toLowerCase();return!(d!==n||u!==c||s&&m&&m!==s)})??null}}var ki=["App Shell & Typography","Cards & Surfaces","Borders & Shadows","Chips","Room Cards","Floor Textures","Floor Textures \u2014 Tile","Floor Textures \u2014 Wood","Floor Textures \u2014 Marble","Floor Textures \u2014 Concrete","Floor Textures \u2014 Carpet Low","Floor Textures \u2014 Carpet High","Floor Textures \u2014 Granite","Queue & Ordering","Status, Confidence & Alerts","Learning & Metrics","Modals & Overlays"],Ti=["Shared Foundations"];function Ye(i){return[...ki,...i||[],...Ti]}var ic=Ye(["Cat","Dog","Raccoon","Parrot","Snake"].map(i=>`Animal Companion \u2014 ${i}`));var Mi=Object.freeze(["color","text","shadow","size","number","duration","motion","typography","easing"]),$i=new Set(Mi);function Ai(i){return String(i||"").replace(/^--evcc-/,"").replace(/-/g," ").replace(/\b\w/g,e=>e.toUpperCase()).trim()}function Ii(i,e="color"){return function(r,a=null,n=e){let c=$i.has(n)?n:e;return{key:r,label:a||Ai(r),group:i,type:c}}}function B(i,e="color"){let t=Ii(i,e);return t.color=(r,a=null)=>t(r,a,"color"),t.text=(r,a=null)=>t(r,a,"text"),t.shadow=(r,a=null)=>t(r,a,"shadow"),t.size=(r,a=null)=>t(r,a,"size"),t.number=(r,a=null)=>t(r,a,"number"),t.duration=(r,a=null)=>t(r,a,"duration"),t.motion=(r,a=null)=>t(r,a,"motion"),t.typography=(r,a=null)=>t(r,a,"typography"),t.easing=(r,a=null)=>t(r,a,"easing"),t}var Se=B("App Shell & Typography","color"),ee=B("Cards & Surfaces","color"),Re=B("Borders & Shadows","color"),C=B("Chips","color"),ne=B("Room Cards","color"),cc=B("Floor Textures","number"),k=B("Queue & Ordering","color"),$=B("Status, Confidence & Alerts","color"),T=B("Learning & Metrics","color"),A=B("Modals & Overlays","color"),X=B("Shared Foundations","size"),sc=B("Animal Companion","color");var hr=[Se.color("--evcc-accent","Accent"),Se.color("--evcc-border","Border"),Se.color("--evcc-text-muted","Text Muted"),Se.color("--evcc-text-primary","Text Primary"),Se.color("--evcc-text-secondary","Text Secondary")];var fr=[ee.color("--evcc-bg-input","BG Input"),ee.color("--evcc-bg-panel","BG Panel"),ee.color("--evcc-card-bg","Card BG"),ee.size("--evcc-card-gap","Card Gap"),ee.size("--evcc-card-min-height","Card Min Height"),ee.size("--evcc-card-padding","Card Padding"),ee.color("--evcc-panel-bg","Panel BG"),ee.color("--evcc-surface-base","Surface Base"),ee.color("--evcc-surface-card","Surface Card"),ee.color("--evcc-surface-input","Surface Input"),ee.color("--evcc-surface-overlay","Surface Overlay"),ee.color("--evcc-surface-panel","Surface Panel"),ee.color("--evcc-surface-raise","Surface Raise"),ee.color("--evcc-surface-raised","Surface Raised")];var gr=[Re.color("--evcc-border-default","Border Default"),Re.color("--evcc-border-strong","Border Strong"),Re.color("--evcc-border-subtle","Border Subtle"),Re.shadow("--evcc-shadow-card","Shadow Card"),Re.shadow("--evcc-shadow-hover","Shadow Hover")];var br=[C.color("--evcc-chip-active-bg","Chip Active BG"),C.color("--evcc-chip-active-border","Chip Active Border"),C.color("--evcc-chip-active-text","Chip Active Text"),C.color("--evcc-chip-bg","Chip BG"),C.color("--evcc-chip-border","Chip Border"),C.color("--evcc-chip-excluded-bg","Chip Excluded BG"),C.color("--evcc-chip-excluded-border","Chip Excluded Border"),C.color("--evcc-chip-excluded-text","Chip Excluded Text"),C.size("--evcc-chip-font-size","Chip Font Size"),C.typography("--evcc-chip-font-weight","Chip Font Weight"),C.size("--evcc-chip-gap","Chip Gap"),C.size("--evcc-chip-height","Chip Height"),C.color("--evcc-chip-hover-bg","Chip Hover BG"),C.color("--evcc-chip-hover-border","Chip Hover Border"),C.color("--evcc-chip-hover-text","Chip Hover Text"),C.size("--evcc-chip-icon-height","Chip Icon Height"),C.size("--evcc-chip-icon-padding","Chip Icon Padding"),C.size("--evcc-chip-icon-size","Chip Icon Size"),C.color("--evcc-chip-included-bg","Chip Included BG"),C.color("--evcc-chip-included-border","Chip Included Border"),C.color("--evcc-chip-included-text","Chip Included Text"),C.color("--evcc-chip-neutral-bg","Chip Neutral BG"),C.size("--evcc-chip-padding","Chip Padding"),C.size("--evcc-chip-radius","Chip Radius"),C.color("--evcc-chip-success-bg","Chip Success BG"),C.color("--evcc-chip-success-border","Chip Success Border"),C.color("--evcc-chip-success-text","Chip Success Text"),C.color("--evcc-chip-text","Chip Text"),C.color("--evcc-chip-warning-bg","Chip Warning BG"),C.color("--evcc-chip-warning-border","Chip Warning Border"),C.color("--evcc-chip-warning-text","Chip Warning Text")];var _r=[ne.color("--evcc-profile-chip-bg","Profile Chip BG"),ne.color("--evcc-profile-chip-border","Profile Chip Border"),ne.color("--evcc-profile-chip-custom-bg","Profile Chip Custom BG"),ne.color("--evcc-profile-chip-custom-border","Profile Chip Custom Border"),ne.color("--evcc-profile-chip-custom-text","Profile Chip Custom Text"),ne.color("--evcc-profile-chip-text","Profile Chip Text"),ne.color("--evcc-room-chip-bg","Room Chip BG"),ne.color("--evcc-room-chip-border","Room Chip Border"),ne.color("--evcc-room-chip-text","Room Chip Text"),ne.number("--evcc-room-fill-opacity","Room Fill Opacity"),ne.size("--evcc-room-grid-columns","Room Grid Columns"),ne.size("--evcc-room-grid-gap","Room Grid Gap"),ne.size("--evcc-room-grid-min","Room Grid Min")];var Le=B("Floor Textures","number"),xe=B("Floor Textures \u2014 Tile","color"),Ee=B("Floor Textures \u2014 Wood","color"),we=B("Floor Textures \u2014 Marble","color"),Ce=B("Floor Textures \u2014 Concrete","color"),Ne=B("Floor Textures \u2014 Carpet Low","color"),Fe=B("Floor Textures \u2014 Carpet High","color"),He=B("Floor Textures \u2014 Granite","color"),yr=[Le.number("--evcc-floor-textures-card-enabled","Card Textures Enabled (0/1)"),Le.number("--evcc-floor-textures-map-enabled","Map Textures Enabled (0/1)"),Le.number("--evcc-floor-texture-opacity-card","Card Texture Opacity (all)"),Le.number("--evcc-floor-texture-opacity-map","Map Texture Opacity (all)"),xe.color("--evcc-floor-tile-base","Tile Base Color"),xe.color("--evcc-floor-tile-grout","Tile Grout Color"),xe.color("--evcc-floor-tile-accent","Tile Accent Color"),xe.number("--evcc-floor-tile-opacity-card","Tile Card Opacity"),xe.number("--evcc-floor-tile-face-opacity","Tile Face Layer Opacity"),xe.number("--evcc-floor-tile-grout-opacity","Tile Grout Layer Opacity"),xe.number("--evcc-floor-tile-line-opacity","Tile Grout Line Layer Opacity"),Ee.color("--evcc-floor-wood-base","Wood Base Color"),Ee.color("--evcc-floor-wood-accent","Wood Accent Color"),Ee.number("--evcc-floor-wood-opacity-card","Wood Card Opacity"),Ee.number("--evcc-floor-wood-depth-opacity","Wood Depth Layer Opacity"),Ee.number("--evcc-floor-wood-grain-opacity","Wood Grain Layer Opacity"),Ee.number("--evcc-floor-wood-seam-opacity","Wood Seam Layer Opacity"),we.color("--evcc-floor-marble-base","Marble Base Color"),we.color("--evcc-floor-marble-micro","Marble Micro Color"),we.color("--evcc-floor-marble-accent","Marble Accent Color"),we.number("--evcc-floor-marble-opacity-card","Marble Card Opacity"),we.number("--evcc-floor-marble-base-opacity","Marble Base Layer Opacity"),we.number("--evcc-floor-marble-micro-opacity","Marble Micro Layer Opacity"),we.number("--evcc-floor-marble-vein-opacity","Marble Vein Layer Opacity"),Ce.color("--evcc-floor-concrete-base","Concrete Base Color"),Ce.color("--evcc-floor-concrete-accent","Concrete Accent Color"),Ce.number("--evcc-floor-concrete-opacity-card","Concrete Card Opacity"),Ce.number("--evcc-floor-concrete-broad-opacity","Concrete Broad Layer Opacity"),Ce.number("--evcc-floor-concrete-micro-opacity","Concrete Micro Layer Opacity"),Ne.color("--evcc-floor-carpet-low-base","Carpet Low Base Color"),Ne.color("--evcc-floor-carpet-low-accent","Carpet Low Accent Color"),Ne.number("--evcc-floor-carpet-low-opacity-card","Carpet Low Card Opacity"),Ne.number("--evcc-floor-carpet-low-texture-opacity","Carpet Low Texture Layer Opacity"),Fe.color("--evcc-floor-carpet-high-base","Carpet High Base Color"),Fe.color("--evcc-floor-carpet-high-accent","Carpet High Accent Color"),Fe.number("--evcc-floor-carpet-high-opacity-card","Carpet High Card Opacity"),Fe.number("--evcc-floor-carpet-high-texture-opacity","Carpet High Texture Layer Opacity"),He.color("--evcc-floor-granite-light-base","Granite Base Color"),He.color("--evcc-floor-granite-light-accent","Granite Accent Color"),He.number("--evcc-floor-granite-light-opacity-card","Granite Card Opacity"),He.number("--evcc-floor-granite-light-texture-opacity","Granite Texture Layer Opacity")];var xr=[k.number("--evcc-drag-opacity","Drag Opacity"),k.number("--evcc-drag-scale","Drag Scale"),k.shadow("--evcc-drag-shadow","Drag Shadow"),k.color("--evcc-order-chip-bg","Order Chip BG"),k.color("--evcc-order-chip-border","Order Chip Border"),k.color("--evcc-order-chip-text","Order Chip Text"),k.color("--evcc-order-feedback-border","Order Feedback Border"),k.color("--evcc-order-target-outline","Order Target Outline"),k.text("--evcc-progress-complete","Progress Complete"),k.color("--evcc-progress-fill","Progress Fill"),k.color("--evcc-queue-chip-bg","Queue Chip BG"),k.color("--evcc-queue-chip-border","Queue Chip Border"),k.size("--evcc-queue-chip-gap","Queue Chip Gap"),k.color("--evcc-queue-chip-text","Queue Chip Text"),k.color("--evcc-queue-completed-bg","Queue Completed BG"),k.color("--evcc-queue-completed-border","Queue Completed Border"),k.number("--evcc-queue-completed-opacity","Queue Completed Opacity"),k.color("--evcc-queue-completed-text","Queue Completed Text"),k.color("--evcc-queue-current-bg","Queue Current BG"),k.color("--evcc-queue-current-border","Queue Current Border"),k.shadow("--evcc-queue-current-glow","Queue Current Glow"),k.color("--evcc-queue-current-text","Queue Current Text"),k.color("--evcc-queue-hover-bg","Queue Hover BG"),k.color("--evcc-queue-hover-border","Queue Hover Border"),k.color("--evcc-queue-hover-text","Queue Hover Text"),k.color("--evcc-queue-inferred-bg","Queue Inferred BG"),k.color("--evcc-queue-inferred-border","Queue Inferred Border"),k.shadow("--evcc-queue-inferred-glow","Queue Inferred Glow"),k.color("--evcc-queue-inferred-text","Queue Inferred Text"),k.color("--evcc-queue-order-bg","Queue Order BG"),k.color("--evcc-queue-order-border","Queue Order Border"),k.color("--evcc-queue-order-text","Queue Order Text"),k.color("--evcc-queue-pending-bg","Queue Pending BG"),k.color("--evcc-queue-pending-border","Queue Pending Border"),k.number("--evcc-queue-pending-opacity","Queue Pending Opacity"),k.color("--evcc-queue-pending-text","Queue Pending Text"),k.color("--evcc-queue-skipped-bg","Queue Skipped BG"),k.color("--evcc-queue-skipped-border","Queue Skipped Border"),k.color("--evcc-queue-skipped-text","Queue Skipped Text"),k.duration("--evcc-reorder-feedback-duration","Reorder Feedback Duration"),k.easing("--evcc-reorder-flip-easing","Reorder Flip Easing")];var wr=[$.color("--evcc-color-cleaning","Color Cleaning"),$.color("--evcc-color-docked","Color Docked"),$.color("--evcc-color-error","Color Error"),$.color("--evcc-color-idle","Color Idle"),$.color("--evcc-color-paused","Color Paused"),$.color("--evcc-color-returning","Color Returning"),$.color("--evcc-conf-high","Conf High"),$.color("--evcc-conf-low","Conf Low"),$.color("--evcc-conf-mid","Conf Mid"),$.color("--evcc-conf-none","Conf None"),$.color("--evcc-confidence-high-bg","Confidence High BG"),$.color("--evcc-confidence-high-border","Confidence High Border"),$.color("--evcc-confidence-high-text","Confidence High Text"),$.color("--evcc-confidence-low-bg","Confidence Low BG"),$.color("--evcc-confidence-low-border","Confidence Low Border"),$.color("--evcc-confidence-low-text","Confidence Low Text"),$.color("--evcc-confidence-medium-bg","Confidence Medium BG"),$.color("--evcc-confidence-medium-border","Confidence Medium Border"),$.color("--evcc-confidence-medium-text","Confidence Medium Text"),$.color("--evcc-sem-error","Sem Error"),$.color("--evcc-sem-info","Sem Info"),$.color("--evcc-sem-success","Sem Success"),$.color("--evcc-sem-warning","Sem Warning"),$.color("--evcc-status-cleaning-bg","Status Cleaning BG"),$.color("--evcc-status-cleaning-border","Status Cleaning Border"),$.color("--evcc-status-cleaning-text","Status Cleaning Text"),$.color("--evcc-status-dot-charging","Status Dot Charging"),$.color("--evcc-status-dot-cleaning","Status Dot Cleaning"),$.color("--evcc-status-dot-docked","Status Dot Docked"),$.color("--evcc-status-dot-error","Status Dot Error"),$.color("--evcc-status-dot-idle","Status Dot Idle"),$.color("--evcc-status-dot-offline","Status Dot Offline"),$.color("--evcc-status-dot-paused","Status Dot Paused"),$.color("--evcc-status-dot-returning","Status Dot Returning"),$.shadow("--evcc-status-dot-shadow","Status Dot Shadow"),$.color("--evcc-status-dot-unavailable","Status Dot Unavailable"),$.duration("--evcc-status-pulse-duration","Status Pulse Duration")];var Sr=[T.color("--evcc-estimate-default-bg","Estimate Default BG"),T.color("--evcc-estimate-default-border","Estimate Default Border"),T.color("--evcc-estimate-default-text","Estimate Default Text"),T.color("--evcc-estimate-learned-bg","Estimate Learned BG"),T.color("--evcc-estimate-learned-border","Estimate Learned Border"),T.color("--evcc-estimate-learned-text","Estimate Learned Text"),T.duration("--evcc-learning-anim-duration-fast","Learning Anim Duration Fast"),T.duration("--evcc-learning-anim-duration-normal","Learning Anim Duration Normal"),T.duration("--evcc-learning-anim-duration-slow","Learning Anim Duration Slow"),T.text("--evcc-learning-anim-ease","Learning Anim Ease"),T.size("--evcc-learning-chip-font-size","Learning Chip Font Size"),T.typography("--evcc-learning-chip-font-weight","Learning Chip Font Weight"),T.size("--evcc-learning-chip-radius","Learning Chip Radius"),T.color("--evcc-learning-confidence-high-bg","Learning Confidence High BG"),T.color("--evcc-learning-confidence-high-border","Learning Confidence High Border"),T.text("--evcc-learning-confidence-high-gradient","Learning Confidence High Gradient"),T.color("--evcc-learning-confidence-high-text","Learning Confidence High Text"),T.color("--evcc-learning-confidence-low-bg","Learning Confidence Low BG"),T.color("--evcc-learning-confidence-low-border","Learning Confidence Low Border"),T.text("--evcc-learning-confidence-low-gradient","Learning Confidence Low Gradient"),T.color("--evcc-learning-confidence-low-text","Learning Confidence Low Text"),T.color("--evcc-learning-confidence-medium-bg","Learning Confidence Medium BG"),T.color("--evcc-learning-confidence-medium-border","Learning Confidence Medium Border"),T.text("--evcc-learning-confidence-medium-gradient","Learning Confidence Medium Gradient"),T.color("--evcc-learning-confidence-medium-text","Learning Confidence Medium Text"),T.color("--evcc-learning-confidence-neutral-bg","Learning Confidence Neutral BG"),T.color("--evcc-learning-confidence-neutral-border","Learning Confidence Neutral Border"),T.text("--evcc-learning-confidence-neutral-gradient","Learning Confidence Neutral Gradient"),T.color("--evcc-learning-confidence-neutral-text","Learning Confidence Neutral Text"),T.shadow("--evcc-learning-current-glow","Learning Current Glow"),T.color("--evcc-learning-note-text","Learning Note Text"),T.color("--evcc-learning-panel-bg","Learning Panel BG"),T.color("--evcc-learning-panel-border","Learning Panel Border"),T.shadow("--evcc-learning-panel-shadow","Learning Panel Shadow"),T.color("--evcc-learning-reanchor-border","Learning Reanchor Border"),T.color("--evcc-learning-reanchor-highlight","Learning Reanchor Highlight"),T.color("--evcc-learning-text-muted","Learning Text Muted"),T.color("--evcc-learning-text-primary","Learning Text Primary"),T.color("--evcc-learning-text-secondary","Learning Text Secondary"),T.color("--evcc-learning-warning-text","Learning Warning Text")];var Rr=[A.color("--evcc-modal-accent","Modal Accent"),A.color("--evcc-modal-accent-bg","Modal Accent BG"),A.color("--evcc-modal-accent-border","Modal Accent Border"),A.color("--evcc-modal-accent-text","Modal Accent Text"),A.color("--evcc-modal-backdrop-bg","Modal Backdrop BG"),A.number("--evcc-modal-backdrop-blur","Modal Backdrop Blur"),A.color("--evcc-modal-bg","Modal BG"),A.color("--evcc-modal-border","Modal Border"),A.color("--evcc-modal-border-default","Modal Border Default"),A.color("--evcc-modal-border-strong","Modal Border Strong"),A.color("--evcc-modal-border-subtle","Modal Border Subtle"),A.color("--evcc-modal-chip-active-bg","Modal Chip Active BG"),A.color("--evcc-modal-chip-active-border","Modal Chip Active Border"),A.color("--evcc-modal-chip-active-text","Modal Chip Active Text"),A.color("--evcc-modal-chip-bg","Modal Chip BG"),A.color("--evcc-modal-chip-border","Modal Chip Border"),A.color("--evcc-modal-chip-hover-bg","Modal Chip Hover BG"),A.color("--evcc-modal-chip-hover-border","Modal Chip Hover Border"),A.color("--evcc-modal-chip-hover-text","Modal Chip Hover Text"),A.color("--evcc-modal-chip-text","Modal Chip Text"),A.color("--evcc-modal-footer-bg","Modal Footer BG"),A.color("--evcc-modal-header-bg","Modal Header BG"),A.color("--evcc-modal-input-bg","Modal Input BG"),A.size("--evcc-modal-padding","Modal Padding"),A.size("--evcc-modal-radius","Modal Radius"),A.size("--evcc-modal-section-gap","Modal Section Gap"),A.shadow("--evcc-modal-shadow","Modal Shadow"),A.color("--evcc-modal-surface-input","Modal Surface Input"),A.color("--evcc-modal-surface-panel","Modal Surface Panel"),A.color("--evcc-modal-surface-section","Modal Surface Section"),A.color("--evcc-modal-text-muted","Modal Text Muted"),A.color("--evcc-modal-text-primary","Modal Text Primary"),A.color("--evcc-modal-text-secondary","Modal Text Secondary"),A.color("--evcc-modal-warning-bg","Modal Warning BG"),A.color("--evcc-modal-warning-border","Modal Warning Border"),A.color("--evcc-modal-warning-text","Modal Warning Text")];var Er=[X.typography("--evcc-font-family","Font Family"),X.size("--evcc-gap","Gap"),X.size("--evcc-grid-gap","Grid Gap"),X.motion("--evcc-hover-lift","Hover Lift"),X.size("--evcc-pad","Pad"),X.number("--evcc-press-scale","Press Scale"),X.size("--evcc-radius-card","Radius Card"),X.size("--evcc-radius-chip","Radius Chip"),X.size("--evcc-radius-inner","Radius Inner"),X.size("--evcc-radius-panel","Radius Panel"),X.size("--evcc-section-gap","Section Gap"),X.text("--evcc-space-lg","Space Lg"),X.text("--evcc-space-md","Space Md"),X.text("--evcc-space-sm","Space Sm"),X.motion("--evcc-transition-normal","Transition Normal")];var ke="Animal Companion";function Te(i){let e=String(i||"").replace(/[^a-z0-9-]/gi,""),t=e.charAt(0).toUpperCase()+e.slice(1);return`${ke} \u2014 ${t}`}var ce=B(ke,"color"),Ci=[ce.color("--evcc-animal-eye-good","Eye \u2014 Good (>50% battery)"),ce.color("--evcc-animal-eye-mid","Eye \u2014 Mid (25\u201350%)"),ce.color("--evcc-animal-eye-warn","Eye \u2014 Warn (15\u201325%)"),ce.color("--evcc-animal-eye-low","Eye \u2014 Low (\u226415%)"),ce.color("--evcc-animal-eye-charging","Eye \u2014 Charging (pulses)"),ce.color("--evcc-animal-fur","Fur (all animals)"),ce.color("--evcc-animal-fur-shadow","Fur Shadow (all)"),ce.color("--evcc-animal-fur-highlight","Fur Highlight (all)"),ce.color("--evcc-animal-eye","Eye Base (all)"),ce.color("--evcc-animal-pupil","Pupil (all)"),ce.color("--evcc-animal-nose","Nose (all)"),ce.color("--evcc-animal-whisker","Whisker (all)"),ce.color("--evcc-animal-ear-inner","Ear Inner (all)"),ce.color("--evcc-animal-white-tip","White Tip / Accent (all)")],Oi=[{suffix:"eye-good",label:"Eye \u2014 Good"},{suffix:"eye-mid",label:"Eye \u2014 Mid"},{suffix:"eye-warn",label:"Eye \u2014 Warn"},{suffix:"eye-low",label:"Eye \u2014 Low"},{suffix:"eye-charging",label:"Eye \u2014 Charging"},{suffix:"fur",label:"Fur"},{suffix:"fur-shadow",label:"Fur Shadow"},{suffix:"fur-highlight",label:"Fur Highlight"},{suffix:"eye",label:"Eye Base"},{suffix:"pupil",label:"Pupil"},{suffix:"nose",label:"Nose"},{suffix:"whisker",label:"Whisker"},{suffix:"ear-inner",label:"Ear Inner"},{suffix:"white-tip",label:"White Tip / Accent"}];function Pi(i){let e=String(i||"").replace(/[^a-z0-9-]/gi,"");if(!e)return[];let t=Te(e),r=B(t,"color");return Oi.map(({suffix:a,label:n})=>r.color(`--evcc-animal-${e}-${a}`,n))}function kr(i){let e=Array.isArray(i)?i.filter(Boolean):[];return{parent:Ci,perAnimal:e.map(t=>({group:Te(t),tokens:Pi(t)}))}}function Tr(i){let e=Array.isArray(i)?i.filter(Boolean):[];return[ke,...e.map(Te)]}var Li=[hr,fr,gr,br,_r,yr,xr,wr,Sr,Rr],Ni=[Er],Fi=["cat","dog","raccoon","parrot","snake"];function Hi(){try{let i=typeof window<"u"&&window.AnimalSVG?.list?window.AnimalSVG.list():null;if(Array.isArray(i)&&i.length>0)return i}catch{}return Fi}function Di(i){let e=new Set;for(let t of i){let r=String(t?.key??"");if(!r)throw new Error("[theme-tokens] Registry entry is missing key.");if(e.has(r))throw new Error(`[theme-tokens] Duplicate token key detected: ${r}`);e.add(r)}}var de=[],be={},Bi={},te=[];function Mr(){let i=Hi(),{parent:e,perAnimal:t}=kr(i),r=t.flatMap(o=>o.tokens),n=[...Li,e,r,...Ni].flat();Di(n);let c=Tr(i),s=Ye(c);de=n,be=Object.freeze(Object.fromEntries(n.map(o=>[o.key,o]))),Bi=Object.freeze(s.reduce((o,l)=>(o[l]=n.filter(d=>d.group===l),o),{})),te=s}Mr();typeof document<"u"&&document.addEventListener&&document.addEventListener("animal-svg-registered",()=>{try{Mr()}catch(i){console.warn("[theme-tokens] rebuild on animal-svg-registered failed:",i)}});function zi(i,e){let t=String(i||"").trim(),r;if(/^#[0-9a-fA-F]{8}$/.test(t))r=`#${t.slice(1,7)}`;else if(/^#[0-9a-fA-F]{6}$/.test(t))r=t;else return t;if(e==null)return t;let a=Math.max(0,Math.min(1,Number(e)));if(Number.isNaN(a))return t;let n=Math.round(a*255).toString(16).padStart(2,"0").toLowerCase();return`${r}${n}`}function $r(i){i._emptyThemeDraft=function(){return{tokens:{},colors:{},alpha:{}}},i._themeDraftHasOverrides=function(e){return Object.keys(e.tokens).length>0||Object.keys(e.colors).length>0||Object.keys(e.alpha).length>0},i._applyThemeDraftBucket=function(e,t){!t||typeof t!="object"||Object.entries(t).forEach(([r,a])=>{if(a==null||a===""){delete e[r];return}e[r]=a})},i._normalizeThemeDraft=function(e){let t=this._emptyThemeDraft();return!e||typeof e!="object"||(this._applyThemeDraftBucket(t.tokens,e.tokens),this._applyThemeDraftBucket(t.colors,e.colors),this._applyThemeDraftBucket(t.alpha,e.alpha)),t},i.applyThemeDraftPatch=function(e){let t=this._ensureThemeState();this._applyThemeDraftBucket(t.workingDraft.tokens,e?.tokens),this._applyThemeDraftBucket(t.workingDraft.colors,e?.colors),this._applyThemeDraftBucket(t.workingDraft.alpha,e?.alpha),t.draftDirty=this._themeDraftHasOverrides(t.workingDraft)},i.applyThemeActivation=function(e,t={}){let r=this._ensureThemeState(),a=t.clearDraft!==!1;r.activeThemeId=e??null,a&&(r.workingDraft=this._emptyThemeDraft(),r.draftDirty=!1)},i._ensureThemeState=function(){return this._themeState||(this._themeState={library:{},librarySummary:[],defaultThemeId:null,activeThemeId:null,workingDraft:this._emptyThemeDraft(),draftDirty:!1,editorMode:"live",selectedThemeId:null,activeSubTab:"presets",focusedGroup:"",tokenSearchQuery:"",selectedGroupFilter:"all",groupOpen:{},groupSearchQueryByName:{},modifiedOnly:!1}),this._themeState},i.setBackendThemeState=function(e){let t=this._ensureThemeState();t.activeThemeId=e?.active_theme_id??null,t.workingDraft=this._normalizeThemeDraft(e?.working_draft),t.draftDirty=e?.draft_dirty??this._themeDraftHasOverrides(t.workingDraft),t.editorMode=e?.editor_mode??"live"},i.setThemeLibrary=function(e){let t=this._ensureThemeState();t.library=e?.library??{},t.librarySummary=e?.themes??[],t.defaultThemeId=e?.default_theme_id??null},i.resolvedTheme=function(){let e=this._ensureThemeState(),t={},r={},a={},n={},c=e.library?.[e.activeThemeId]||null;return c&&(Object.entries(c.colors||{}).forEach(([s,o])=>{a[s]=o,r[s]="theme"}),Object.entries(c.alpha||{}).forEach(([s,o])=>{n[s]=o,r[s]||(r[s]="theme")}),Object.entries(c.tokens||{}).forEach(([s,o])=>{t[s]=o,r[s]="theme"})),Object.entries(e.workingDraft.colors).forEach(([s,o])=>{a[s]=o,r[s]="draft"}),Object.entries(e.workingDraft.alpha).forEach(([s,o])=>{n[s]=o,r[s]="draft"}),Object.entries(e.workingDraft.tokens).forEach(([s,o])=>{t[s]=o,r[s]="draft"}),Object.entries(a).forEach(([s,o])=>{let l=s in n?n[s]:null;t[s]=zi(o,l)}),{tokens:t,sources:r}},i.setThemeSubTab=function(e){this._ensureThemeState().activeSubTab=e},i.setThemeSearchQuery=function(e){this._ensureThemeState().tokenSearchQuery=String(e||"").toLowerCase()},i.setThemeModifiedOnly=function(e){this._ensureThemeState().modifiedOnly=!!e},i.setSelectedTheme=function(e){this._ensureThemeState().selectedThemeId=e},i.setThemeFocusedGroup=function(e){let t=this._ensureThemeState(),r=String(e||"").trim();t.focusedGroup=te.includes(r)?r:""},i.getThemeFocusedGroup=function(){let e=String(this._ensureThemeState().focusedGroup||"").trim();return te.includes(e)?e:""},i.currentThemePreviewGroup=function(){let e=this._ensureThemeState(),t=String(e.selectedGroupFilter||"").trim(),r=String(e.activeSubTab||"presets").trim().toLowerCase();if(te.includes(t))return t;let a=this.getThemeFocusedGroup();if(te.includes(a))return a;if(r==="palette")return"Shared Foundations";let n=te.find(c=>this.isThemeGroupOpen(c));return n||"Shared Foundations"},i.setThemeGroupFilter=function(e){let t=this._ensureThemeState();t.selectedGroupFilter=String(e||"all")},i.toggleThemeGroup=function(e){let t=this._ensureThemeState();t.groupOpen[e]=!this.isThemeGroupOpen(e)},i.isThemeGroupOpen=function(e){let t=this._ensureThemeState();return e in t.groupOpen?!!t.groupOpen[e]:!0},i.setThemeGroupSearchQuery=function(e,t){let r=this._ensureThemeState();r.groupSearchQueryByName[e]=String(t||"").toLowerCase()},i.getThemeGroupSearchQuery=function(e){return this._ensureThemeState().groupSearchQueryByName[e]||""},i.getSelectedTheme=function(){let e=this._ensureThemeState();return e.library?.[e.selectedThemeId]||null},i.getActiveTheme=function(){let e=this._ensureThemeState();return e.library?.[e.activeThemeId]||null},i.getThemeGroupFilter=function(){return this._ensureThemeState().selectedGroupFilter||"all"},i.tokenMatchesGlobalThemeSearch=function(e,t="",r=""){let a=String(r||"").toLowerCase();if(!a)return!0;let n=String(e?.label||"").toLowerCase(),c=String(e?.key||"").toLowerCase(),s=String(t||"").toLowerCase(),o=Array.isArray(e?.aliases)?e.aliases.map(u=>String(u||"").toLowerCase()):[],l=Array.isArray(e?.usage)?e.usage.map(u=>String(u||"").toLowerCase()):[],d=Array.isArray(e?.affects)?e.affects.map(u=>String(u||"").toLowerCase()):[];return!!(n.includes(a)||c.includes(a)||s.includes(a)||o.some(u=>u.includes(a))||l.some(u=>u.includes(a))||d.some(u=>u.includes(a)))},i.tokenMatchesThemeGroupSearch=function(e,t="",r){let a=this.getThemeGroupSearchQuery(r);return this.tokenMatchesGlobalThemeSearch(e,t,a)},i.filteredThemeTokens=function(e,t={}){let r=this._ensureThemeState(),{tokens:a,sources:n}=this.resolvedTheme(),c=r.tokenSearchQuery,s=r.modifiedOnly,o=r.selectedGroupFilter||"all",l=t.excludeKeys instanceof Set?t.excludeKeys:new Set;return e.filter(d=>{let u=d.key,m=a[u]||"",v=n[u]||"ha",p=d.group||"";if(l.has(u)||s&&v!=="draft")return!1;if(o==="modified"){if(v!=="draft")return!1}else if(o!=="all"&&p!==o&&!p.startsWith(o+" \u2014 "))return!1;return!!this.tokenMatchesGlobalThemeSearch(d,m,c)})},i.filteredThemeTokensForGroup=function(e,t,r={}){let{tokens:a}=this.resolvedTheme();return this.filteredThemeTokens(t,r).filter(n=>{if(n.group!==e)return!1;let c=a[n.key]||"";return this.tokenMatchesThemeGroupSearch(n,c,e)})},i.themeGroupCounts=function(e,t,r={}){let{sources:a}=this.resolvedTheme(),n=this.filteredThemeTokensForGroup(e,t,r),c=n.length;return{modified:n.filter(o=>(a[o.key]||"ha")==="draft").length,total:c}},i.shouldForceThemeGroupOpenForSearch=function(e,t,r={}){return this._ensureThemeState().tokenSearchQuery?this.themeGroupCounts(e,t,r).total>0:!1}}function Ar(i){i._mapViewActive=null,i._mapSegmentsData=null,i._selectedSegmentIds=null,i._mapViewStorageKey=function(){return`evcc_map_view_active_${ie(this.config?.vacuum??"")}`},i.isMapViewActive=function(){if(this._mapViewActive===null){let e=localStorage.getItem(this._mapViewStorageKey());this._mapViewActive=e==="true"}return this._mapViewActive},i.setMapViewActive=function(e){this._mapViewActive=!!e;try{localStorage.setItem(this._mapViewStorageKey(),String(this._mapViewActive))}catch{}},i.toggleMapView=function(){this.setMapViewActive(!this.isMapViewActive())},i.mapSegmentsData=function(){return this._mapSegmentsData},i.setMapSegmentsData=function(e){let t=this._mapSegmentsData?.map_id;this._mapSegmentsData=e,e?.map_id!==t?(this._segmentRoomOverlay=null,this._dotAnchorOverlay=null,this._mapAnchorMode=!1,this.resetMapTransform()):(this._segmentRoomOverlay=null,this._dotAnchorOverlay=null)},i.mapSegments=function(){return this._mapSegmentsData?.segments??[]},i.mapImageUrl=function(){let e=this._mapSegmentsData?.image_variants??{};return(e.dark??e.default??e.light)?.browser_url??null},i._getSegmentIds=function(){return this._selectedSegmentIds||(this._selectedSegmentIds=new Set),this._selectedSegmentIds},i.selectedSegmentIds=function(){return this._getSegmentIds()},i.isSegmentSelected=function(e){return this._getSegmentIds().has(String(e))},i.toggleSegmentSelected=function(e){let t=this._getSegmentIds(),r=String(e);t.has(r)?t.delete(r):t.add(r)},i.clearSegmentSelection=function(){this._getSegmentIds().clear()},i.enableSegmentForRoom=function(e){let t=this.segmentIdForRoom(e);t&&this._getSegmentIds().add(String(t))},i.disableSegmentForRoom=function(e){let t=this.segmentIdForRoom(e);t&&this._getSegmentIds().delete(String(t))},i.selectedSegments=function(){let e=this.mapSegments(),t=[];for(let r of this._getSegmentIds()){let a=e.find(n=>String(n.segment_id)===r);a&&t.push(a)}return t},i._configSelectedSegmentId=null,i.configSelectedSegmentId=function(){return this._configSelectedSegmentId},i.setConfigSelectedSegmentId=function(e){this._configSelectedSegmentId=e!=null?String(e):null},i._segmentRoomOverlay=null,i._segRoomLegacyKey=function(){let e=this._mapSegmentsData?.map_id??"unknown";return`evcc_seg_rooms_${ie(this.config?.vacuum??"")}_${e}`},i._ensureSegmentRoomOverlay=function(){return this._segmentRoomOverlay||(this._segmentRoomOverlay=new Map),this._segmentRoomOverlay},i.getLegacySegmentRoomLinks=function(){try{let e=localStorage.getItem(this._segRoomLegacyKey());if(!e)return null;let t=JSON.parse(e);return!t||typeof t!="object"?null:t}catch{return null}},i.clearLegacySegmentRoomLinks=function(){try{localStorage.removeItem(this._segRoomLegacyKey())}catch{}},i.roomIdForSegment=function(e){let t=String(e),r=this.mapSegments().find(a=>String(a.segment_id)===t);return r?.room_id!=null?String(r.room_id):this._segmentRoomOverlay?.get(t)??null},i.segmentIdForRoom=function(e){let t=String(e),r=this.mapSegments().find(a=>a.room_id!=null&&String(a.room_id)===t);if(r)return String(r.segment_id);if(this._segmentRoomOverlay){for(let[a,n]of this._segmentRoomOverlay)if(n===t)return a}return null},i.assignSegmentRoom=function(e,t){let r=String(e),a=String(t),n=this._ensureSegmentRoomOverlay();for(let[c,s]of n)s===a&&c!==r&&n.delete(c);n.set(r,a)},i.unassignSegmentRoom=function(e){this._ensureSegmentRoomOverlay().delete(String(e))},i.configSelectedSegment=function(){let e=this._configSelectedSegmentId;return e?this.mapSegments().find(t=>String(t.segment_id)===e)??null:null},i._mapActionStatus=null,i.mapActionStatus=function(){return this._mapActionStatus},i.setMapActionStatus=function(e){this._mapActionStatus=e},i.clearMapActionStatus=function(){this._mapActionStatus=null},i.mapNudgeStep=function(){let e=this._mapSegmentsData?.image_variants??{},t=e.dark??e.default??e.light,r=t?.width??1e3,a=t?.height??1e3;return{x:Math.max(1,Math.round(r*.005)),y:Math.max(1,Math.round(a*.005))}},i._mapZoom=1,i._mapTranslateX=0,i._mapTranslateY=0,i.mapZoom=function(){return this._mapZoom},i.mapTranslateX=function(){return this._mapTranslateX},i.mapTranslateY=function(){return this._mapTranslateY},i.resetMapTransform=function(){this._mapZoom=1,this._mapTranslateX=0,this._mapTranslateY=0},i.applyMapZoom=function(e,t,r){let a=Math.max(.5,Math.min(8,e)),n=a/this._mapZoom;this._mapTranslateX=t-(t-this._mapTranslateX)*n,this._mapTranslateY=r-(r-this._mapTranslateY)*n,this._mapZoom=a},i.applyMapPan=function(e,t){this._mapTranslateX+=e,this._mapTranslateY+=t},i._dotAnchorOverlay=null,i._mapAnchorMode=!1,i._dotAnchorLegacyKey=function(){let e=this._mapSegmentsData?.map_id??"unknown";return`evcc_dot_anchors_${ie(this.config?.vacuum??"")}_${e}`},i._ensureDotAnchorOverlay=function(){return this._dotAnchorOverlay||(this._dotAnchorOverlay=new Map),this._dotAnchorOverlay},i.getLegacyDotAnchors=function(){try{let e=localStorage.getItem(this._dotAnchorLegacyKey());if(!e)return null;let t=JSON.parse(e);return!t||typeof t!="object"?null:t}catch{return null}},i.clearLegacyDotAnchors=function(){try{localStorage.removeItem(this._dotAnchorLegacyKey())}catch{}},i.roomDotAnchor=function(e){let t=String(e);return this._dotAnchorOverlay?.has(t)?this._dotAnchorOverlay.get(t):this._mapSegmentsData?.companion_anchors?.[t]??null},i.setRoomDotAnchor=function(e,t,r){let a=String(e);this._ensureDotAnchorOverlay().set(a,{pct_x:t,pct_y:r})},i.isMapAnchorMode=function(){return this._mapAnchorMode},i.setMapAnchorMode=function(e){this._mapAnchorMode=!!e},i.currentMapRoom=function(){let e=this.rawRobotPosition?.();if(!e||e.x==null||e.y==null)return null;let t=this.getRoomsForActiveMap?.()??[],r=50;for(let a of t){if(a.is_transition||a.isTransition)continue;let n=a.bounds;if(n&&e.x>=n.min_x-r&&e.x<=n.max_x+r&&e.y>=n.min_y-r&&e.y<=n.max_y+r)return a}return null},i._configSelectedVertexIndex=null,i.configSelectedVertexIndex=function(){return this._configSelectedVertexIndex},i.setConfigSelectedVertexIndex=function(e){this._configSelectedVertexIndex=e!=null?Number(e):null},i._mapAnimalSelection=null,i._animalSelectionKey=function(){return`evcc_animal_${ie(this.config?.vacuum??"")}`},i.mapAnimalSelection=function(){if(this._mapAnimalSelection===null)try{this._mapAnimalSelection=localStorage.getItem(this._animalSelectionKey())??"cat"}catch{this._mapAnimalSelection="cat"}return this._mapAnimalSelection},i.setMapAnimalSelection=function(e){this._mapAnimalSelection=e;try{localStorage.setItem(this._animalSelectionKey(),e)}catch{}},i._mapAnimalScale=null,i._animalScaleKey=function(){return`evcc_animal_scale_${ie(this.config?.vacuum??"")}`},i.mapAnimalScale=function(){if(this._mapAnimalScale===null)try{let e=parseFloat(localStorage.getItem(this._animalScaleKey()));this._mapAnimalScale=isFinite(e)?e:1}catch{this._mapAnimalScale=1}return this._mapAnimalScale},i.setMapAnimalScale=function(e){let t=Math.max(.5,Math.min(3,Number(e)));this._mapAnimalScale=t;try{localStorage.setItem(this._animalScaleKey(),String(t))}catch{}}}function Ir(i){i._viewport="desktop",i.viewport=function(){return this._viewport},i.isMobileViewport=function(){return this._viewport==="mobile"},i.isCompactRender=function(){return this._viewport==="mobile"},i.setViewportFromWidth=function(e){let t=e<600?"mobile":"desktop";return t===this._viewport?!1:(this._viewport=t,!0)},i.setViewport=function(e){return e!=="mobile"&&e!=="desktop"||e===this._viewport?!1:(this._viewport=e,!0)}}function Cr(i){i._ensureLearningState=function(){return this._learning||(this._learning={estimate:null,reanchored:null,completedRooms:[],nextRoom:null,jobActive:!1,summary:null,dashboardSnapshot:null,incompleteRunLog:null,troubleRoomsLog:null,roomEstimates:{},roomEstimateMeta:{stats_stale:!1,stats_rebuilt_at:null,estimated_at:null,room_count:0,current_battery:null,map_id:null,vacuum_entity_id:null}}),Array.isArray(this._learning.completedRooms)||(this._learning.completedRooms=[]),(!this._learning.roomEstimates||typeof this._learning.roomEstimates!="object")&&(this._learning.roomEstimates={}),(!this._learning.roomEstimateMeta||typeof this._learning.roomEstimateMeta!="object")&&(this._learning.roomEstimateMeta={stats_stale:!1,stats_rebuilt_at:null,estimated_at:null,room_count:0,current_battery:null,map_id:null,vacuum_entity_id:null}),this._learning},i.clearLearningState=function(){this._learning={estimate:null,reanchored:null,completedRooms:[],nextRoom:null,jobActive:!1,summary:null,dashboardSnapshot:null,incompleteRunLog:null,troubleRoomsLog:null,roomEstimates:{},roomEstimateMeta:{stats_stale:!1,stats_rebuilt_at:null,estimated_at:null,room_count:0,current_battery:null,map_id:null,vacuum_entity_id:null}}},i.clearLearningJobContext=function(){let e=this._ensureLearningState();e.estimate=null,e.reanchored=null,e.completedRooms=[],e.nextRoom=null,e.jobActive=!1,e.summary=null},i.learningState=function(){return this._ensureLearningState()},i.dashboardSnapshot=function(){return this._ensureLearningState().dashboardSnapshot??null},i.dashboardJobProgress=function(){return this.dashboardSnapshot()?.job_progress??null},i.dashboardJobControl=function(){return this.dashboardSnapshot()?.job_control??null},i.dashboardStartStatus=function(){return this.dashboardSnapshot()?.start_status??null},i.dashboardLifecycle=function(){return this.dashboardSnapshot()?.lifecycle??null},i.dashboardUpkeep=function(){return this.dashboardSnapshot()?.upkeep??null},i.dashboardAdapterVocabulary=function(){return this.dashboardSnapshot()?.adapter_vocabulary??null},i.adapterOptionsFor=function(e){let r=this.dashboardAdapterVocabulary()?.[`${e}_options`];return Array.isArray(r)?r:[]},i.adapterOptionValuesFor=function(e){return this.adapterOptionsFor(e).map(t=>t?.value).filter(Boolean)},i.dashboardStatusSummary=function(){return this.dashboardSnapshot()?.status_summary??null},i.dashboardAttentionSummary=function(){return this.dashboardSnapshot()?.attention_summary??null},i.dashboardPlannedJobEstimate=function(){return this.dashboardSnapshot()?.planned_job_estimate??null},i.dashboardPlannedWaterEstimate=function(){return this.dashboardPlannedJobEstimate()?.water_estimate??null},i.dashboardPlannedWaterRooms=function(){let e=this.dashboardPlannedWaterEstimate()?.rooms;return Array.isArray(e)?e:[]},i.dashboardPlannedWaterRoomForRoom=function(e,t=null){let r=e==null?null:String(e),a=t==null?null:String(t).trim().toLowerCase();return this.dashboardPlannedWaterRooms().find(n=>{let c=n?.room_id==null?null:String(n.room_id),s=n?.slug==null?null:String(n.slug).trim().toLowerCase();return!!(r!=null&&c===r||a&&s===a)})??null},i.dashboardPlannedJobEstimateAvailable=function(){return!!this.dashboardPlannedJobEstimate()?.available},i.dashboardPlannedJobEstimateTotalMinutes=function(){let e=Number(this.dashboardPlannedJobEstimate()?.total_minutes);return Number.isFinite(e)?e:null},i.dashboardJobProgressTimeline=function(){let e=this.dashboardJobProgress()?.timeline;return Array.isArray(e)?e:[]},i._dashboardJobIsActive=function(){let e=this.dashboardJobProgress();if(!e||typeof e!="object")return!1;if(typeof e.terminal=="boolean")return!e.terminal;let t=String(e.status??"").trim().toLowerCase();return t?!["complete","completed","finished","idle","terminal","not_started","inactive"].includes(t):!1},i.incompleteRunLog=function(){return this._ensureLearningState().incompleteRunLog??null},i.hasIncompleteRunLog=function(){let e=this.incompleteRunLog();if(!e)return!1;let t=e.missed_room_ids;return Array.isArray(t)&&t.length>0},i.incompleteRunMissedRoomIds=function(){let e=this.incompleteRunLog()?.missed_room_ids;return Array.isArray(e)?e:[]},i.incompleteRunMissedRooms=function(){let e=this.incompleteRunLog()?.missed_rooms;return Array.isArray(e)?e:[]},i.setIncompleteRunLog=function(e){let t=this._ensureLearningState();t.incompleteRunLog=e??null},i.clearIncompleteRunLog=function(){let e=this._ensureLearningState();e.incompleteRunLog=null},i.troubleRoomsLog=function(){return this._ensureLearningState().troubleRoomsLog??null},i.hasTroubleRooms=function(){let e=this.troubleRoomsLog();if(!e||typeof e!="object")return!1;let t=e.rooms;return!t||typeof t!="object"?!1:Object.values(t).some(r=>r?.is_trouble===!0)},i.troubleRoomForRoom=function(e){let t=this.troubleRoomsLog();if(!t||typeof t!="object")return null;let r=t.rooms;if(!r||typeof r!="object")return null;let a=String(e);return r[a]??null},i.setTroubleRoomsLog=function(e){let t=this._ensureLearningState();t.troubleRoomsLog=e??null},i.clearTroubleRoomsLog=function(){let e=this._ensureLearningState();e.troubleRoomsLog=null},i.learningEstimate=function(){return this._ensureLearningState().estimate??this.dashboardPlannedJobEstimate()??null},i.learningReanchored=function(){return this._ensureLearningState().reanchored??null},i.learningCompletedRooms=function(){return[...this._ensureLearningState().completedRooms]},i.learningNextRoom=function(){return this._ensureLearningState().nextRoom??null},i.learningJobActive=function(){return this._dashboardJobIsActive()?!0:!!this._ensureLearningState().jobActive},i.learningSummary=function(){return this._ensureLearningState().summary??null},i.hasLearningSummary=function(){return!!this._ensureLearningState().summary},i.clearLearningSummary=function(){let e=this._ensureLearningState();e.summary=null},i.roomEstimates=function(){return this._ensureLearningState().roomEstimates??{}},i.roomEstimateMeta=function(){return this._ensureLearningState().roomEstimateMeta??{}},i.hasRoomEstimates=function(){return Object.keys(this.roomEstimates()).length>0},i.roomEstimateForRoom=function(e){let t=String(e),r=this.roomEstimates();for(let[a,n]of Object.entries(r))if(String(a)===t)return n??null;return null},i.roomEstimatesStatsStale=function(){return!!this.roomEstimateMeta().stats_stale},i.roomEstimatesStatsRebuiltAt=function(){return this.roomEstimateMeta().stats_rebuilt_at??null},i.roomEstimatesEstimatedAt=function(){return this.roomEstimateMeta().estimated_at??null},i.roomEstimateCount=function(){let e=Number(this.roomEstimateMeta().room_count);return Number.isFinite(e)?e:Object.keys(this.roomEstimates()).length},i.setLearningEstimate=function(e){let t=this._ensureLearningState();t.estimate=e??null},i.setDashboardSnapshot=function(e){let t=this._ensureLearningState();t.dashboardSnapshot=e??null},i.setLearningReanchored=function(e){let t=this._ensureLearningState();t.reanchored=e??null},i.setLearningNextRoom=function(e){let t=this._ensureLearningState();t.nextRoom=e??null},i.setLearningJobActive=function(e){let t=this._ensureLearningState();t.jobActive=!!e},i.setLearningCompletedRooms=function(e){let t=this._ensureLearningState();t.completedRooms=Array.isArray(e)?[...e]:[]},i.setRoomEstimates=function(e){let t=this._ensureLearningState(),r={};for(let a of e?.rooms??[])a?.room_id!=null&&(r[a.room_id]=a);t.roomEstimates=r,t.roomEstimateMeta={stats_stale:!!e?.stats_stale,stats_rebuilt_at:e?.stats_rebuilt_at??null,estimated_at:e?.estimated_at??null,room_count:Number(e?.room_count??Object.keys(r).length)||0,current_battery:e?.current_battery??null,map_id:e?.map_id??null,vacuum_entity_id:e?.vacuum_entity_id??null}},i.clearRoomEstimates=function(){let e=this._ensureLearningState();e.roomEstimates={},e.roomEstimateMeta={stats_stale:!1,stats_rebuilt_at:null,estimated_at:null,room_count:0,current_battery:null,map_id:null,vacuum_entity_id:null}},i.pushCompletedLearningRoom=function(e){let t=this._ensureLearningState();if(!e||e.room_id==null)return;let r=Number(e.actual_duration_minutes);Number.isFinite(r)&&t.completedRooms.push({room_id:e.room_id,actual_duration_minutes:r})},i.beginLearningJob=function(){let e=this._ensureLearningState();e.jobActive=!0,e.reanchored=e.estimate??null,e.completedRooms=[],e.nextRoom=null,e.summary=null},i.endLearningJob=function(e=null){let t=this._ensureLearningState(),r=t.estimate,a=t.reanchored??r,n=Array.isArray(t.completedRooms)?t.completedRooms:[],c=Number(e?.actual_cleaning_minutes??e?.duration_minutes),s=Number(e?.room_count),o=Number(a?.total_minutes??r?.total_minutes??0);r||a||n.length||e?t.summary={finished_at:new Date().toISOString(),total_minutes:Number.isFinite(c)&&c>0?c:o||0,rooms_completed:Number.isFinite(s)&&s>0?s:n.length,predicted_total_minutes:o||null,battery_warning:!!a?.battery_warning,final_payload:a??r??null}:t.summary=null,t.jobActive=!1,t.reanchored=null,t.completedRooms=[],t.nextRoom=null},i.hasLearningEstimate=function(){let e=this.learningEstimate();return!!e&&!e?.error},i.learningEstimateError=function(){return this.learningEstimate()?.error??null},i.learningEstimateErrorDetail=function(){return this.learningEstimate()?.error_detail??null},i.learningStatsStale=function(){return!!this.learningEstimate()?.stats_stale},i.learningBatteryWarning=function(){return!!(this.dashboardJobProgress()??this.learningReanchored()??this.learningEstimate())?.battery_warning},i.learningCanRenderEstimatePanel=function(){let e=this.learningEstimate();return!(!e||e.error)},i.learningTotalMinutes=function(){let e=Number(this.dashboardPlannedJobEstimateTotalMinutes()??this.learningEstimate()?.total_minutes);return Number.isFinite(e)?e:null},i.learningJobEtaAt=function(){return this.dashboardJobProgress()?.status_summary?.eta_at??this.dashboardPlannedJobEstimate()?.job_eta_at??this.learningEstimate()?.job_eta_at??null},i.learningConfidenceBreakpoint=function(){return this.dashboardPlannedJobEstimate()?.confidence_breakpoint??this.learningEstimate()?.confidence_breakpoint??null},i.learningRoomTimeline=function(){let e=this.dashboardJobProgressTimeline();if(e.length)return e;let t=this.dashboardPlannedJobEstimate()?.room_timeline;if(Array.isArray(t)&&t.length)return t;let r=this.learningReanchored()??this.learningEstimate();return Array.isArray(r?.room_timeline)?r.room_timeline:[]},i.learningRoomsCompletedCount=function(){let e=this.dashboardJobProgress()?.completed_room_ids;if(Array.isArray(e))return e.length;let t=this.learningReanchored(),r=Number(t?.rooms_completed);return Number.isFinite(r)?r:this._ensureLearningState().completedRooms.length},i.learningRoomsRemainingCount=function(){let e=this.dashboardJobProgress()?.remaining_room_ids;if(Array.isArray(e))return e.length;let t=this.learningReanchored(),r=Number(t?.rooms_remaining);return Number.isFinite(r)?r:this.learningRoomTimeline().filter(n=>!n?.completed).length},i.learningAllCompleted=function(){let e=this.dashboardJobProgress();if(e&&typeof e.terminal=="boolean")return e.terminal;let t=this.learningReanchored();if(typeof t?.all_completed=="boolean")return t.all_completed;let r=this.learningNextRoom();return!!(r&&Object.keys(r).length===0)},i.learningLiveBannerRoom=function(){let e=this.dashboardJobProgress()?.current_room_id;if(e!=null){let r=this.learningTimelineEntryForRoom(e);if(r)return r}let t=this.learningRoomTimeline().find(r=>!!r?.current);return t||this.learningNextRoom()},i.learningTimelineEntryForRoom=function(e){let t=String(e);return this.learningRoomTimeline().find(r=>String(r?.room_id)===t)??null}}function Or(i){i._ensureSetupState=function(){return this._setupState||(this._setupState={status:null,loading:!1,error:null,lastResult:null}),this._setupState},i.setupStatus=function(){return this._ensureSetupState().status??null},i.setSetupStatus=function(e){this._ensureSetupState().status=e??null},i.setupLoading=function(){return this._ensureSetupState().loading},i.setSetupLoading=function(e){this._ensureSetupState().loading=!!e},i.setupError=function(){return this._ensureSetupState().error??null},i.setSetupError=function(e){this._ensureSetupState().error=e??null},i.setupLastResult=function(){return this._ensureSetupState().lastResult??null},i.setSetupLastResult=function(e){this._ensureSetupState().lastResult=e??null},i._ensureSetupRoomEditor=function(){return this._setupRoomEditor||(this._setupRoomEditor={openMapId:null,rooms:null,loadingMapId:null,enabled:{},floorTypes:{},saving:!1,configuredMapIds:{}}),this._setupRoomEditor},i.setupRoomEditorOpenMapId=function(){return this._ensureSetupRoomEditor().openMapId??null},i.setupRoomEditorRooms=function(){return this._ensureSetupRoomEditor().rooms??null},i.setupRoomEditorLoadingMapId=function(){return this._ensureSetupRoomEditor().loadingMapId??null},i.setupRoomEditorSaving=function(){return this._ensureSetupRoomEditor().saving},i.isSetupMapConfigured=function(e){return!!this._ensureSetupRoomEditor().configuredMapIds[String(e)]},i.setSetupRoomEditorLoadingMapId=function(e){this._ensureSetupRoomEditor().loadingMapId=e??null},i.openSetupRoomEditor=function(e,t){let r=this._ensureSetupRoomEditor();r.openMapId=e,r.rooms=t,r.loadingMapId=null;let a={},n={};for(let c of t){let s=String(c.room_id);a[s]=!0,n[s]=c.floor_type||"hardwood"}r.enabled=a,r.floorTypes=n},i.closeSetupRoomEditor=function(){let e=this._ensureSetupRoomEditor();e.openMapId=null,e.rooms=null},i.toggleSetupRoom=function(e){let t=this._ensureSetupRoomEditor(),r=String(e);t.enabled[r]=t.enabled[r]===!1},i.setSetupRoomFloorType=function(e,t){this._ensureSetupRoomEditor().floorTypes[String(e)]=t},i.setSetupRoomEditorSaving=function(e){this._ensureSetupRoomEditor().saving=!!e},i.markSetupMapConfigured=function(e){this._ensureSetupRoomEditor().configuredMapIds[String(e)]=!0},i._ensureSetupDeleteState=function(){return this._setupDeleteState||(this._setupDeleteState={pendingMapId:null,stage:null,typedToken:"",deleting:!1}),this._setupDeleteState},i.setupDeletePendingMapId=function(){return this._ensureSetupDeleteState().pendingMapId??null},i.setupDeleteStage=function(){return this._ensureSetupDeleteState().stage??null},i.setupDeleteTypedToken=function(){return this._ensureSetupDeleteState().typedToken??""},i.setupDeleteDeleting=function(){return this._ensureSetupDeleteState().deleting},i.openSetupDeleteConfirm=function(e,t){let r=this._ensureSetupDeleteState();r.pendingMapId=e,r.stage=t?"typing":"confirm",r.typedToken="",r.deleting=!1},i.setSetupDeleteTypedToken=function(e){this._ensureSetupDeleteState().typedToken=e??""},i.setSetupDeleteDeleting=function(e){this._ensureSetupDeleteState().deleting=!!e},i.closeSetupDeleteConfirm=function(){let e=this._ensureSetupDeleteState();e.pendingMapId=null,e.stage=null,e.typedToken="",e.deleting=!1},i.setupRoomEditorEnabledIds=function(){let e=this._ensureSetupRoomEditor();return(e.rooms??[]).filter(r=>e.enabled[String(r.room_id)]!==!1).map(r=>r.room_id)},i.setupRoomEditorFloorTypesMap=function(){return{...this._ensureSetupRoomEditor().floorTypes}}}var Me={ALL:"all",HAS_BOUNDS:"has_bounds",NO_BOUNDS:"no_bounds"};function Pr(i){i._ensureMappingReviewState=function(){return this._mappingReviewState||(this._mappingReviewState={snapshot:null,filter:Me.ALL,pendingClearRoomId:null,pendingJobAction:null,pendingRebuildRoomId:null}),this._mappingReviewState},i.mappingBoundsSnapshot=function(){return this._ensureMappingReviewState().snapshot??null},i.setMappingBoundsSnapshot=function(e){this._ensureMappingReviewState().snapshot=e??null},i.mappingBoundsFilter=function(){return this._ensureMappingReviewState().filter},i.setMappingBoundsFilter=function(e){let t=this._ensureMappingReviewState();t.filter=Object.values(Me).includes(e)?e:Me.ALL},i.beginMappingBoundsClear=function(e){this._ensureMappingReviewState().pendingClearRoomId=String(e)},i.endMappingBoundsClear=function(){this._ensureMappingReviewState().pendingClearRoomId=null},i.isMappingBoundsClearPending=function(e){return this._ensureMappingReviewState().pendingClearRoomId===String(e)},i.beginMappingJobAction=function(e,t,r){this._ensureMappingReviewState().pendingJobAction={roomId:String(e),jobIndex:Number(t),action:r}},i.endMappingJobAction=function(){this._ensureMappingReviewState().pendingJobAction=null},i.isMappingJobActionPending=function(e,t){let r=this._ensureMappingReviewState().pendingJobAction;return r!==null&&r.roomId===String(e)&&r.jobIndex===Number(t)},i.beginMappingRebuild=function(e){this._ensureMappingReviewState().pendingRebuildRoomId=String(e)},i.endMappingRebuild=function(){this._ensureMappingReviewState().pendingRebuildRoomId=null},i.isMappingRebuildPending=function(e){return this._ensureMappingReviewState().pendingRebuildRoomId===String(e)},i.mappingBoundsFilterOptions=function(){return[{value:Me.ALL,label:"All Rooms"},{value:Me.HAS_BOUNDS,label:"Has Bounds"},{value:Me.NO_BOUNDS,label:"No Bounds"}]}}var z=class{constructor(e,t){this.hass=e,this.config=t}sync(e,t){return this.hass=e,this.config=t,this}};Xt(z.prototype);Zt(z.prototype);er(z.prototype);tr(z.prototype);rr(z.prototype);ar(z.prototype);cr(z.prototype);sr(z.prototype);or(z.prototype);lr(z.prototype);dr(z.prototype);ur(z.prototype);vr(z.prototype);pr(z.prototype);$r(z.prototype);Ar(z.prototype);Ir(z.prototype);Cr(z.prototype);Or(z.prototype);Pr(z.prototype);function Lr(i){i.escapeHtml=function(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")},i.renderSelect=function(e,t,r,a,n=!1){let c=Array.isArray(r)?r:[];return`
    ...
    `},i.formatTimestamp=function(e,t={},r=""){if(!e)return r;let a=new Date(e);return Number.isNaN(a.getTime())?r:a.toLocaleString([],t)}}function Nr(i){i.renderBaseStationView=function(e){let{state:t}=e,r=t.dashboardUpkeep?.()??{},a=t.dockStatusLabel?.()??t.dockStatus?.()??r.dock_status_label??r.dock_status??null,n=t.dockLifecycleStateLabel?.()??t.dockLifecycleState?.()??null,c=t.dockTaskStatusLabel?.()??t.dockTaskStatus?.()??null,s=t.isDocked?.()??!1,o=t.dockActionStatus?.()??null,l=t.dashboardPlannedWaterEstimate?.()??null,d=r.dock_events??{},u=t.pauseTimeoutMinutesDefault?.(),v=[{id:"wash_mop",label:"Wash Mop"},{id:"dry_mop",label:"Dry Mop"},{id:"stop_dry_mop",label:"Stop Drying"},{id:"empty_dust",label:"Empty Dust"}].filter(({id:b})=>t.dockActionGate?.(b)?.supported!==!1),p=v.map(({id:b,label:R})=>this._renderDockActionCard(b,R,t)).join(""),f=t.dockActionGate?.("wash_mop")?.supported!==!1,h=v.length>0;return`
...
config/eufy_vacuum/battery/${this.escapeHtml(R)}/samples.jsonl</pre>
    ...
    `}}function Hr(i){i.renderLearningReviewView=function(e){let{state:t}=e,r=t.learningHistorySnapshot?.();if(!r)return'<div class="evcc-empty">Loading learning history...</div>';if(r.available===!1)return`
    ...
    `:""},i.renderRoomsActionBar=function(e,t,r,a,n){let c=r===1?"1 room":`${r} rooms`,s=(Array.isArray(a)?a:[]).filter(P=>P.enabled),o=e?n?"evcc-chip--start-warn":"evcc-chip--start":"disabled",l=this.card?._state,d=!!l?.hasActiveRun?.(),u=Number(this.card?._learningController?.getJobProgressPercent?.()??0),m=Array.isArray(l?.learningRoomTimeline?.())?l.learningRoomTimeline():[],v=l?.learningCompletedRooms?.()||[],p=new Set(v.map(P=>String(P.room_id))),f=s.reduce((P,L)=>{let U=String(L.id),F=m.find(ae=>String(ae.room_id)===U),Z=this.card?._state?.roomEstimateForRoom?.(L.id)??null,oe=Number(F?.minutes??Z?.minutes);return Number.isFinite(oe)?P+oe:P},0),h=Number(l?.dashboardPlannedJobEstimateTotalMinutes?.()),b=Number.isFinite(h)&&h>0?h:f,R=b>0?this._formatLearningDuration(b):null,S=l?.startConfirmation?.()??null,g=l?.startPreflight?.()??S?.preflight??null,x=!!l?.startRequiresConfirmation?.(),w=!!l?.cancelRunRequiresConfirmation?.(),I=!!l?.hasActiveRun?.(),O=!!l?.canPauseRun?.(),W=!!l?.canResumeRun?.(),Y=w?"Confirm Cancel":I?"Cancel Run":x?"Confirm Start":"Start Cleaning",fe=w?"evcc-chip--start-warn evcc-chip--confirm-flash":I?"evcc-chip--cancel-run":x?"evcc-chip--start-warn evcc-chip--confirm-flash":o,V=x||w,ve=Array.isArray(g?.blocked_rooms)?g.blocked_rooms:[],re=Array.isArray(g?.modified_rooms)?g.modified_rooms:[],le=Array.isArray(g?.warnings)?g.warnings:[];return`
    <div class="evcc-rooms-action-bar">
      ...
      ${s.length>0?`
        <div class="evcc-queue-chips">
          ...
          ${s.map((P,L)=>{let U=String(P.id),F=m.find(M=>String(M.room_id)===U),Z=p.has(U),oe=this.card?._learningController?.getRoomProgressSnapshot?.(P.id)??null,ae="evcc-queue-chip--queued";d&&(F?.completed||Z||oe?.isCompleted?ae="evcc-queue-chip--completed":F?.current||oe?.isCurrent?ae="evcc-queue-chip--current":(F?.remaining||F)&&(ae="evcc-queue-chip--remaining"));let pe="";if(F?.confidence_breakpoint?.ui_variant){let M=F.confidence_breakpoint.ui_variant;M==="success"?pe="evcc-queue-chip--confidence-high":M==="warning"?pe="evcc-queue-chip--confidence-medium":M==="error"&&(pe="evcc-queue-chip--confidence-low")}let $e=F?.minutes!=null?this._formatLearningMinutes(F.minutes):null,E=ae==="evcc-queue-chip--completed"?100:ae==="evcc-queue-chip--current"?Number(oe?.percent??u):0,D=ae==="evcc-queue-chip--current"?`${Math.max(0,Math.min(99,Math.floor(E)))}%`:$e;return`
              <button
                type="button"
                class="evcc-queue-chip ${ae} ${pe}"
                data-queue-chip="true"
                data-room-id="${P.id}"
                data-map-id="${this.escapeHtml(P.mapId)}"
                data-enabled="${P.enabled?"true":"false"}"
                style="--job-progress:${E}%;"
  ...
  `},i.renderRoomCard=function(e,t){let r=this._normalizeRoomDisplayData(e),a=r.cleanMode?r.cleanModeLabel||this._formatCleanMode(r.cleanMode):null,c=!r.fanSpeed||["off","normal"].includes(String(r.fanSpeed).toLowerCase())?null:r.fanSpeedLabel||this._formatFanSpeed(r.fanSpeed),o=!r.cleanIntensity||String(r.cleanIntensity).toLowerCase()==="standard"?null:r.cleanIntensityLabel||this._formatCleanIntensity(r.cleanIntensity),l=this._isMopMode(r.cleanMode)&&r.waterLevel&&String(r.waterLevel).toLowerCase()!=="off"?r.waterLevelLabel||this._formatWaterLevel(r.waterLevel):null,d=this._isMopMode(r.cleanMode)&&r.edgeMopping?"Edge Mop On":null,u=Number(r.cleanPasses)>1?`${Number(r.cleanPasses)}\xD7 passes`:null,m=this.card?._state?.orderDragItemId?.(),v=this.card?._state?.orderDragOverItemId?.(),p=String(m)===String(r.id)?"evcc-order-drag-source":"",f=String(v)===String(r.id)?"evcc-order-drag-target":"",h=t?.roomEstimateForRoom?.(r.id)??null,b=t?.dashboardPlannedWaterRoomForRoom?.(r.id,r.slug)??null,R="";if(h&&h.error==null){let L=h.source==="learned"?"evcc-room-status--estimate-learned":"evcc-room-status--estimate-default",U=h.source==="learned"?this._formatLearningMinutes(h.minutes):`~${this._formatLearningMinutes(h.minutes)}`,F=[`Estimate: ${this._formatLearningMinutes(h.minutes)}`];h.source&&F.push(`Source: ${String(h.source)}`);let Z=Number(h.battery);Number.isFinite(Z)&&F.push(`Battery: ${Z}`);let oe=F.join(" \xB7 ");R=`
    ...
    `}let S="",g="",x="";if(h&&h.error==null&&typeof this.renderConfidenceChip=="function")if(h.source==="learned"){let L=h?.confidence_breakpoint?.ui_variant,U=L==="success"?"Reliable":L==="warning"?"Learning":L==="error"?"Uncertain":null;U&&(S=this.renderConfidenceChip(h.confidence_breakpoint,U,U),L==="success"?g="evcc-room-card--confidence-high":L==="warning"?g="evcc-room-card--confidence-medium":g="evcc-room-card--confidence-low")}else h.source==="default"&&(S=this.renderConfidenceChip({ui_variant:"neutral"},"Unlearned","Unlearned"));let w=String(b?.effective_clean_mode??b?.clean_mode??"").toLowerCase(),I=String(b?.effective_water_level??b?.water_level??"").toLowerCase();if(!!(b?.mop_active||this._isMopMode(w))&&I!=="off"){let L=Number(b.estimated_robot_water_used_ml);Number.isFinite(L)&&(x=`
      ...
      `)}let W=[];h?.intensity_mismatch&&W.push({text:"\u26A0 intensity mismatch",variant:"warning"});let Y=t?.troubleRoomForRoom?.(r.id)??null;if(Y?.is_trouble){let L=Number(Y.miss_count??0),U=Number(Y.run_count??0),F=Number(Y.miss_rate??0),Z=Number.isFinite(F)?Math.round(F*100):null;W.push({text:`\u26A0 Missed ${L}\xD7 of ${U} run${U===1?"":"s"}${Z!==null?` (${Z}%)`:""}`,variant:"warning",title:`This room was missed in ${Z??"?"}% of recent runs. Consider checking for obstacles or map accuracy.`})}let fe=!!this.card?._state?.hasActiveRun?.(),V=this.card?._learningController?.getRoomProgressSnapshot?.(r.id)??null,ve=V?.percent??this.card?._learningController?.getRoomProgressPercent?.(r.id),re=Number.isFinite(ve)?ve:0,le="evcc-room-card--queue-idle";r.enabled&&fe&&(V?.isCompleted||re>=100?le="evcc-room-card--queue-completed":V?.isCurrent||re>0?le="evcc-room-card--queue-current":le="evcc-room-card--queue-remaining");let P=fe&&V&&V.isCurrent?`
      ...
      `:"";return`
    <div
      class="evcc-room-card ${r.enabled?"is-enabled":"is-disabled"} ${p} ${f} ${le} ${g}"
        ...
        <div class="evcc-room-notes">
          ${W.map(L=>`
            <div
              ...
              ${(()=>{let U=String(L.text).includes("No learned data")?"This room is using a fallback estimate until enough learned samples are collected.":String(L.text).includes("runs to reliable")?`Estimated ${String(L.text).split(" ")[0]} more runs to reach high confidence.`:String(L.text).includes("intensity mismatch")?"Estimate was learned from a different cleaning intensity or profile.":"",F=L.title||U;return F?`title="${this.escapeHtml(F)}"`:""})()}
            >
  ...
  `},i._normalizeRoomDisplayData=function(e){let t=e?.selected_profile_details??{},r=String(e?.profile_name??e?.profileName??e?.profile??"vacuum_quick"),a=String(e?.clean_mode??e?.cleanMode??t?.clean_mode??"vacuum"),n=String(e?.fan_speed??e?.fanSpeed??t?.fan_speed??""),c=String(e?.water_level??e?.waterLevel??t?.water_level??""),s=String(e?.clean_intensity??e?.cleanIntensity??t?.clean_intensity??""),o=Number(e?.clean_passes??e?.cleanPasses??e?.passes??t?.default_clean_passes??1),l=!!(e?.edge_mopping??e?.edgeMopping??t?.default_edge_mopping??!1),d=String(e?.floor_type??e?.floorType??""),u=String(e?.carpet_type??e?.carpetType??""),m=!!(e?.carpet??(()=>{let p=String(d).toLowerCase();return p==="carpet"||p.startsWith("carpet_")||p.startsWith("carpet-")})()),v=Number(e?.order??e?.displayOrder??e?.position??999999);return{id:e?.id,mapId:e?.mapId??e?.map_id??"",name:e?.name??e?.room_name??"",slug:e?.slug??e?.room_slug??null,enabled:!!e?.enabled,order:Number.isFinite(v)?v:999999,profileName:r,profileLabel:e?.profile_label??e?.profileLabel??e?.selected_profile_label??e?.resolved_profile_label??null,profileSubtitle:e?.profile_subtitle??e?.profileSubtitle??null,isCustomProfile:r.toLowerCase()==="custom",cleanMode:a,cleanModeLabel:e?.clean_mode_label??e?.cleanModeLabel??t?.clean_mode_label??null,fanSpeed:n,fanSpeedLabel:e?.fan_speed_label??e?.fanSpeedLabel??t?.fan_speed_label??null,waterLevel:c,waterLevelLabel:e?.water_level_label??e?.waterLevelLabel??t?.water_level_label??null,cleanIntensity:s,cleanIntensityLabel:e?.clean_intensity_label??e?.cleanIntensityLabel??t?.clean_intensity_label??t?.path_type_label??null,cleanPasses:Number.isFinite(o)?o:1,cleanPassesLabel:e?.clean_passes_label??e?.cleanPassesLabel??t?.clean_passes_label??null,edgeMopping:l,edgeMoppingLabel:e?.edge_mopping_label??e?.edgeMoppingLabel??t?.edge_mopping_label??null,floorType:d,floorTypeLabel:e?.floor_type_label??e?.floorTypeLabel??null,carpetType:u,carpetTypeLabel:e?.carpet_type_label??e?.carpetTypeLabel??null,carpet:m,selectedProfileDetails:t}},i._isMopMode=function(e){let t=String(e??"").toLowerCase();return t==="mop"||t==="vacuum_mop"||t.includes("mop")||t.includes("wash")},i._roomProfileLabel=function(e){let t=String(e??"").trim();return t?t.toLowerCase()==="custom"?"Custom":t==="vacuum_quick"?"Vacuum Only Quick":t==="vacuum_deep"?"Vacuum Only Deep":t==="vacuum_mop_quick"?"Quick":t==="vacuum_mop_deep"?"Deep":t==="user_1"?"User Profile 1":t.replace(/[_-]+/g," ").replace(/\b\w/g,r=>r.toUpperCase()):"Standard"},i._formatCleanMode=function(e){let t=String(e??"").trim().toLowerCase();return t==="vacuum_mop"||t==="vacuum and mop"?"Vacuum + Mop":t==="vacuum"?"Vacuum":t==="mop"?"Mop":this._formatSettingValue(e)},i._formatFanSpeed=function(e){return this._formatSettingValue(e)},i._formatWaterLevel=function(e){return this._formatSettingValue(e)},i._formatCleanIntensity=function(e){return this._formatSettingValue(e)},i._formatFloorType=function(e){return this._formatSettingValue(e)},i._formatSettingValue=function(e){return e?String(e).replace(/[_-]+/g," ").replace(/\b\w/g,t=>t.toUpperCase()):""}}function Br(i){i.renderRunProfilesPanel=function(e){let t=e.savedRunProfiles?.()??[],r=e.selectedRunProfile?.()??null,a=e.runProfileDraft?.()??{name:"",expose_as_button:!1},n=!!e.isRunProfileEditorOpen?.(),c=e.runProfileEditorMode?.()??"new";return`
    ...
    `},i._renderMaintenanceCard=function(e){let t=e?.label??e?.component_label??e?.name??e?.title??"Unnamed item",r=String(e?.kind??"maintenance"),a=String(e?.status??"unknown"),n=e?.status_label??this._formatMaintenanceStatus(a),c=e?.available!==!1,s=this._maintenanceRemainingPercent(e),o=Number.isFinite(s)?Math.max(0,Math.min(100,s)):0,l=this._maintenancePrimaryValue(e),d=this._maintenanceSecondaryValue(e),u=e?.guide?.display??null,m=u?.frequency||this._formatMaintenanceFrequency(u?.frequency);return`
      <button
        type="button"
      ...
      <div class="evcc-modal-backdrop" data-action="close-maintenance-modal">
        <div class="evcc-modal evcc-maintenance-modal" data-stop-propagation>
          ...
          <div class="evcc-modal-body">
            ...
            ${n==="maintenance"?(()=>{let g=Number(r?.interval_hours),x=Number(r?.default_interval_hours),w=Number(r?.max_interval_hours),I=r?.reset_service_data?.vacuum_entity_id??"",O=r?.component??"",W=Number.isFinite(g)&&g>0?g:Number.isFinite(x)?x:"",Y=[];return Number.isFinite(x)&&x>0&&Y.push(`Default ${x}h`),Number.isFinite(w)&&w>0&&Y.push(`Max ${w}h`),`
                <div class="evcc-editor-field-group">
                  ...
                  ${Y.length?`
                    <div class="evcc-maintenance-interval-hint">${this.escapeHtml(Y.join(" \xB7 "))}</div>
                  `:""}
                </div>
              `})():""}
    ...
    `}}function qr(i){i.renderRoomEditorModal=function(e){let{state:t}=e;if(!t.isRoomEditorOpen())return"";let r=t.activeEditorRoom(),a=t.editorFields();if(!r||!a)return"";let n=t.isEditorRoomCarpet();return`
    ...
    `}}var ji=new Set(["is_on","is_off","exists","missing"]);function Gr(i){i.renderRoomRulesView=function(e){let{state:t}=e,r=t.getRoomsForActiveMap?.()??[];if(!r.length)return`
    ...
    `},i._renderRuleEditor=function(e,t,r,a,n){let c=a==="new",s=r.kind==="modifier",o=e.ruleEntityDescriptor?.(r)??null,l=e.ruleOperatorGroups?.(r)??[],d=e.ruleEntitySearchResults?.(r.entity_id,10)??[],u=ji.has(r.operator??""),m=e.roomRulesDraftIsValid?.()??!1;return`
    ...
    `}}function Ur(i){i.renderOrderSelectorModal=function(e){let{state:t}=e;if(!t.isOrderSelectorOpen())return"";let r=t.orderSelectorScope(),a=t.orderSelectorItem(),n=t.orderSelectorTargetPosition(),c=t.orderSelectorPositions(),s=t.getOrderAdapter(r);if(!a||!s)return"";let o=s.getLabel(a);return`
    ...
    `}}function Wr(i){if(!i)return null;let e=String(i).trim();if(!/^color-mix\(/i.test(e))return null;let t=e.indexOf("("),r=e.lastIndexOf(")");if(t===-1||r===-1)return null;let c=e.slice(t+1,r).replace(/^\s*in\s+\w+\s*,\s*/i,"").match(/^(.*?\s+\d+(?:\.\d+)?%)\s*,\s*(.*?\s+\d+(?:\.\d+)?%)\s*$/);if(!c)return null;let s=/^(.*?)\s+(\d+(?:\.\d+)?)%$/,o=c[1].trim().match(s),l=c[2].trim().match(s);return!o||!l?null:{color1:o[1].trim(),ratio:parseFloat(o[2]),color2:l[1].trim(),ratio2:parseFloat(l[2])}}function Vi(i,e,t){let r=Math.max(0,Math.min(100,Math.round(e)));return`color-mix(in srgb, ${i} ${r}%, ${t} ${100-r}%)`}var De=new Set(["--evcc-accent","--evcc-surface-base","--evcc-text-primary","--evcc-radius-card"]),qi={"Shared Foundations":{min:0,max:64,step:2},"Cards & Surfaces":{min:0,max:32,step:1},"Borders & Shadows":{min:0,max:32,step:1},Chips:{min:20,max:48,step:1},"Room Cards":{min:0,max:32,step:1},"Floor Textures":{min:0,max:1,step:.01},"Floor Textures \u2014 Tile":{min:0,max:1,step:.01},"Floor Textures \u2014 Wood":{min:0,max:1,step:.01},"Floor Textures \u2014 Marble":{min:0,max:1,step:.01},"Floor Textures \u2014 Concrete":{min:0,max:1,step:.01},"Floor Textures \u2014 Carpet Low":{min:0,max:1,step:.01},"Floor Textures \u2014 Carpet High":{min:0,max:1,step:.01},"Floor Textures \u2014 Granite":{min:0,max:1,step:.01},"Queue & Ordering":{min:0,max:32,step:1},"Status, Confidence & Alerts":{min:0,max:32,step:1},"Learning & Metrics":{min:0,max:32,step:1},"Modals & Overlays":{min:0,max:32,step:1}};function Gi(i){let e=parseFloat(String(i||"").trim());return Number.isNaN(e)?null:e}function Jr(i,e){let t=String(e||"").trim();if(!t)return{numeric:null,unit:Be(i)};if(i.type==="number")return{numeric:Gi(t),unit:""};if(i.type==="size"){let r=t.match(/^(-?\d*\.?\d+)\s*(px|rem|em|%|vh|vw|vmin|vmax|ch|ex)$/i);return r?{numeric:Number(r[1]),unit:r[2].toLowerCase()}:{numeric:null,unit:Be(i)}}if(i.type==="duration"){let r=t.match(/^(-?\d*\.?\d+)\s*(ms|s)$/i);return r?{numeric:Number(r[1]),unit:r[2].toLowerCase()}:{numeric:null,unit:Be(i)}}return{numeric:null,unit:""}}function Be(i){return i.type==="size"?"px":i.type==="duration"?"ms":""}function Ui(i){return i.type==="size"||i.type==="number"||i.type==="duration"}function Wi(i,e){return Ui(i)?e==null||e===""?!0:Jr(i,e).numeric!==null:!1}function Ji(i){let e=Number(i);return Number.isNaN(e)?100:Math.max(0,Math.min(100,e))}function Ki(i){let e=String(i||"").trim();if(/^#[0-9a-fA-F]{8}$/.test(e)){let t=e.slice(7,9),r=parseInt(t,16)/255;return Ji(Math.round(r*100))}return 100}function Kr(i){i.renderThemeView=function(){let e=this.card._state._ensureThemeState(),{tokens:t,sources:r}=this.card._state.resolvedTheme(),a=e.activeSubTab||"presets";return`
    ...
    `},i._renderThemeGroupFilters=function(){let e=this.card._state.getThemeGroupFilter();return`
      <div class="evcc-chips evcc-theme-filters">
        ${[{value:"all",label:"All"},{value:"modified",label:"Modified"},...te.map(r=>({value:r,label:r}))].map(r=>`
          <button
    ...
    `},i._renderThemeTokenEditor=function(e,t){let r=this.card._state.getThemeGroupFilter(),a={},n=new Set;for(let o of te){let l=o.indexOf(" \u2014 ");if(l===-1)continue;let d=o.slice(0,l);te.includes(d)&&((a[d]=a[d]??[]).push(o),n.add(o))}let c=(o,l=!1)=>{let d=this.card._state.filteredThemeTokensForGroup(o,de,{excludeKeys:De}),u=this.card._state.getThemeGroupSearchQuery(o),m=String(u||"").trim().length>0,v=r===o||m,f=(a[o]??[]).map(g=>c(g,!0)).filter(Boolean).join("");if(!d.length&&!v&&!f)return"";let h=this.card._state.themeGroupCounts(o,de,{excludeKeys:De}),R=this.card._state.shouldForceThemeGroupOpenForSearch(o,de,{excludeKeys:De})||this.card._state.isThemeGroupOpen(o),S=l?o.slice(o.lastIndexOf(" \u2014 ")+3):o;return`
      ...
      `},s=te.filter(o=>!n.has(o)).map(o=>c(o)).filter(Boolean);return`
      <div class="evcc-theme-editor-pane">
        ${this._renderThemePreviewPane()}
    ...
    `},i._renderThemeTokenRow=function(e,t,r){let a=r==="draft",n=t||"";return e.type==="color"?Wr(n)?this._renderThemeColorMixTokenRow(e,n,a):this._renderThemeColorTokenRow(e,n,a):Wi(e,n)?this._renderThemeNumericTokenRow(e,n,a):this._renderThemeTextTokenRow(e,n,a)},i._renderThemeColorTokenRow=function(e,t,r){let a=String(t||"").trim(),n=this._safeColorInputValue(a),c=Ki(a),s=/^#[0-9a-fA-F]{8}$/.test(a)?`#${a.slice(1,7)}`:a;return`
    ...
    `},i._renderThemeColorMixTokenRow=function(e,t,r){let a=Wr(t);if(!a)return this._renderThemeColorTokenRow(e,t,r);let{color1:n,ratio:c,color2:s}=a,o=this.escapeHtml(Vi(n,c,s));return`
    ...
    `},i._renderThemeNumericTokenRow=function(e,t,r){let a=qi[e.group]||{min:0,max:64,step:1},n=Jr(e,t),c=n.numeric??a.min,s=n.unit||Be(e),o=e.type==="number"?"":s,l=Math.min(a.min,c),d=Math.max(a.max,c);return`
      <div
    ...
    `}}function en(i){switch(i){case"cleaning":return"alert";case"returning":return"walking";case"paused":return"standing";case"error":return"warning";case"docked":case"idle":return"curled";default:return"curled"}}function Xr(i){let e=0,t=0,r=0,a=i.length;for(let n=0,c=a-1;n<a;c=n++){let s=i[c][0]*i[n][1]-i[n][0]*i[c][1];e+=s,t+=(i[c][0]+i[n][0])*s,r+=(i[c][1]+i[n][1])*s}if(e*=.5,Math.abs(e)<1e-10){let n=i.reduce((s,o)=>s+o[0],0),c=i.reduce((s,o)=>s+o[1],0);return[n/a,c/a]}return[t/(6*e),r/(6*e)]}var ze=["#00e5ff","#ff6b35","#a3e635","#e879f9","#fbbf24","#a78bfa","#fb7185","#34d399","#60a5fa","#f472b6","#4ade80","#f97316"],tn=[{key:"dark",label:"Dark",hint:"primary \u2014 clearest room colours"},{key:"light",label:"Light",hint:"assist \u2014 wall detection"},{key:"default",label:"Default",hint:"fallback"}];function Zr(i){i.renderMapRoomView=function(e){let{state:t,vacuumStatus:r}=e,a=t.mapSegmentsData(),n=t.mapImageUrl();if(!a?.available||!n)return`
        ...
        <div class="evcc-map-container">
          ...
          <div class="evcc-map-layers" style="transform:translate(${m}px,${v}px) scale(${u});transform-origin:0 0">
            ...
            >
              ...
              ${c.map((p,f)=>{let h=t.roomIdForSegment(p.segment_id),b=h!=null?l.find(g=>String(g.id)===String(h)):null,R=b?.name??p.name??p.label??`Segment ${p.segment_id}`,S=b?"Tap to queue \xB7 Double-tap to configure":"Tap to queue";return this._renderMapSegmentPolygon(p,s,f,R,S)}).join("")}
            ...
            ${c.map(p=>{let f=p.polygon_pct;if(!Array.isArray(f)||f.length<3)return"";let[h,b]=Xr(f),R=Math.min(Math.max(h,5),95),S=Math.min(Math.max(b,6),94),g=t.roomIdForSegment(p.segment_id),w=(g!=null?l.find(W=>String(W.id)===String(g)):null)?.name??p.name??p.label??null;if(!w)return"";let I=o.findIndex(W=>String(W.segment_id)===String(p.segment_id)),O=I>=0;return`<div class="evcc-map-label${O?" evcc-map-label--selected":""}" style="left:${R}%;top:${S}%">
    ...
    />`,u="";return c&&(u=n.map(([m,v],p)=>{let f=a===p;return`<circle
          ...
          data-segment-id="${l}"
          data-vertex-index="${p}"
        />`}).join("")),`<g>${d}${u}</g>`},i._renderVariantsSection=function(e,t,r){let a=tn.map(({key:l,label:d,hint:u})=>{let m=e[l],v=r?.type==="upload"&&r?.variant===l&&r?.status==="busy",p=r?.type==="analyze"&&r?.variant===l&&r?.status==="busy",f=v||p,h=r?.type==="upload"&&r?.variant===l&&r?.status==="error",b=m?`${m.width} \xD7 ${m.height}`:"not uploaded",R=m?"evcc-map-variant-status--ok":"evcc-map-variant-status--missing",S=v?"Uploading\u2026":p?"Analyzing\u2026 (10-30s)":"Upload";return`
        <div class="evcc-map-variant-row">
          ...
          <span class="evcc-map-variant-status ${R}">${b}</span>
          ${h?`<span class="evcc-map-action-status evcc-map-action-status--error">
                 ${this.escapeHtml(r.message??"Upload failed")}
               </span>`:""}
          <button
            class="evcc-map-config-btn${f?" evcc-map-config-btn--busy":""}"
    ...
    `}}var N="/eufy_vacuum/textures",je={tile:{opacityDefault:1,layers:[{url:`${N}/tile/tile-mask.png`,role:"base",colorToken:"--evcc-floor-tile-base",colorDefault:"#D4AF37",opacityToken:"--evcc-floor-tile-face-opacity",opacityDefault:.87},{url:`${N}/tile/grout-mask.png`,role:"grout",colorToken:"--evcc-floor-tile-grout",colorDefault:"#121212",opacityToken:"--evcc-floor-tile-grout-opacity",opacityDefault:.95},{url:`${N}/tile/pure-tile-grout.png`,role:"accent",colorToken:"--evcc-floor-tile-accent",colorDefault:"#f0f0f5",opacityToken:"--evcc-floor-tile-line-opacity",opacityDefault:.39}],masks:[{url:`${N}/tile/tile-mask.png`},{url:`${N}/tile/grout-mask.png`},{url:`${N}/tile/pure-tile-grout.png`}],baseTexture:null},wood:{opacityDefault:.99,layers:[{url:`${N}/wood/wood-directional-depth-mask.png`,role:"base",colorToken:"--evcc-floor-wood-base",colorDefault:"#7A4010cf",opacityToken:"--evcc-floor-wood-depth-opacity",opacityDefault:.43},{url:`${N}/wood/wood-grain-mask.png`,role:"base",colorToken:"--evcc-floor-wood-base",colorDefault:"#7A4010cf",opacityToken:"--evcc-floor-wood-grain-opacity",opacityDefault:.84},{url:`${N}/wood/wood-seam-mask.png`,role:"accent",colorToken:"--evcc-floor-wood-accent",colorDefault:"#e89754",opacityToken:"--evcc-floor-wood-seam-opacity",opacityDefault:.78}],masks:[{url:`${N}/wood/wood-grain-mask.png`},{url:`${N}/wood/wood-seam-mask.png`},{url:`${N}/wood/wood-directional-depth-mask.png`}],baseTexture:null},marble:{opacityDefault:.9,layers:[{url:`${N}/marble/marble-base-mask.png`,role:"base",colorToken:"--evcc-floor-marble-base",colorDefault:"#e9e8e8",opacityToken:"--evcc-floor-marble-base-opacity",opacityDefault:.97},{url:`${N}/marble/marble-micro-texture-mask.png`,role:"micro",colorToken:"--evcc-floor-marble-micro",colorDefault:"#080707",opacityToken:"--evcc-floor-marble-micro-opacity",opacityDefault:1},{url:`${N}/marble/marble-vein-mask.png`,role:"accent",colorToken:"--evcc-floor-marble-accent",colorDefault:"#D4AF3773",opacityToken:"--evcc-floor-marble-vein-opacity",opacityDefault:0}],masks:[{url:`${N}/marble/marble-vein-mask.png`},{url:`${N}/marble/marble-micro-texture-mask.png`},{url:`${N}/marble/marble-base-mask.png`}],baseTexture:null},concrete:{opacityDefault:1,layers:[{url:`${N}/concrete/concrete-broad-mask.png`,role:"base",colorToken:"--evcc-floor-concrete-base",colorDefault:"#eceaea",opacityToken:"--evcc-floor-concrete-broad-opacity",opacityDefault:1},{url:`${N}/concrete/concrete-micro-mask.png`,role:"accent",colorToken:"--evcc-floor-concrete-accent",colorDefault:"#121111",opacityToken:"--evcc-floor-concrete-micro-opacity",opacityDefault:.62}],masks:[{url:`${N}/concrete/concrete-micro-mask.png`},{url:`${N}/concrete/concrete-broad-mask.png`}],baseTexture:null},carpet_low:{opacityDefault:.8,layers:[{url:`${N}/carpet/texture-floor-carpet-low.png`,role:"base",colorToken:"--evcc-floor-carpet-low-base",colorDefault:"#0d0c0c",opacityToken:"--evcc-floor-carpet-low-texture-opacity",opacityDefault:1}],masks:[],baseTexture:`${N}/carpet/texture-floor-carpet-low.png`},carpet_high:{opacityDefault:1,layers:[{url:`${N}/carpet/texture-floor-carpet-high.png`,role:"base",colorToken:"--evcc-floor-carpet-high-base",colorDefault:"#0a0a0a",opacityToken:"--evcc-floor-carpet-high-texture-opacity",opacityDefault:1}],masks:[],baseTexture:`${N}/carpet/texture-floor-carpet-high.png`},granite_light:{opacityDefault:1,layers:[{url:`${N}/granite/texture-floor-granite-light.png`,role:"base",colorToken:"--evcc-floor-granite-light-base",colorDefault:"#0a0a0a",opacityToken:"--evcc-floor-granite-light-texture-opacity",opacityDefault:1}],masks:[],baseTexture:`${N}/granite/texture-floor-granite-light.png`},default:{opacityDefault:.85,layers:[],masks:[],baseTexture:null}};function Xe(i){let e=je[i];return e?e.baseTexture?e.baseTexture:e.layers.length?e.layers[0].url:e.masks.length?e.masks[0].url:null:null}function Ze(i){let e=String(i?.floor_type??"").toLowerCase().trim(),t=String(i?.carpet_type??"").toLowerCase().trim();return e==="carpet"?t==="high_pile"||t==="high"?"carpet_high":"carpet_low":e==="carpet_low_pile"||e==="carpet_low"?"carpet_low":e==="carpet_high_pile"||e==="carpet_high"?"carpet_high":e==="hardwood"||e==="laminate"||e==="wood"?"wood":e==="tile"?"tile":e==="marble"?"marble":e==="concrete"?"concrete":e==="granite"||e==="granite_light"?"granite_light":"default"}function rn(i){let e=String(i??""),t=2166136261;for(let n=0;n<e.length;n++)t^=e.charCodeAt(n),t=Math.imul(t,16777619)>>>0;let r=t%101,a=(t>>>13^t>>>7)%101;return`${r}% ${a}%`}function ea(i){i._resolveSegmentFloorType=function(e){return Ze({floor_type:e?.floor_type??e?.floorType??"",carpet_type:e?.carpet_type??e?.carpetType??""})},i._renderFloorTextureLayer=function(e){let t=Ze({floor_type:e?.floorType??"",carpet_type:e?.carpetType??""}),r=je[t]??je.default,a=r.opacityDefault??.85,n=`var(--evcc-floor-${t}-opacity-card,var(--evcc-floor-texture-opacity-card,${a}))`,c=rn(e?.id??e?.name??t),s=r.layers.map(o=>{let l=`var(${o.colorToken},${o.colorDefault})`,d=`url(${o.url})`,u=`var(${o.opacityToken},${o.opacityDefault})`;return`<span class="evcc-ftx-layer" data-role="${o.role}" style="background-color:${l};mask-image:${d};-webkit-mask-image:${d};--layer-opacity:${u}"></span>`}).join("");return`<div class="evcc-room-texture-layer" data-floor="${t}" style="--floor-opacity-card:${n};--floor-position-card:${c}">${s}</div>`},i._buildFloorTextureDefs=function(e){let t=new Set,r=[];for(let a of e){if(t.has(a))continue;t.add(a);let n=Xe(a);n&&r.push(`<pattern id="evcc-ftx-${a}" patternUnits="userSpaceOnUse" width="8" height="8"><image href="${n}" width="8" height="8" preserveAspectRatio="xMidYMid slice"/></pattern>`)}return r.length?`<defs>${r.join("")}</defs>`:""},i._renderFloorTexturePolygon=function(e,t){let r=e.polygon_pct;return!Array.isArray(r)||r.length<3||!Xe(t)?"":`<polygon class="evcc-map-texture-polygon" points="${r.map(([n,c])=>`${n},${c}`).join(" ")}" fill="url(#evcc-ftx-${t})" data-floor="${t}"/>`}}var an=[{value:"hardwood",label:"Hardwood"},{value:"laminate",label:"Laminate"},{value:"tile",label:"Tile"},{value:"marble",label:"Marble"},{value:"granite",label:"Granite"},{value:"concrete",label:"Concrete"},{value:"carpet_low_pile",label:"Low-Pile Carpet"},{value:"carpet_high_pile",label:"High-Pile Carpet"}];function ra(i){i.renderSetupView=function(e){let{state:t,card:r}=e,a=r._config?.vacuum_entity_id??"",n=t.setupStatus?.()??null,c=t.setupLoading?.()??!1,s=t.setupError?.()??null,o=t.setupLastResult?.()??null,d=(Array.isArray(n?.vacuums)?n.vacuums:[]).find(E=>E.vacuum_entity_id===a)??null,u=Array.isArray(d?.setup_steps)&&d.setup_steps.length?d.setup_steps:nn(d),m=d?.room_drift??null,v=t.setupRoomEditorOpenMapId?.()??null,p=t.setupRoomEditorLoadingMapId?.()??null,f=t.setupRoomEditorRooms?.()??[],h=t.setupRoomEditorSaving?.()??!1,b=t.setupDeletePendingMapId?.()??null,R=t.setupDeleteStage?.()??null,S=t.setupDeleteTypedToken?.()??"",g=t.setupDeleteDeleting?.()??!1,x=new Set((t.setupRoomEditorEnabledIds?.()??[]).map(String)),w=t.setupRoomEditorFloorTypesMap?.()??{},I=(d?.maps??[]).filter(E=>E.imported),O=c?'<div class="evcc-setup-result info">Working\u2026</div>':"",W=s&&!c?`<div class="evcc-setup-result error">${this.escapeHtml(String(s))}</div>`:"",Y=(()=>{if(!o||c)return"";let E=o.status??"",D=o.message??"";return E==="error"||E==="blocked"?`<div class="evcc-setup-result error">${this.escapeHtml(D)}</div>`:D?`<div class="evcc-setup-result success">${this.escapeHtml(D)}</div>`:""})(),re={add_vacuum:E=>E.completed?`
      ...
      `,import_active_map:E=>{let D=ta(u,"add_vacuum"),M=I.length;if(!D)return'<div class="evcc-setup-step-body muted">Complete Add Vacuum first.</div>';let q=M>0?`<div class="evcc-setup-step-body muted">${M} map${M===1?"":"s"} imported.</div>`:`<div class="evcc-setup-step-body">Import the vacuum's currently active map. Make sure it has completed a mapping run first.</div>`,J=M>0?"Import Another Map":"Import Active Map",Q=M>0?"secondary":"";return`
        ${q}
        <button class="evcc-setup-btn ${Q}"
                data-action="setup-import-map"
                ${c?"disabled":""}>
          ${J}
        </button>
      `},save_rooms:E=>{let D=u.find(H=>H.id==="import_active_map"),M=!!D,q=!D||D.completed;if(!ta(u,"add_vacuum"))return'<div class="evcc-setup-step-body muted">Complete Add Vacuum first.</div>';if(M&&!q)return'<div class="evcc-setup-step-body muted">Complete map import first.</div>';if(I.length===0&&!M)return`
          <div class="evcc-setup-step-body">
            No rooms discovered yet. Run a clean cycle so the vacuum reports
            its room list, then refresh setup status.
          </div>
        `;let Q=le(m,d),me=I.map(H=>U(H,!0)).join("");return`
      ...
      `}},le=(E,D)=>{if(!E||E.in_sync)return"";let M=Array.isArray(E.new_rooms)?E.new_rooms:[],q=Array.isArray(E.removed_rooms)?E.removed_rooms:[],J=Array.isArray(E.transiently_missing)?E.transiently_missing:[];if(M.length===0&&q.length===0&&J.length===0)return"";let Q=M.length===0?"":`
          ...
          <div class="evcc-setup-drift-list">
            ${M.map(H=>`
              <div class="evcc-setup-drift-row">
                <span class="evcc-setup-drift-room-name">${this.escapeHtml(H.name??`Room ${H.room_id}`)}</span>
                <span class="evcc-setup-drift-room-map muted">map ${this.escapeHtml(String(H.map_id??""))}</span>
                <button class="evcc-setup-btn secondary small"
                        data-action="setup-reject-room"
                        data-room-id="${H.room_id}"
                        ${c?"disabled":""}>
                  Reject as phantom
                </button>
              </div>
      ...
      `,me=q.length===0?"":`
        <div class="evcc-setup-drift-section removed">
          <div class="evcc-setup-drift-title">
            Rooms no longer reported (${q.length})
          </div>
          <div class="evcc-setup-drift-hint">
      ...
      `},P=E=>p===E?`<div class="evcc-setup-room-editor">
        ...
        <div class="evcc-setup-room-editor">
          ...
          <div class="evcc-setup-room-list">
            ${f.length===0?'<div class="evcc-setup-step-body muted">No rooms found for this map.</div>':f.map(M=>{let q=String(M.room_id),J=this.escapeHtml(M.name??`Room ${q}`),Q=x.has(q),me=w[q]??"hardwood",ge=an.map(H=>`
              <button class="evcc-setup-floor-chip ${me===H.value?"active":""}"
                      data-action="setup-set-floor-type"
                      data-room-id="${q}"
                      data-floor-type="${H.value}"
                      ${h?"disabled":""}>
                ${H.label}
              </button>
            `).join("");return`
              <div class="evcc-setup-room-row ${Q?"":"excluded"}">
                <div class="evcc-setup-room-row-top">
                  <button class="evcc-setup-room-toggle ${Q?"on":"off"}"
                          data-action="setup-toggle-room"
                          data-room-id="${q}"
                          title="${Q?"Click to exclude":"Click to include"}"
                          ${h?"disabled":""}>
                    ${Q?"\u2713":"\u2715"}
                  </button>
                  <span class="evcc-setup-room-name">${J}</span>
                </div>
                ${Q?`<div class="evcc-setup-floor-chips">${ge}</div>`:""}
              </div>
            `}).join("")}
          </div>
          <button class="evcc-setup-btn"
      ...
      `,L=(E,D)=>{if(b!==E)return"";let M=this.escapeHtml(D?.typed_confirmation_value??`Map ${E}`),q=D?.requires_typed_confirmation??!1,J=D?.reasons??[],Q=J.length?`<div class="evcc-setup-delete-badges">
             ${J.map(H=>`<span class="evcc-setup-protection-badge">${this.escapeHtml(H.message)}</span>`).join("")}
           </div>`:"",me=q?`<div class="evcc-setup-delete-typed">
             ...
             <input class="evcc-setup-delete-input"
                    ...
                    autocomplete="off"
                    spellcheck="false" />
           </div>`:"",ge=q?S.trim()===(D?.typed_confirmation_value??"").trim():!0;return`
      ...
      `},U=(E,D)=>{let M=String(E.map_id),q=this.escapeHtml(E.display_name??`Map ${M}`),J=t.isSetupMapConfigured?.(M),Q=v===M||p===M,me=E.protection??null,ge=me?.requires_typed_confirmation??!1,H=b===M,fi=J&&!Q?'<span class="evcc-setup-configured-badge">\u2713 Configured</span>':"",gi=D?`
        <button class="evcc-setup-btn ${J?"secondary":""} small"
                data-action="setup-configure-map"
                data-map-id="${M}"
                ${c||h||g?"disabled":""}>
          ${Q?"Close":J?"Reconfigure":"Configure Rooms"}
        </button>
      `:"",bi=H?"":`<button class="evcc-setup-btn destructive-ghost small"
                   data-action="setup-delete-map-open"
                   data-map-id="${M}"
                   data-requires-typed="${ge}"
                   ${c||h||g?"disabled":""}>
             Delete
           </button>`;return`
        <div class="evcc-setup-mapconfig-row">
          <div class="evcc-setup-mapconfig-header">
            <div class="evcc-setup-mapconfig-name">${q}</div>
      ...
      `},F=(E,D)=>{let M=re[E.id],q=M?M(E):`<div class="evcc-setup-step-body muted">No handler for step "${this.escapeHtml(E.id)}".</div>`,J=E.completed?"\u2713":String(D+1);return`
      ...
      `},Z=u.map(F).join(""),oe=!!n?.setup_complete,ae=m?m.in_sync!==!1:!0,pe=oe&&ae?`<div class="evcc-setup-result success">
    ...
    `}}function ta(i,e){return Array.isArray(i)?!!i.find(r=>r.id===e)?.completed:!1}function nn(i){if(!i)return[{id:"add_vacuum",label:"Add vacuum",completed:!1,service:""},{id:"import_active_map",label:"Import active map",completed:!1,service:""},{id:"save_rooms",label:"Configure rooms",completed:!1,service:""}];let e=!!i.has_imported_map;return[{id:"add_vacuum",label:"Add vacuum",completed:!0,service:""},{id:"import_active_map",label:"Import active map",completed:e,service:""},{id:"save_rooms",label:"Configure rooms",completed:e,service:""}]}function aa(i){i.renderMappingReviewView=function(e){let{state:t}=e,r=t.mappingBoundsSnapshot?.();if(!r)return'<div class="evcc-empty">Loading mapping bounds...</div>';if(r.available===!1)return`
    ...
    `},i.renderMobileBottomNav=function(e){let t=sa.some(r=>r.id===e);return`
      <nav class="evcc-mobile-nav" aria-label="Primary">
        ...
        <button
          ...
          aria-haspopup="menu"
        >
          <span class="evcc-mobile-nav-icon">${vn()}</span>
  ...
  </svg>`}function mn(){return`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
               stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
    <line x1="4" y1="20" x2="20" y2="20"/>
    <rect x="6"  y="11" width="3" height="9"/>
    <rect x="11" y="6"  width="3" height="14"/>
    <rect x="16" y="14" width="3" height="6"/>
  </svg>`}function vn(){return`<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    <circle cx="5"  cy="12" r="2"/>
    <circle cx="12" cy="12" r="2"/>
    <circle cx="19" cy="12" r="2"/>
  </svg>`}function la(i){i.renderIncompleteRunBanner=function(e){if(!e.hasIncompleteRunLog?.()||e.learningJobActive?.())return"";let t=e.incompleteRunLog(),r=e.incompleteRunMissedRooms(),a=r.length,n=String(t?.outcome_status??"cancelled").toLowerCase(),c={cancelled:"cancelled",failed:"failed",interrupted:"interrupted"}[n]??n,s=r.map(o=>`<span class="evcc-incomplete-run-room">${this.escapeHtml(o.name)}</span>`).join("");return`
...
`;var Va=`
  ...
  /* ===========================================================
     ...
     =========================================================== */
`;var qa=[Ra,Ea,ka,Ta,Ma,$a,Aa,Ia,tt,rt,Ca,Oa,Pa,La,Na,Fa,Ha,Da,Ba,za,ja,Va].join(`
