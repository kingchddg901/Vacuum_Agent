      ...
      <div class="evcc-modal-backdrop" data-action="close-theme-json">
        <div class="evcc-modal evcc-modal--theme-json" data-stop-propagation>
          ...
          <div class="evcc-modal-footer">
            ...
            ${r?'<button type="button" class="evcc-chip evcc-chip--save" data-action="copy-theme-json">Copy</button>':'<button type="button" class="evcc-chip evcc-chip--save" data-action="confirm-theme-import">Import</button>'}
          </div>
