/**
 * Cat — black cat. Quadruped layout shared with dog and raccoon.
 * All paths preserved verbatim from the React CatPaths.tsx.
 */
(function () {
  ...
  AnimalSVG.register('copy_cat', {
    ...
    parts: {
      body: `
        ...
        <path d="M175,200 C200,210 240,212 280,210 C310,208 335,202 340,195" stroke="${FUR_H}" stroke-width="2" fill="none" opacity="0.3"/>
      ...
      frontLeftLeg: `
        <g>
          ...
          <g class="cat-fl-lower" style="transform-origin: 170px 236px">
            <line x1="170" y1="236" x2="172" y2="275" stroke="${FUR}" stroke-width="11" stroke-linecap="round"/>
            <ellipse cx="172" cy="278" rx="10" ry="4.5" fill="${FUR}"/>
          </g>
      ...
      frontRightLeg: `
        <g>
          ...
          <g class="cat-fr-lower" style="transform-origin: 198px 236px">
            <line x1="198" y1="236" x2="200" y2="275" stroke="${FUR_S}" stroke-width="11" stroke-linecap="round"/>
            <ellipse cx="200" cy="278" rx="10" ry="4.5" fill="${FUR_S}"/>
          </g>
      ...
      backLeftLeg: `
        <g>
          ...
          <g class="cat-bl-lower" style="transform-origin: 303px 234px">
            <line x1="303" y1="234" x2="312" y2="275" stroke="${FUR}" stroke-width="11" stroke-linecap="round"/>
            <ellipse cx="312" cy="278" rx="10" ry="4.5" fill="${FUR}"/>
          </g>
      ...
      backRightLeg: `
        <g>
          ...
          <g class="cat-br-lower" style="transform-origin: 330px 232px">
            <line x1="330" y1="232" x2="339" y2="275" stroke="${FUR_S}" stroke-width="11" stroke-linecap="round"/>
            <ellipse cx="339" cy="278" rx="10" ry="4.5" fill="${FUR_S}"/>
          </g>
      ...
      tail: `
        ...
        <path d="M372,75 C368,70 364,72 363,78" stroke="${TIP}" stroke-width="8" fill="none" stroke-linecap="round"/>
      `,
      head: `
        ...
        <path d="M108,55 C107,47 109,43 112,43 C115,43 117,47 116,53 L108,55 Z" fill="${TIP}"/>
        ...
        <path d="M173,53 C172,47 174,43 177,43 C180,43 182,47 181,55 L173,53 Z" fill="${TIP}"/>
      ...
      eyes: `
        ...
        <ellipse cx="133" cy="117" rx="2" ry="5.5" fill="${PUP}"/>
        <circle cx="136" cy="115" r="1.8" fill="${TIP}" opacity="0.85"/>
        <circle cx="131" cy="119" r="0.7" fill="${TIP}" opacity="0.4"/>
        <path d="M148,117 C152,110 162,110 166,117 C162,124 152,124 148,117 Z" fill="${EYE}"/>
        <ellipse cx="157" cy="117" rx="2" ry="5.5" fill="${PUP}"/>
        <circle cx="160" cy="115" r="1.8" fill="${TIP}" opacity="0.85"/>
        <circle cx="155" cy="119" r="0.7" fill="${TIP}" opacity="0.4"/>
      `,
      face: `
        <path d="M144,131 L141,135 L147,135 Z" fill="${NOSE}"/>
        <path d="M144,135 C144,138 142,140 139,141" stroke="${WHISK}" stroke-width="0.7" fill="none"/>
        <path d="M144,135 C144,138 146,140 149,141" stroke="${WHISK}" stroke-width="0.7" fill="none"/>
        <line x1="117" y1="127" x2="84" y2="121" stroke="${WHISK}" stroke-width="0.7" opacity="0.6"/>
        <line x1="117" y1="131" x2="80" y2="131" stroke="${WHISK}" stroke-width="0.7" opacity="0.6"/>
        <line x1="117" y1="135" x2="84" y2="141" stroke="${WHISK}" stroke-width="0.7" opacity="0.6"/>
        <line x1="170" y1="127" x2="200" y2="121" stroke="${WHISK}" stroke-width="0.7" opacity="0.6"/>
        <line x1="170" y1="131" x2="204" y2="131" stroke="${WHISK}" stroke-width="0.7" opacity="0.6"/>
        <line x1="170" y1="135" x2="200" y2="141" stroke="${WHISK}" stroke-width="0.7" opacity="0.6"/>
      `,
      warning: `
        <g>
          ...
          <line x1="330" y1="147" x2="337" y2="131" stroke="${FUR}" stroke-width="2.5" stroke-linecap="round"/>

          <line x1="349" y1="162" x2="358" y2="153" stroke="${FUR}" stroke-width="2" stroke-linecap="round"/>
          <line x1="358" y1="150" x2="368" y2="141" stroke="${FUR}" stroke-width="2" stroke-linecap="round"/>
          <line x1="365" y1="136" x2="376" y2="128" stroke="${FUR}" stroke-width="2" stroke-linecap="round"/>
          <line x1="370" y1="120" x2="382" y2="113" stroke="${FUR}" stroke-width="2" stroke-linecap="round"/>
          <line x1="374" y1="104" x2="386" y2="99" stroke="${FUR}" stroke-width="2" stroke-linecap="round"/>
          <line x1="349" y1="162" x2="340" y2="152" stroke="${FUR}" stroke-width="2" stroke-linecap="round"/>
          <line x1="358" y1="150" x2="349" y2="140" stroke="${FUR}" stroke-width="2" stroke-linecap="round"/>
          <line x1="365" y1="136" x2="355" y2="127" stroke="${FUR}" stroke-width="2" stroke-linecap="round"/>
          <line x1="370" y1="120" x2="360" y2="112" stroke="${FUR}" stroke-width="2" stroke-linecap="round"/>
          ...
          <path d="M141,137 C141,140 143,142 145,141" stroke="${TIP}" stroke-width="1" fill="none" opacity="0.6"/>
          <path d="M147,141 C149,142 151,140 151,137" stroke="${TIP}" stroke-width="1" fill="none" opacity="0.6"/>
        </g>
      `,
    },
  });
