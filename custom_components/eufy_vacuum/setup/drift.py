...
#       A1-ID-4 (closed RP-019): Drift keys its history by bare device room_id across ALL maps but feeds it only the
#              ACTIVE map's discovery, so a multi-map vacuum's inactive rooms decay toward
