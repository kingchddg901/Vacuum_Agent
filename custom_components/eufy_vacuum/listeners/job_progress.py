...
#       A5-METRICS-1: job_progress ticker gates on a hand-copied {"started","paused"} literal, so app-
#              started (external) runs never get the Lever B live current-room refresh or a
#              progress tick
