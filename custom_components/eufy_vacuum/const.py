...
SERVICE_GOTO = "goto"  # cruise the robot to one tapped point (navigation, not a clean)
...
SERVICE_SET_ROOM_ACCESS_GRAPH = "set_room_access_graph"
...
SERVICE_SETUP_UNREJECT_ROOMS = "setup_unreject_rooms"
