"""GENERATED — do not hand-edit. id upkeep-guide translations from the lifted TM.
...
GUIDE_TRANSLATIONS = {
 "auto_empty": {
  ...
  "air_duct": {
   ...
   "replace_frequency": None,
   "steps": [
    "Lepaskan tangki air bersih, tangki air kotor, dan kotak debu.",
    "Lepaskan filter air dan lap bekas air dengan kain.",
    "Pegang sisi-sisi dasar dok ke atas untuk membongkar dan memeriksa adanya penyumbatan. Bersihkan saluran masuk udara dengan cotton bud jika tersumbat dan lap dengan kain kering.",
    "Letakkan dok dengan hati-hati dalam posisi terbalik di atas lantai keras yang dilapisi handuk lembut.",
    "Lepaskan ketiga sekrup dan lepaskan penutupnya.",
    "Lap saluran udara dan penutup saluran dengan kain kering.",
    "Pasang kembali penutup dan sekrupkan kembali di tempatnya."
   ],
   "notes": [
    "Frekuensi: * Bersihkan sesuai kebutuhan.",
    "Pengantar: Ikuti langkah-langkah berikut untuk membersihkan saluran udara dan menghindari penyumbatan."
   ]
  },
  "maintenance_brush": {
   "clean_frequency": None,
   "replace_frequency": None,
   "steps": [
    "Angkat kait sikat perawatan berkecepatan tinggi dan lepaskan sikat, seperti yang ditunjukkan di bawah ini. Hilangkan benda-benda yang tersangkut pada sikat perawatan berkecepatan tinggi dan bilas hingga bersih. Pasang kembali sikat dan kunci di tempatnya."
   ],
   "notes": [
    "Frekuensi: * Bersihkan sesuai kebutuhan dan ganti setiap 6-12 bulan.",
