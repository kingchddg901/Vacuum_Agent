"""GENERATED — do not hand-edit. ko upkeep-guide translations from the lifted TM.
...
GUIDE_TRANSLATIONS = {
 "auto_empty": {
  ...
  "air_duct": {
   ...
   "replace_frequency": None,
   "steps": [
    "청수 탱크, 오수 탱크, 먼지통을 분리하십시오.",
    "물 필터를 분리하고 천으로 물자국을 닦아내십시오.",
    "도크 받침대의 양옆을 위로 잡아 분해하고 막힘이 있는지 확인하십시오. 흡기구가 막힌 경우 면봉으로 청소하고 마른 천으로 닦으십시오.",
    "부드러운 수건을 깐 단단한 바닥에 도크를 조심스럽게 거꾸로 놓으십시오.",
    "세 개의 나사를 풀고 커버를 분리하십시오.",
    "마른 천으로 통풍구와 통풍구 커버를 닦으십시오.",
    "커버를 다시 장착하고 나사를 조여 제자리에 고정하십시오."
   ],
   "notes": [
    "주기: * 필요에 따라 청소하십시오.",
    "소개: 통풍구를 청소하고 막힘을 방지하려면 다음 단계를 따르십시오."
   ]
  },
  "maintenance_brush": {
   "clean_frequency": None,
   "replace_frequency": None,
   "steps": [
    "아래 그림과 같이 고속 유지 관리 브러시 걸쇠를 들어 올리고 브러시를 분리하십시오. 고속 유지 관리 브러시에 엉킨 이물질을 제거하고 깨끗이 헹구십시오. 브러시를 다시 장착하고 걸쇠로 제자리에 고정하십시오."
   ],
   "notes": [
    "주기: * 필요에 따라 청소하고 6~12개월마다 교체하십시오.",
