...
GUIDE_TRANSLATIONS = {'x10_pro_omni': {'filter': {'steps': ['打開上蓋，取出集塵盒。',
                  ...
                  'side_brush': {'steps': ['使用螺絲起子拆下邊刷。',
                                           ...
                                           '用清水沖洗邊刷，並使其完全風乾。',
                                           '待邊刷乾燥後再裝回。']},
                  'main_brush': {'steps': ['解開滾刷護蓋的卡榫，將護蓋取出。',
                                              '取出滾刷。',
                                              '剪除並清理纏繞的毛髮與碎屑。',
                                              '沖洗滾刷與護蓋，然後使其風乾。',
                                              '裝回滾刷，並將護蓋扣回原位。'],
                                    'notes': ['滾刷護蓋也應每 3 至 6 個月或於磨損時更換。']},
                  'mop_cloth': {'steps': ['從機器人取下拖布。', '清洗拖布並完全晾乾後再使用。', '當拖布磨損或清潔效果變差時予以更換。']},
                  'cleaning_tray': {'steps': ['從 Omni 基站取出清潔盤。', '用清水徹底沖洗清潔盤。', '清潔後將清潔盤裝回。'],
                                    'notes': ['污水箱裝滿時應清空並沖洗。']},
                  'caster_wheel': {'steps': ['檢查萬向輪是否纏繞毛髮或卡有碎屑。',
                                             '小心清除碎屑，並將輪子周圍擦拭乾淨。',
                                             '下次清潔前，確認輪子能自由轉動。'],
 ...
 's1_pro': {'filter': {'steps': ['從集塵盒區域取出高效濾網。', '輕拍去除灰塵與碎屑。', '待濾網潔淨乾燥後再裝回或更換。'],
            ...
            'main_brush': {'steps': ['取下滾刷護蓋。', '檢查滾刷與兩端端蓋是否纏繞毛髮或卡有碎屑。', '徹底清潔滾刷後再裝回。']},
            'mop_cloth': {'steps': ['取下滾筒拖布或拖地接觸面，清除殘留污垢。',
                                        '待清潔後的部件乾燥後再使用。',
            ...
            'caster_wheel': {'steps': ['檢查萬向輪是否卡有毛髮與碎屑。', '清除積垢，並確認輪子能自由轉動。']}},
 'omni_c20': {'filter': {'steps': ['取出集塵盒或濾網艙。', '取出濾網並輕拍去除灰塵。', '僅在手冊／應用程式指引允許時清洗，並待完全乾燥後再裝回。'],
              ...
              'main_brush': {'steps': ['檢查滾刷是否纏繞毛髮或卡有碎屑。', '使用清潔工具或剪刀剪除纏繞的雜物。', '清潔後裝回。'],
                                'notes': ['Pro-Detangle 防纏梳可減少但無法完全省去手動清潔。']},
              'mop_cloth': {'steps': ['從機器人或基站取下拖布。', '清潔並完全晾乾後再使用。', '當拖布磨損或清潔效果變差時予以更換。']},
 ...
 'x8_series': {'filter': {'steps': ['取出集塵盒，並拿出濾網。', '輕拍濾網以去除灰塵。', '若有沖洗，請待其完全乾燥後再裝回。']},
               ...
               'main_brush': {'steps': ['捏住主滾刷護蓋的卡榫，取下護蓋。',
                                           '取出主滾刷。',
                                           '使用清潔工具或剪刀清除毛髮與碎屑。',
                                           '裝回滾刷與護蓋。']},
               'mop_cloth': {'steps': ['從固定座取下拖布。', '清洗並晾乾後再使用。', '若拖布磨損或失去效果，請更換。'],
 ...
 'l60_series': {'filter': {'steps': ['按下集塵盒釋放鈕，取出集塵盒。',
                ...
                'main_brush': {'steps': ['取下主滾刷護蓋。',
                                            '取出滾刷。',
                                            '清除滾刷與軸承上纏繞的毛髮與碎屑。',
                                            '擦乾後裝回滾刷與護蓋。'],
                                  'notes': ['SES 機型另具備自動斷髮功能，可減少保養需求。']},
                'mop_cloth': {'steps': ['取下拖布或抹布。', '清潔並完全晾乾後再使用。', '當抹布磨損時予以更換。'],
                                  'notes': ['僅適用於混合型機型。']}}}
