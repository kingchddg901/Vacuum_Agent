...
GUIDE_TRANSLATIONS = {'x10_pro_omni': {'filter': {'steps': ['打开顶盖，取出尘盒。',
 ...
 's1_pro': {'filter': {'steps': ['从尘盒处取出高性能滤网。', '轻轻抖落灰尘和碎屑。', '待滤网清洁并晾干后，将其重新安装或更换。'],
            ...
            'main_brush': {'steps': ['取下滚刷盖板。', '检查滚刷及其两端端盖是否缠有头发或碎屑。', '重新安装前，将滚刷彻底清洁干净。']},
            'mop_cloth': {'steps': ['取下滚筒拖布或拖布接触面，清除残留污渍。',
                                        '清洁后待部件晾干再使用。',
            ...
            'caster_wheel': {'steps': ['检查万向轮上是否有头发和碎屑。', '清除积垢，并确认轮子转动顺畅。']}},
 'omni_c20': {'filter': {'steps': ['取出尘盒或滤网仓。', '取出滤网并轻拍抖落灰尘。', '仅在手册/应用指引允许时清洗，然后彻底晾干再重新安装。'],
              ...
              'main_brush': {'steps': ['检查滚刷是否缠有头发或碎屑。', '使用清洁工具或剪刀剪除缠绕的杂物。', '清洁后重新安装。'],
                                'notes': ['Pro-Detangle 防缠绕梳可减少但无法完全免除手动清洁。']},
              'mop_cloth': {'steps': ['从机器人或基站上取下拖布。',
                                          '再次使用前，请清洗并彻底晾干。',
                                          '当拖布磨损或清洁效果下降时，请更换。']},
 ...
 'x8_series': {'filter': {'steps': ['取出尘盒并取下滤网。', '轻拍滤网以抖落灰尘。', '如果冲洗过，请在重新安装前将其彻底风干。']},
               ...
               'main_brush': {'steps': ['捏住滚刷盖板卡扣，取下盖板。',
                                           '提起并取出滚刷。',
                                           '使用清洁工具或剪刀清除头发和碎屑。',
                                           '重新安装滚刷和盖板。']},
               'mop_cloth': {'steps': ['从支架上取下拖布。', '再次使用前清洗并晾干。', '如果磨损或效果变差则更换。'],
 ...
 'l60_series': {'filter': {'steps': ['按下尘盒释放按钮，取出尘盒。',
                ...
                'main_brush': {'steps': ['取下滚刷盖板。',
                                            '提起并取出滚刷。',
                                            '清除滚刷和轴承上缠绕的头发和碎屑。',
                                            '擦干后重新安装滚刷和盖板。'],
                                  'notes': ['SES 机型还配备自动断发功能以减少维护。']},
                'mop_cloth': {'steps': ['取下拖布或抹布。', '再次使用前，请清洗并彻底晾干。', '当拖布磨损时请更换。'],
