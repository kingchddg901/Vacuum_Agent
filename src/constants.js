...
export const SERVICE_ADD_QUEUE_ZONE         = "add_queue_zone";
...
export const SERVICE_SET_STALL_CAPTURE      = "set_stall_capture";
export const SERVICE_ACKNOWLEDGE_MAP_FRAME  = "acknowledge_map_frame";
...
export const ENTITY = {
  ...
  cleanOrderSensor:  (id) => `sensor.${vacuumObjectId(id)}_clean_order`,
  overrideOrderSwitch: (id) => `switch.${vacuumObjectId(id)}_clean_order_override`,
