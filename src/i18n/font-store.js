 ...
 * chrome. Not against "languages that look Latin": OpenDyslexic is missing
 * glyphs that Polish (ł ą), Czech (ř ů) and Turkish (ı İ ğ) need, so those
 * locales must be PROVEN, never assumed.
 *
