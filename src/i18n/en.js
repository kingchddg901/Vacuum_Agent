...
export const en = {
  ...
  "setup.subtab_steps": "Setup steps",
  "setup.subtab_system": "System",
  "system.subtitle": "Every value Vacuum Agent reads from your vacuum, and how it was chosen. If a row names the wrong entity, the reading it feeds will be wrong too.",
  "system.empty": "No entity bindings yet — the dashboard snapshot has not arrived.",
  "system.col_role": "Reads",
  ...
  "system.source_magnitude": "Value comparison",
  "system.source_override": "Your choice",
  "system.source_device_sibling": "Found on the vacuum's device",
  "system.source_config_entry_sibling": "Found in the vacuum's integration",
  "system.source_declared_rescue": "Renamed — matched by suffix",
  "system.reason_disabled": "disabled in Home Assistant",
  "system.reason_absent": "not found",
  "system.reason_registered_no_state": "no reading yet",
  "system.reason_override_unresolved": "your chosen entity is missing",
  ...
  "map.goto_hint": "Tap the map to send the robot there",  // Pill shown while go-to (cruise-to-point) mode is armed
  "map.goto_point": "Send the robot to a point",  // Button/tooltip; enters tap-a-point go-to (cruise) mode
  ...
  "fault.dreame.auto_key_trig": "Internal error",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.battery_fault": "Battery error",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.battery_low": "Low battery",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.battery_percentage": "Battery level error",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.bin_full": "The dust collection bag is full, or the air duct is blocked.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.bin_open": "The upper cover of auto-empty base is not closed, or the dust collection bag is not installed.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.blocked": "Cleanup route is blocked, returning to the dock.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.blocked_by_obstacle": "Robot blocked by obstacle.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.bmi055_acce": "Accelerometer error",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.bmi055_gyro": "Gyro error",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.box_full": "The filter not dry or blocked",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.brush": "The main brush wrapped",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.bumper": "Collision sensor is stuck",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.bumper_repeat": "Collision sensor is stuck",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.camera_fault": "Camera error",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.camera_idle": "Internal error",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.camera_occlusion": "Visual positioning sensor error",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.carpet": "Please start the robot in non-carpet area.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.charge_fault": "Charging error",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.charge_no_electric": "The charging dock is not powered on",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.charger_get": "Cannot find base",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.chassis_lift_malfunction": "Chassis lift malfunction.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.check_mop_install": "Please check if the mop is installed properly.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.clean_mop_pad": "The cleaning task is complete, please clean the mop pad washboard.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.clean_tank_level": "Check and fill the clean water tank.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.cliff": "Cliff sensor error",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.dirty_tank_level": "The water level in the used water tank is too high.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.dirty_tank_not_installed": "The used water tank of robot is not installed.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.dirty_water_tank": "The dirty water tank is full or not installed.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.dirty_water_tank_blocked": "Dirty water tank blocked.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.dirty_water_tank_full": "Abnormal water level in the robot's used water tank.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.dirty_water_tank_pump": "Dirty water tank pump error.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.dock_error": "Dock Error.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.drainage_failed": "Abnormal water drainage from used water tank",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.drainage_outlet_filter": "The wastewater outlet filter of robot is clogged.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.drop": "Wheels are suspended",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.drop_repeat": "Wheels are suspended",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.dust_bag_full": "Dust bag is full or vents are blocked.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.edge": "Edge sensor error",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.edge_mop_detached": "Edge mop detached.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.edge_mop_stop_rotate": "Edge mop stopped rotating.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.fan": "The filter not dry or blocked",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.fan_speed_error": "Fan speed sensor error",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.filter_blocked": "The filter not dry or blocked",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.flow_error": "Flow sensor error",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.flow_shielding": "Optical sensor error",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.fluffing_roller_error": "Fluffing Roller Error.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.forward_suffocate": "The robot is stuck, or cannot go forward",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.gesture": "Robot is tilted",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.heart": "Internal error",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.infrared_fault": "Infrared error",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.infrared_shielding": "Infrared shielding error",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.internal_error": "Malfunction due to an internal error. Try to restart the robot.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.laser": "The 3D obstacle avoidance sensor is malfunctioning.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.lds_bumper": "Laser distance sensor bumper error",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.lds_error": "Laser distance sensor error",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.lds_failed_to_lift": "Failed to lift LDS module.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.left_magnet": "Left magnet sensor error",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.left_wheel_motor": "The robot is stuck, or its left wheel may be blocked by foreign objects",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.left_wheell_speed": "Left wheel may be blocked by foreign objects",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.low_battery_turn_off": "Low battery. Robot will shut down soon.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.main_wheels_error": "Main wheels error.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.mop_cover_error": "Check for any debris near the roller mop and mop cover.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.mop_holder_error": "Mop holder quantity/placement error in the dock.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.mop_install_failed": "Mop pad installation failed.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.mop_not_detected": "Mop not detected.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.mop_not_installed": "Mop Not Installed.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.mop_pad": "The washboard is not installed properly.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.mop_pad_stop_rotate": "The mop pad has stopped rotating.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.mop_removed": "The mop pad comes off during the cleaning task.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.move": "Move sensor error",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.no_box": "Dust bin not installed",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.no_go_zone": "No-Go zone or virtual wall detected.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.no_mop_in_station": "Mop pad is not in the station.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.no_tank_box": "Water tank not installed",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.onboard_dirty_water_tank_full": "Robot's used water box is full.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.onboard_water_tank_empty": "Low water level in robot's clean water box.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.optical_flow": "Optical flow sensor error",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.p3v3": "Internal error",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.remove_mop": "Mopping completed. Please remove and clean the mop in time.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.restricted": "Detected that the vacuum-mop is in a restricted area.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.retractable_leg_stuck": "Please check if the retractable legs are tangled.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.return_to_charge_failed": "Failed to return to charge.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.right_magnet": "Right magnet sensor error",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.right_wheel_motor": "The robot is stuck, or its right wheel may be blocked by foreign objects",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.right_wheell_speed": "Right wheel may be blocked by foreign objects",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.robot_in_hidden_room": "Hidden area. Please move the robot to the appropriate area and retry.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.robot_stuck": "LDS cannot be raised here for positioning.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.robot_stuck_on_carpet": "Robot slips on the carpet",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.robot_stuck_on_curtain": "Robot slips in the curtain area",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.robot_stuck_on_low_lying_area": "Robot stuck in a low-clearance area.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.robot_stuck_on_obstacle": "Robot has detected obstacles on the path.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.robot_stuck_on_passage": "Robot stuck in the narrow passage.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.robot_stuck_on_pet": "Robot has detected people or pets on the path.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.robot_stuck_on_ramp": "Robot has detected Easy-to-Fall ramps on the path.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.robot_stuck_on_slippery_surface": "Robot is stuck due to slipping.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.robot_stuck_on_tables": "Robot stuck among the tables and chairs.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.robot_stuck_on_threshold": "Robot stuck at the step/threshold.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.robot_stuck_repeat": "Move robot to an open area and resume the task.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.robotic_arm_stopped": "Robotic arm stopped.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.roller_mop_error": "Check for any debris near the roller mop and mop cover.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.route": "Cleanup route is blocked.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.rtc": "RTC error",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.self_test_failed": "Abnormal water discharge from the clean water tank of the upper and lower water modules.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.side_brush": "The side brush wrapped",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.slippery_floor": "Slippery floor. Please try again later.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.station_disconnected": "Base station not powered on",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.strong_magnet": "Strong magnetic field detected",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.turn_suffocate": "The robot is stuck, or cannot turn",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.ultrasonic": "The ultrasonic sensor is malfunctioning.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.unknown": "Unknown error code",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.wash_failed": "Failed to wash dirty mop.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.washboard_level": "Water level in the washboard is too high.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.washboard_not_working": "Washboard stops working.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.water_box_empty": "Water tank is empty",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.water_pump": "Water pump error",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.water_tank": "The clean water tank is not installed.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.water_tank_dry": "Low water level in the clean water tank, please fill with water timely.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.wet_mop_pad": "The water level of the washboard is abnormal, please clean the washboard timely.",  // Dreame (tasshack dreame_vacuum, MIT)
  "fault.dreame.xv7001": "Gyro error",  // Dreame (tasshack dreame_vacuum, MIT)
