...
export const LEARNING_TOKENS = [
  ...
  learningToken.color("--evcc-learning-confidence-low-bg", "Learning Confidence Low BG"),
  ...
  learningToken.color("--evcc-learning-confidence-neutral-bg", "Learning Confidence Neutral BG"),
  ...
  learningToken.shadow("--evcc-learning-current-glow", "Learning Current Glow"),
