...
export const SURFACE_TOKENS = [
  ...
  surfaceToken.color("--evcc-surface-action", "Surface Action"),
  surfaceToken.color("--evcc-surface-action-hover", "Surface Action Hover"),
  surfaceToken.color("--evcc-surface-base", "Surface Base"),
  surfaceToken.color("--evcc-surface-card", "Surface Card"),
  surfaceToken.color("--evcc-surface-chip", "Surface Chip"),
