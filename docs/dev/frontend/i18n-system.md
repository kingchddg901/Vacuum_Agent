...
└── guide-keys.js          generated upkeep-guide KEY pack (see "Guide on the card")
```
...
⚠ THE PER-FAMILY PROSE CHANNEL IS GONE (2026-09-12). `guide-translations.js` and its 17 served
