...
> documented in [12 — Where the Map Comes From](../../12-map-source.md). Wave 3 consumer wiring
...
- **Adapter:** a `map_render: {format}` block declares the decode format (Eufy
  ...
  > Wave-1 (2026-06-19) state. Details: [22 — The Adapter Contract](../../22-adapter-contract.md) /
  > [24 — The Roborock Adapter](../../24-roborock-adapter.md).
