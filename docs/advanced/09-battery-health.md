...
For the user-facing tour see [user-guide/13-battery-health.md](../user-guide/13-battery-health.md). For internal architecture see [16 — The Battery Record](../dev/16-battery-record.md).
