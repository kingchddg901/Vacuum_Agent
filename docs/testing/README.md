...
The suite currently has **2,605 test functions** across **155 test files**
(49 unit, 94 integration, 12 adapter) — 2,909 cases after parametrization — all
green, running on Python 3.14 inside a Linux container. Those exercise the
**191 source modules** under
