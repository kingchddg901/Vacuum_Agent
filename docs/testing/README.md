...
The suite currently has **2,663 test functions** across **157 test files**
(50 unit, 95 integration, 12 adapter) — 2,969 cases after parametrization — all
green, running on Python 3.14 inside a Linux container. Those exercise the
**200 source modules** under
`custom_components/eufy_vacuum/` to **94.8% coverage** (93% combined with
