...
The suite currently has **3,912 test functions** across **212 test files**
(86 unit, 108 integration, 18 adapter) — 4,602 cases after parametrization —
...
not a real regression. Those 3,369/3,859 exercise the **225 source modules**
under `custom_components/eufy_vacuum/` to **94.1% coverage** (92% combined
