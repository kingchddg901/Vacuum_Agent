...
The suite currently has **2,461 test functions** across **148 test files**
(49 unit, 89 integration, 10 adapter) — 2,744 cases after parametrization — all
green, running on Python 3.14 inside a Linux container. Those exercise the
**156 source modules** under
`custom_components/eufy_vacuum/` to **95.9% coverage** (94% combined with
