...
current settings. Covered by **68 tests across 3 files**.
...
|---------------|------:|----:|------------|-------|
| `manager.py` | 413 | 96% | `test_profiles_manager.py` | integration |
| `room_profiles.py` | 179 | 95% | `test_profiles_room_profiles.py` (unit), `test_profile_catalog.py` (unit) | unit |
