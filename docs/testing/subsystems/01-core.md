...
low-battery-return reads. Covered by **264 tests across 15 files**.
...
|---------------|------:|----:|------------|-------|
| `manager.py` | 1850 | 95% | `test_manager_lifecycle_status.py`, `test_manager_progress.py`, `test_manager_delegation.py`, `test_manager_start_selected.py`, `test_manager_external_finalize.py`, `test_manager_init_migrations.py`, `test_core_manager_registry.py`, `test_manager_compare_sources.py`, `test_manager_live_pose.py`, `test_core_manager_helpers.py` (unit) | int + unit |
| `error_tracker.py` | 388 | 89% | `test_core_error_tracker.py` | integration |
| `capabilities.py` | 120 | 97% | `test_core_capabilities.py` | integration |
